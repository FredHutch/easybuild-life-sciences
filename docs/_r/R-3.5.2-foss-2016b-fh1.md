...
Sensitivity, Identifiability and Monte Carlo Analysis
  * [FNN-1.1.2.2](https://cran.r-project.org/web/packages/FNN/index.html) Fast Nearest Neighbor Search Algorithms and Applications
...
Results to Speed Up Computations
  ...
  * [R6-2.3.0](https://cran.r-project.org/web/packages/R6/index.html) Encapsulated Classes with Reference Semantics
...
Polynomial Manipulations
  * [prabclus-2.2-6](https://cran.r-project.org/web/packages/prabclus/index.html) Functions for Clustering and Testing of Presence-Absence,
...
Regression
  * [randomForestSRC-2.7.0](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
...
'GitHub'
  ...
  * [rlang-0.3.2](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
...
Applications
  ...
  * [sf-0.7-2](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
...
Exponential-Family Random Graph Models
  ...
  * [tidyr-0.8.2](https://cran.r-project.org/web/packages/tidyr/index.html) Easily Tidy Data with 'spread()' and 'gather()' Functions
...
Signal Processing
  ...
  * [zoo-1.8-4](https://cran.r-project.org/web/packages/zoo/index.html) S3 Infrastructure for Regular and Irregular Time Series (Z's Ordered Observations)
