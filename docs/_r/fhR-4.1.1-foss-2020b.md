...
Model
  ...
  * [GenomicAlignments-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicAlignments.html) Representation and manipulation of short genomic alignments
...
Buttlar
  * KEGG.db 3.2.4
  * [KEGGREST-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/KEGGREST.html) Client-side REST access to the Kyoto Encyclopedia of Genes and Genomes (KEGG)
...
Implementation
  ...
  * [S4Vectors-0.30.0](https://www.bioconductor.org/packages/release/bioc/html/S4Vectors.html) Foundation of vector-like and list-like containers in Bioconductor
...
in Environmental Sciences
  ...
  * [affyio-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/affyio.html) Tools for parsing Affymetrix data files
...
(CGDS)
  ...
  * [cli-3.0.1](https://cran.r-project.org/web/packages/cli/index.html) Helpers for Developing Command Line Interfaces
...
('ODE', 'DAE', 'DDE')
  ...
  * [derfinderHelper-1.26.0](https://www.bioconductor.org/packages/release/bioc/html/derfinderHelper.html) derfinder helper package
...
and Shape
  ...
  * [gcrma-2.64.0](https://www.bioconductor.org/packages/release/bioc/html/gcrma.html) Background Adjustment Using Sequence Information
  ...
  * [gdsfmt-1.28.0](https://cran.r-project.org/web/packages/gdsfmt/index.html) R Interface to CoreArray Genomic Data Structure (GDS) files
  ...
  * [geneLenDataBase-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/geneLenDataBase.html) Lengths of mRNA transcripts for a number of genomes
  * [genefilter-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/genefilter.html) genefilter: methods for filtering genes from high-throughput experiments
  * [geneplotter-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/geneplotter.html) Graphics related functions for Bioconductor
...
Model Fitting
  ...
  * [gert-1.3.2](https://cran.r-project.org/web/packages/gert/index.html) Simple Git Client for R
...
Enhancements
  ...
  * [ggbio-1.40.0](https://www.bioconductor.org/packages/release/bioc/html/ggbio.html) Visualization tools for genomic data
  * [ggcyto-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/ggcyto.html) Visualize Cytometry data with ggplot
  ...
  * [ggfun-0.0.3](https://cran.r-project.org/web/packages/ggfun/index.html) Miscellaneous Functions for 'ggplot2'
...
'ggplot2'
  * [ggsignif-0.6.2](https://cran.r-project.org/web/packages/ggsignif/index.html) Significance Brackets for 'ggplot2'
  * [ggthemes-4.2.4](https://cran.r-project.org/web/packages/ggthemes/index.html) Extra Themes, Scales and Geoms for 'ggplot2'
  * [ggtree-3.0.4](https://www.bioconductor.org/packages/release/bioc/html/ggtree.html) an R package for visualization of tree and annotation data
...
Distribution
  ...
  * [glmmTMB-1.1.2.2](https://cran.r-project.org/web/packages/glmmTMB/index.html) Generalized Linear Mixed Models using Template Model Builder
...
Likelihood
  ...
  * [goseq-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/goseq.html) Gene Ontology analyser for RNA-seq and other length biased data
  ...
  * [graph-1.70.0](https://cran.r-project.org/web/packages/graph/index.html) graph: A package to handle graph data structures
  * graphics built in
...
Covariates
  ...
  * [gtsummary-1.4.2](https://cran.r-project.org/web/packages/gtsummary/index.html) Presentation-Ready Data Summary and Analytic Result Tables
  * [h2o-3.32.1.3](https://cran.r-project.org/web/packages/h2o/index.html) R Interface for the 'H2O' Scalable Machine Learning Platform
  * [hal9001-0.2.7](https://cran.r-project.org/web/packages/hal9001/index.html) The Scalable Highly Adaptive Lasso
...
when Linkage Phase is Ambiguous
  ...
  * [hms-1.1.0](https://cran.r-project.org/web/packages/hms/index.html) Pretty Time of Day
  * [hopach-2.52.0](https://cran.r-project.org/web/packages/hopach/index.html) Hierarchical Ordered Partitioning and Collapsing Hybrid (HOPACH)
  * [htmlTable-2.2.1](https://cran.r-project.org/web/packages/htmlTable/index.html) Advanced Tables for Markdown/HTML
  ...
  * [httpuv-1.6.2](https://cran.r-project.org/web/packages/httpuv/index.html) HTTP and WebSocket Server Library
...
High-Dimensional Cytometry
  ...
  * [illuminaio-0.34.0](https://www.bioconductor.org/packages/release/bioc/html/illuminaio.html) Parsing Illumina Microarray Output Files
  ...
  * [impute-1.66.0](https://cran.r-project.org/web/packages/impute/index.html) impute: Imputation for microarray data
...
Network
  ...
  * [interactiveDisplayBase-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/interactiveDisplayBase.html) Base package for enabling powerful shiny web displays of Bioconductor objects
  ...
  * [ipred-0.9-11](https://cran.r-project.org/web/packages/ipred/index.html) Improved Predictors
...
Grids
  ...
  * [jstable-1.0.6](https://cran.r-project.org/web/packages/jstable/index.html) Create Tables from Different Types of Regression
  * [karyoploteR-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/karyoploteR.html) Plot customizable linear genomes displaying arbitrary data
...
Derivatives
  ...
  * [knitr-1.33](https://cran.r-project.org/web/packages/knitr/index.html) A General-Purpose Package for Dynamic Report Generation in R
...
Monte Carlo Studies
  ...
  * [labelled-2.8.0](https://cran.r-project.org/web/packages/labelled/index.html) Manipulating Labelled Data
  ...
  * [lasso2-1.2-21.1](https://cran.r-project.org/web/packages/lasso2/index.html) L1 Constrained Estimation aka `lasso'
  * lassosum 0.4.5
...
Loops
  * [lattice-0.20-44](https://cran.r-project.org/web/packages/lattice/index.html) Trellis Graphics for R
  ...
  * [lhs-1.1.2](https://cran.r-project.org/web/packages/lhs/index.html) Latin Hypercube Samples
  * [libcoin-1.0-8](https://cran.r-project.org/web/packages/libcoin/index.html) Linear Test Statistics for Permutation Inference
  * [lifecycle-1.0.0](https://cran.r-project.org/web/packages/lifecycle/index.html) Manage the Life Cycle of your Package Functions
  * [limSolve-1.5.6](https://cran.r-project.org/web/packages/limSolve/index.html) Solving Linear Inverse Models
  * [limma-3.48.3](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
...
Models
  ...
  * [lpsymphony-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/lpsymphony.html) Symphony integer linear programming solver in R
...
Likelihood or Least Squares
  ...
  * [lumi-2.44.0](https://www.bioconductor.org/packages/release/bioc/html/lumi.html) BeadArray Specific Methods for Illumina Methylation and Expression Microarrays
  * [lwgeom-0.2-7](https://cran.r-project.org/web/packages/lwgeom/index.html) Bindings to Selected 'liblwgeom' Functions for Simple Features
  ...
  * [maSigPro-1.64.0](https://www.bioconductor.org/packages/release/bioc/html/maSigPro.html) Significant Gene Expression Profile Differences in Time Course Gene Expression Data
  ...
  * [manipulateWidget-0.11.0](https://cran.r-project.org/web/packages/manipulateWidget/index.html) Add Even More Interactivity to Interactive Charts
  ...
  * [marray-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/marray.html) Exploratory analysis for two-color spotted microarray data
  * [mathjaxr-1.4-0](https://cran.r-project.org/web/packages/mathjaxr/index.html) Using 'Mathjax' in Rd Files
  * [matrixStats-0.60.1](https://cran.r-project.org/web/packages/matrixStats/index.html) Functions that Apply to Rows and Columns of Matrices (and to
Vectors)
...
Classification, and Density Estimation
  ...
  * [mcmcse-1.4-1](https://cran.r-project.org/web/packages/mcmcse/index.html) Monte Carlo Standard Errors for MCMC
  ...
  * [metagenomeSeq-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/metagenomeSeq.html) Statistical analysis for sparse high-throughput sequencing
  * methods built in
  * [methylKit-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/methylKit.html) DNA methylation analysis from high-throughput bisulfite sequencing results
  * [methylumi-2.38.0](https://www.bioconductor.org/packages/release/bioc/html/methylumi.html) Handle Illumina methylation data
  * [mets-1.2.9](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
  * [mgcv-1.8-36](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
...
'mice'
  * [microbenchmark-1.4-7](https://cran.r-project.org/web/packages/microbenchmark/index.html) Accurate Timing Functions
  * [mime-0.11](https://cran.r-project.org/web/packages/mime/index.html) Map Filenames to MIME Types
  * [minfi-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/minfi.html) Analyze Illumina Infinium DNA methylation arrays
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [misc3d-0.9-0](https://cran.r-project.org/web/packages/misc3d/index.html) Miscellaneous 3D Plots
  ...
  * [mitml-0.4-1](https://cran.r-project.org/web/packages/mitml/index.html) Tools for Multiple Imputation in Multilevel Modeling
  * [mitools-2.4](https://cran.r-project.org/web/packages/mitools/index.html) Tools for Multiple Imputation of Missing Data
  * [mixOmics-6.16.3](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
...
Versions
  ...
  * [motifmatchr-1.14.0](https://www.bioconductor.org/packages/release/bioc/html/motifmatchr.html) Fast Motif Matching in R
  * [mpath-0.4-2.19](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
  * [msa-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/msa.html) Multiple Sequence Alignment
  ...
  * [multtest-2.48.0](https://cran.r-project.org/web/packages/multtest/index.html) Resampling-based multiple hypothesis testing
  ...
  * [mvtnorm-1.1-2](https://cran.r-project.org/web/packages/mvtnorm/index.html) Multivariate Normal and t Distributions
...
Dimensions
  ...
  * [nanotime-0.3.3](https://cran.r-project.org/web/packages/nanotime/index.html) Nanosecond-Resolution Time Support for R
...
Files
  * [ncdfFlow-2.38.0](https://www.bioconductor.org/packages/release/bioc/html/ncdfFlow.html) ncdfFlow: A package that provides HDF5 based storage for flow cytometry data.
  * [ndtv-0.13.1](https://cran.r-project.org/web/packages/ndtv/index.html) Network Dynamic Temporal Visualizations
...
Methods)
  ...
  * [oligo-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/oligo.html) Preprocessing tools for oligonucleotide arrays
  * [oligoClasses-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/oligoClasses.html) Classes for high-throughput arrays supported by oligo and crlmm
  * [openCyto-2.4.0](https://www.bioconductor.org/packages/release/bioc/html/openCyto.html) Hierarchical Gating Pipeline for flow cytometry data
...
OpenSSL
  ...
  * [optimx-2021-6.12](https://cran.r-project.org/web/packages/optimx/index.html) Expanded Replacement and Extension of the 'optim' Function
  ...
  * [org.Hs.eg.db-3.13.0](https://www.bioconductor.org/packages/release/bioc/html/org.Hs.eg.db.html) Genome wide annotation for Human
  * [org.Mm.eg.db-3.13.0](https://www.bioconductor.org/packages/release/bioc/html/org.Mm.eg.db.html) Genome wide annotation for Mouse
  * [origami-1.0.3](https://cran.r-project.org/web/packages/origami/index.html) Generalized Framework for Cross-Validation
...
Dependencies
  ...
  * [parallelly-1.27.0](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
...
8601 Formats
  ...
  * [party-1.3-8](https://cran.r-project.org/web/packages/party/index.html) A Laboratory for Recursive Partytioning
  ...
  * [pathview-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/pathview.html) a tool set for pathway based data integration and visualization
  * [pbapply-1.4-3](https://cran.r-project.org/web/packages/pbapply/index.html) Adding Progress Bar to '*apply' Functions
...
Methods for Test in Mixed Models
  ...
  * [pcaMethods-1.84.0](https://www.bioconductor.org/packages/release/bioc/html/pcaMethods.html) A collection of PCA methods
...
in GLMs and in the Cox Model
  ...
  * [phyloseq-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/phyloseq.html) Handling and analysis of high-throughput microbiome census data
  * [phytools-0.7-80](https://cran.r-project.org/web/packages/phytools/index.html) Phylogenetic Tools for Comparative Biology (and Other Things)
  * [pillar-1.6.2](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [pkgload-1.2.1](https://cran.r-project.org/web/packages/pkgload/index.html) Simulate Package Installation and Attach
  ...
  * [plotly-4.9.4.1](https://cran.r-project.org/web/packages/plotly/index.html) Create Interactive Web Graphics via 'plotly.js'
  ...
  * [plotrix-3.8-1](https://cran.r-project.org/web/packages/plotrix/index.html) Various Plotting Functions
  ...
  * [polyester-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/polyester.html) Simulate RNA-seq reads
...
Polynomial Manipulations
  * [posterior-1.0.1](https://cran.r-project.org/web/packages/posterior/index.html) Tools for Working with Posterior Distributions
...
Abundance and Multilocus Genetic Data
  ...
  * [preprocessCore-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/preprocessCore.html) A collection of pre-processing functions
  ...
  * [progressr-0.8.0](https://cran.r-project.org/web/packages/progressr/index.html) An Inclusive, Unifying API for Progress Updates
  ...
  * [psych-2.1.6](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
  * [psychotools-0.6-1](https://cran.r-project.org/web/packages/psychotools/index.html) Psychometric Modeling Infrastructure
...
Resampling
  ...
  * [qgraph-1.6.9](https://cran.r-project.org/web/packages/qgraph/index.html) Graph Plotting Methods, Psychometric Data Visualization and
Graphical Model Estimation
  ...
  * [quantsmooth-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/quantsmooth.html) Quantile smoothing and genomic visualization of array data
  * [questionr-0.7.4](https://cran.r-project.org/web/packages/questionr/index.html) Functions to Make Surveys Processing Easier
  * [qvalue-2.24.0](https://cran.r-project.org/web/packages/qvalue/index.html) Q-value estimation for false discovery rate control
  ...
  * [rGADEM-2.40.0](https://www.bioconductor.org/packages/release/bioc/html/rGADEM.html) de novo motif discovery
  * [rJava-1.0-4](https://cran.r-project.org/web/packages/rJava/index.html) Low-Level R to Java Interface
...
Regression
  * [randomForestSRC-2.12.1](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
...
and Logs
  * [raster-3.4-13](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
  * [rasterVis-0.50.3](https://cran.r-project.org/web/packages/rasterVis/index.html) Visualization Methods for Raster Data
  ...
  * [rbibutils-2.2.3](https://cran.r-project.org/web/packages/rbibutils/index.html) Read 'Bibtex' Files and Convert Between Bibliography Formats
...
'Ensembl' and 'UCSC' Genome Browsers
  ...
  * [regioneR-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/regioneR.html) Association analysis of genomic regions based on permutation tests
  ...
  * [remotes-2.4.0](https://cran.r-project.org/web/packages/remotes/index.html) R Package Installation from Remote Repositories, Including
'GitHub'
  ...
  * [reticulate-1.20](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  ...
  * [rgdal-1.5-23](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  ...
  * [rgeos-0.5-7](https://cran.r-project.org/web/packages/rgeos/index.html) Interface to Geometry Engine - Open Source ('GEOS')
  ...
  * [rhdf5-2.36.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5.html) R Interface to HDF5
  * [rhdf5filters-1.4.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5filters.html) HDF5 Compression Filters
  ...
  * [rlang-0.4.11](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  ...
  * [rmarkdown-2.10](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Annealing (Rgraph C Library Wrapper for R)
  ...
  * [robustbase-0.93-8](https://cran.r-project.org/web/packages/robustbase/index.html) Basic Robust Statistics
  * [rootSolve-1.8.2.2](https://cran.r-project.org/web/packages/rootSolve/index.html) Nonlinear Root Finding, Equilibrium and Steady-State Analysis of
Ordinary Differential Equations
  ...
  * [rrcov-1.5-5](https://cran.r-project.org/web/packages/rrcov/index.html) Scalable Robust Estimators with High Breakdown Point
  * [rredlist-0.7.0](https://cran.r-project.org/web/packages/rredlist/index.html) 'IUCN' Red List Client
  * [rsample-0.1.0](https://cran.r-project.org/web/packages/rsample/index.html) General Resampling Infrastructure
...
Applications
  * [rslurm-0.6.0](https://cran.r-project.org/web/packages/rslurm/index.html) Submit R Calculations to a 'Slurm' Cluster
  ...
  * [rtracklayer-1.52.1](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  ...
  * [rvcheck-0.2.0](https://cran.r-project.org/web/packages/rvcheck/index.html) R/Package Version Check
  ...
  * [rvest-1.0.1](https://cran.r-project.org/web/packages/rvest/index.html) Easily Harvest (Scrape) Web Pages
  * [rzmq-0.9.8](https://cran.r-project.org/web/packages/rzmq/index.html) R Bindings for 'ZeroMQ'
  * [s2-1.0.6](https://cran.r-project.org/web/packages/s2/index.html) Spherical Geometry Operators Using the S2 Geometry Library
  ...
  * [sensemakr-0.1.3](https://cran.r-project.org/web/packages/sensemakr/index.html) Sensitivity Analysis Tools for Regression Models
  * [seqLogo-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/seqLogo.html) Sequence logos for DNA sequence alignments
  * [seqinr-4.2-8](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
  * [seqminer-8.0](https://cran.r-project.org/web/packages/seqminer/index.html) Efficiently Read Sequence Data (VCF Format, BCF Format, METAL
Format and BGEN Format) into R
  ...
  * [sf-1.0-2](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
  * [sfsmisc-1.1-11](https://cran.r-project.org/web/packages/sfsmisc/index.html) Utilities from 'Seminar fuer Statistik' ETH Zurich
  * [shadowtext-0.0.8](https://cran.r-project.org/web/packages/shadowtext/index.html) Shadow Text Grob and Layer
  ...
  * [shiny-1.6.0](https://cran.r-project.org/web/packages/shiny/index.html) Web Application Framework for R
  * [shinyBS-0.61](https://cran.r-project.org/web/packages/shinyBS/index.html) Twitter Bootstrap Components for Shiny
  * [shinyFiles-0.9.0](https://cran.r-project.org/web/packages/shinyFiles/index.html) A Server-Side File System Viewer for Shiny
...
Analysis for Bayesian Models
  ...
  * [siggenes-1.66.0](https://www.bioconductor.org/packages/release/bioc/html/siggenes.html) Multiple Testing using SAM and Efron's Empirical Bayes Approaches
...
the SUN
  ...
  * [snpStats-1.42.0](https://www.bioconductor.org/packages/release/bioc/html/snpStats.html) SnpMatrix and XSnpMatrix classes and methods
  ...
  * [spData-0.3.10](https://cran.r-project.org/web/packages/spData/index.html) Datasets for Spatial Analysis
...
Use in Ecological Models
  * [spaMM-3.8.23](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, with or without Spatial Random Effects
  ...
  * [sparklyr-1.7.1](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [sparseMatrixStats-1.4.2](https://www.bioconductor.org/packages/release/bioc/html/sparseMatrixStats.html) Summary Statistics for Rows and Columns of Sparse Matrices
  ...
  * [spatstat.geom-2.2-2](https://cran.r-project.org/web/packages/spatstat.geom/index.html) Geometrical Functionality of the 'spatstat' Family
...
Software
  ...
  * [stopwords-2.2](https://cran.r-project.org/web/packages/stopwords/index.html) Multilingual Stopword Lists
  * [stringdist-0.9.7](https://cran.r-project.org/web/packages/stringdist/index.html) Approximate String Matching, Fuzzy Text Search, and String
Distance Functions
  * [stringi-1.7.4](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
  ...
  * [styler-1.5.1](https://cran.r-project.org/web/packages/styler/index.html) Non-Invasive Pretty Printing of R Code
  ...
  * [sva-3.40.0](https://www.bioconductor.org/packages/release/bioc/html/sva.html) Surrogate Variable Analysis
...
Normal Distribution
  ...
  * [systemPipeR-1.26.3](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
  * [systemfonts-1.0.2](https://cran.r-project.org/web/packages/systemfonts/index.html) System Native Font Finding
...
Exponential-Family Random Graph Models
  * [tergmLite-2.5.0](https://cran.r-project.org/web/packages/tergmLite/index.html) Fast Simulation of Simple Temporal Exponential Random Graph
Models
  * [terra-1.3-22](https://cran.r-project.org/web/packages/terra/index.html) Spatial Data Analysis
  * [testit-0.13](https://cran.r-project.org/web/packages/testit/index.html) A Simple Package for Testing R Packages
  * [testthat-3.0.4](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  * [threejs-0.3.3](https://cran.r-project.org/web/packages/threejs/index.html) Interactive 3D Scatter Plots, Networks and Globes
  * [tibble-3.1.4](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
...
Stack and List Structures
  ...
  * [tidymodels-0.1.3](https://cran.r-project.org/web/packages/tidymodels/index.html) Easily Install and Load the 'Tidymodels' Packages
  ...
  * [tidyr-1.1.3](https://cran.r-project.org/web/packages/tidyr/index.html) Tidy Messy Data
  * [tidyselect-1.1.1](https://cran.r-project.org/web/packages/tidyselect/index.html) Select from a Set of Strings
  * [tidytext-0.3.1](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
  * [tidytree-0.3.5](https://cran.r-project.org/web/packages/tidytree/index.html) A Tidy Tool for Phylogenetic Tree Data Manipulation
  ...
  * [tilingArray-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/tilingArray.html) Transcript mapping with high-density oligonucleotide tiling arrays
  ...
  * [timereg-2.0.0](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
  * [tinytex-0.33](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain TeX Live, and Compile
LaTeX Documents
  * [tkWidgets-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/tkWidgets.html) R based tk widgets
  * [tkrplot-0.0-25](https://cran.r-project.org/web/packages/tkrplot/index.html) TK Rplot
  ...
  * [treeio-1.16.2](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [tsna-0.3.3](https://cran.r-project.org/web/packages/tsna/index.html) Tools for Temporal Social Network Analysis
  ...
  * [twang-2.4](https://cran.r-project.org/web/packages/twang/index.html) Toolkit for Weighting and Analysis of Nonequivalent Groups
  ...
  * [tzdb-0.1.2](https://cran.r-project.org/web/packages/tzdb/index.html) Time Zone Database Information
  ...
  * [usethis-2.0.1](https://cran.r-project.org/web/packages/usethis/index.html) Automate Package and Project Setup
...
for Dimensionality Reduction
  * [vcd-1.4-8](https://cran.r-project.org/web/packages/vcd/index.html) Visualizing Categorical Data
...
Estimates
  * [viridis-0.6.1](https://cran.r-project.org/web/packages/viridis/index.html) Colorblind-Friendly Color Maps for R
  ...
  * [vroom-1.5.4](https://cran.r-project.org/web/packages/vroom/index.html) Read and Write Rectangular Text Data Quickly
  * [vsn-3.60.0](https://www.bioconductor.org/packages/release/bioc/html/vsn.html) Variance stabilization and calibration for microarray data
  * [waldo-0.3.0](https://cran.r-project.org/web/packages/waldo/index.html) Find Differences Between R Objects
...
Signal Processing
  ...
  * [widgetTools-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/widgetTools.html) Creates an interactive tcltk widget
  ...
  * [workflows-0.2.3](https://cran.r-project.org/web/packages/workflows/index.html) Modeling Workflows
  ...
  * xCell 1.1.0
  * [xfun-0.25](https://cran.r-project.org/web/packages/xfun/index.html) Supporting Functions for Packages Maintained by 'Yihui Xie'
  ...
  * [yardstick-0.0.8](https://cran.r-project.org/web/packages/yardstick/index.html) Tidy Characterizations of Model Performance
  * [yulab.utils-0.0.2](https://cran.r-project.org/web/packages/yulab.utils/index.html) Supporting Functions for Packages Maintained by 'YuLab-SMU'
...
Compositional Data Sets
  ...
  * [zlibbioc-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/zlibbioc.html) An R packaged zlib-1.2.5
