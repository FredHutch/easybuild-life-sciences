...
Note: This is is the default package from easybuild. Use R packages with the 'fh'
suffix for the full Fred Hutch R build.
...
Estimation
  ...
  * [spdep-0.7-8](https://cran.r-project.org/web/packages/spdep/index.html) Spatial Dependence: Weighting Schemes, Statistics and Models
  * splines built in
