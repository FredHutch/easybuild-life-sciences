...
Statistics
  ...
  * [Biostrings-2.52.0](https://www.bioconductor.org/packages/release/bioc/html/Biostrings.html) Efficient manipulation of biological strings
...
Q-Learning
  ...
  * [DynDoc-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/DynDoc.html) Dynamic document tools
...
Sensitivity, Identifiability and Monte Carlo Analysis
  ...
  * [GSVA-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/GSVA.html) Gene Set Variation Analysis for microarray and RNA-seq data
...
Model
  ...
  * [Gviz-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/Gviz.html) Plotting data and annotation information along genomic coordinates
  * HCsnip 1.2.0
...
in Environmental Sciences
  ...
  * [affyio-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/affyio.html) Tools for parsing Affymetrix data files
...
Regions
  * [ellipsis-0.2.0.1](https://cran.r-project.org/web/packages/ellipsis/index.html) Tools for Working with ...
...
Makridakis, Wheelwright & Hyndman (1998)
  ...
  * [foreach-1.4.4](https://cran.r-project.org/web/packages/foreach/index.html) Provides Foreach Looping Construct
...
Components Analysis for Large Dense and Sparse Matrices
  * [iterators-1.0.10](https://cran.r-project.org/web/packages/iterators/index.html) Provides Iterator Construct
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [multtest-2.40.0](https://cran.r-project.org/web/packages/multtest/index.html) Resampling-based multiple hypothesis testing
...
Files
  * [ncdfFlow-2.30.1](https://www.bioconductor.org/packages/release/bioc/html/ncdfFlow.html) ncdfFlow: A package that provides HDF5 based storage for flow cytometry data.
...
Data and Resting State Data
  ...
  * [nlme-3.1-140](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
...
Methods)
  ...
  * [oligoClasses-1.46.0](https://www.bioconductor.org/packages/release/bioc/html/oligoClasses.html) Classes for high-throughput arrays supported by oligo and crlmm
  * [openCyto-1.22.2](https://www.bioconductor.org/packages/release/bioc/html/openCyto.html) Hierarchical Gating Pipeline for flow cytometry data
  * [openssl-1.4](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  ...
  * [optparse-1.6.2](https://cran.r-project.org/web/packages/optparse/index.html) Command Line Option Parser
  * [ordinal-2019.4-25](https://cran.r-project.org/web/packages/ordinal/index.html) Regression Models for Ordinal Data
  * [org.Hs.eg.db-3.8.2](https://www.bioconductor.org/packages/release/bioc/html/org.Hs.eg.db.html) Genome wide annotation for Human
  * [pROC-1.15.0](https://cran.r-project.org/web/packages/pROC/index.html) Display and Analyze ROC Curves
...
8601 Formats
  * [parsnip-0.0.2](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
  ...
  * [partykit-1.2-4](https://cran.r-project.org/web/packages/partykit/index.html) A Toolkit for Recursive Partytioning
  ...
  * [pbapply-1.4-0](https://cran.r-project.org/web/packages/pbapply/index.html) Adding Progress Bar to '*apply' Functions
...
Model Comparison
  ...
  * [pcaMethods-1.76.0](https://www.bioconductor.org/packages/release/bioc/html/pcaMethods.html) A collection of PCA methods
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [pkgbuild-1.0.3](https://cran.r-project.org/web/packages/pkgbuild/index.html) Find Tools Needed to Build R Packages
  ...
  * [polyester-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/polyester.html) Simulate RNA-seq reads
...
Abundance and Multilocus Genetic Data
  ...
  * [preprocessCore-1.46.0](https://www.bioconductor.org/packages/release/bioc/html/preprocessCore.html) A collection of pre-processing functions
  ...
  * [processx-3.4.0](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
...
Research
  ...
  * [pulsar-0.3.5](https://cran.r-project.org/web/packages/pulsar/index.html) Parallel Utilities for Lambda Selection along a Regularization
Path
...
Graphical Model Estimation
  ...
  * [qrnn-2.0.4](https://cran.r-project.org/web/packages/qrnn/index.html) Quantile Regression Neural Network
  ...
  * [quantreg-5.41](https://cran.r-project.org/web/packages/quantreg/index.html) Quantile Regression
  * [quantsmooth-1.50.0](https://www.bioconductor.org/packages/release/bioc/html/quantsmooth.html) Quantile smoothing and genomic visualization of array data
  * [questionr-0.7.0](https://cran.r-project.org/web/packages/questionr/index.html) Functions to Make Surveys Processing Easier
  * [qvalue-2.16.0](https://cran.r-project.org/web/packages/qvalue/index.html) Q-value estimation for false discovery rate control
  * [qvcalc-1.0.0](https://cran.r-project.org/web/packages/qvcalc/index.html) Quasi Variances for Factor Effects in Statistical Models
  ...
  * [rGADEM-2.32.0](https://www.bioconductor.org/packages/release/bioc/html/rGADEM.html) de novo motif discovery
...
Regression
  * [randomForestSRC-2.9.0](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
...
and Logs
  * [raster-2.9-5](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [recipes-0.1.6](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing Tools to Create Design Matrices
  ...
  * [rematch2-2.0.1](https://cran.r-project.org/web/packages/rematch2/index.html) Tidy Output from Regular Expression Matching
...
'GitHub'
  ...
  * [reticulate-1.12](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  * [rex-1.1.2](https://cran.r-project.org/web/packages/rex/index.html) Friendly Regular Expressions
  * [rgdal-1.4-4](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  ...
  * [rgl-0.100.24](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  * [rhdf5-2.28.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5.html) R Interface to HDF5
  ...
  * [rmarkdown-1.13](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Ordinary Differential Equations
  * [rotl-3.0.9](https://cran.r-project.org/web/packages/rotl/index.html) Interface to the 'Open Tree of Life' API
  ...
  * [rsample-0.0.4](https://cran.r-project.org/web/packages/rsample/index.html) General Resampling Infrastructure
...
Applications
  ...
  * [rstan-2.18.2](https://cran.r-project.org/web/packages/rstan/index.html) R Interface to Stan
  * [rstanarm-2.18.2](https://cran.r-project.org/web/packages/rstanarm/index.html) Bayesian Applied Regression Modeling via Stan
  * [rstantools-1.5.1](https://cran.r-project.org/web/packages/rstantools/index.html) Tools for Developing R Packages Interfacing with 'Stan'
  * [rstudioapi-0.10](https://cran.r-project.org/web/packages/rstudioapi/index.html) Safely Access the RStudio API
  * [rtracklayer-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  ...
  * [seewave-2.1.3](https://cran.r-project.org/web/packages/seewave/index.html) Sound Analysis and Synthesis
  ...
  * [seqLogo-1.50.0](https://www.bioconductor.org/packages/release/bioc/html/seqLogo.html) Sequence logos for DNA sequence alignments
  ...
  * [sf-0.7-6](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
  ...
  * [shinyFiles-0.7.3](https://cran.r-project.org/web/packages/shinyFiles/index.html) A Server-Side File System Viewer for Shiny
...
Analysis for Bayesian Models
  ...
  * [sigaR-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/sigaR.html) Statistics for Integrative Genomics Analyses in R
  * [siggenes-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/siggenes.html) Multiple Testing using SAM and Efron's Empirical Bayes Approaches
...
Estimation
  ...
  * [snpStats-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/snpStats.html) SnpMatrix and XSnpMatrix classes and methods
  ...
  * [spData-0.3.0](https://cran.r-project.org/web/packages/spData/index.html) Datasets for Spatial Analysis
  * [spaMM-3.0.0](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, Particularly Spatial Models
  * [spam-2.2-2](https://cran.r-project.org/web/packages/spam/index.html) SPArse Matrix
  * [sparklyr-1.0.2](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [spatial-7.3-11](https://cran.r-project.org/web/packages/spatial/index.html) Functions for Kriging and Point Pattern Analysis
  * [spatstat-1.60-1](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  ...
  * [spdep-1.1-2](https://cran.r-project.org/web/packages/spdep/index.html) Spatial Dependence: Weighting Schemes, Statistics and Models
  * splines built in
...
Software
  * stats built in
  * stats4 built in
  * [stopwords-0.9.0](https://cran.r-project.org/web/packages/stopwords/index.html) Multilingual Stopword Lists
  * [stringdist-0.9.5.2](https://cran.r-project.org/web/packages/stringdist/index.html) Approximate String Matching and String Distance Functions
  ...
  * [svd-0.4.3](https://cran.r-project.org/web/packages/svd/index.html) Interfaces to Various State-of-Art SVD and Eigensolvers
  * synapser 0.6.56
  ...
  * [systemPipeR-1.18.2](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
...
Exponential-Family Random Graph Models
  * [testthat-2.1.1](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  ...
  * [tidymodels-0.0.2](https://cran.r-project.org/web/packages/tidymodels/index.html) Easily Install and Load the 'Tidymodels' Packages
  ...
  * [tidypredict-0.3.0](https://cran.r-project.org/web/packages/tidypredict/index.html) Run Predictions Inside the Database
  * [tidyr-0.8.3](https://cran.r-project.org/web/packages/tidyr/index.html) Easily Tidy Data with 'spread()' and 'gather()' Functions
  * [tidyselect-0.2.5](https://cran.r-project.org/web/packages/tidyselect/index.html) Select from a Set of Strings
  * [tidytext-0.2.1](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
  ...
  * [tilingArray-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/tilingArray.html) Transcript mapping with high-density oligonucleotide tiling arrays
  ...
  * [timereg-1.9.3](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
  * [tinytex-0.14](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain 'TeX Live', and Compile
'LaTeX' Documents
  * [tkWidgets-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/tkWidgets.html) R based tk widgets
  ...
  * [treeio-1.8.1](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [units-0.6-3](https://cran.r-project.org/web/packages/units/index.html) Measurement Units for R Vectors
  ...
  * [uroot-2.0-9.1](https://cran.r-project.org/web/packages/uroot/index.html) Unit Root Tests for Seasonal Time Series
  * [usethis-1.5.0](https://cran.r-project.org/web/packages/usethis/index.html) Automate Package and Project Setup
  ...
  * [vctrs-0.1.0](https://cran.r-project.org/web/packages/vctrs/index.html) Vector Helpers
  * [vegan-2.5-5](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
  * [venn-1.7](https://cran.r-project.org/web/packages/venn/index.html) Draw Venn Diagrams
  * [vioplot-0.3.0](https://cran.r-project.org/web/packages/vioplot/index.html) Violin Plot
...
Estimates
  ...
  * [visNetwork-2.0.6](https://cran.r-project.org/web/packages/visNetwork/index.html) Network Visualization using 'vis.js' Library
  * [vsn-3.52.0](https://www.bioconductor.org/packages/release/bioc/html/vsn.html) Variance stabilization and calibration for microarray data
...
Signal Processing
  ...
  * [widgetTools-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/widgetTools.html) Creates an interactive tcltk widget
  ...
  * [worrms-0.3.2](https://cran.r-project.org/web/packages/worrms/index.html) World Register of Marine Species (WoRMS) Client
  * xCell 1.2
  * [xfun-0.7](https://cran.r-project.org/web/packages/xfun/index.html) Miscellaneous Functions by 'Yihui Xie'
  ...
  * [yardstick-0.0.3](https://cran.r-project.org/web/packages/yardstick/index.html) Tidy Characterizations of Model Performance
  * [zeallot-0.1.0](https://cran.r-project.org/web/packages/zeallot/index.html) Multiple, Unpacking, and Destructuring Assignment
  * [zip-2.0.2](https://cran.r-project.org/web/packages/zip/index.html) Cross-Platform 'zip' Compression
  * [zlibbioc-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/zlibbioc.html) An R packaged zlib-1.2.5
  * [zoo-1.8-5](https://cran.r-project.org/web/packages/zoo/index.html) S3 Infrastructure for Regular and Irregular Time Series (Z's
