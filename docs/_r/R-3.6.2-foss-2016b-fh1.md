...
Statistics
  ...
  * [BiocParallel-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/BiocParallel.html) Bioconductor facilities for parallel evaluation
  * [BiocStyle-2.14.0](https://www.bioconductor.org/packages/release/bioc/html/BiocStyle.html) Standard styles for vignettes and other Bioconductor documents
  ...
  * [COMPASS-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/COMPASS.html) Combinatorial Polyfunctionality Analysis of Single Cells
...
PostScript) and Display (X11 and Win32) Output
  ...
  * [ChIPpeakAnno-3.20.0](https://www.bioconductor.org/packages/release/bioc/html/ChIPpeakAnno.html) Batch annotation of the peaks identified from either ChIP-seq, ChIP-chip experiments or any experiments resulted in large number of chromosome ranges
  ...
  * [CytoML-1.12.0](https://www.bioconductor.org/packages/release/bioc/html/CytoML.html) A GatingML Interface for Cross Platform Cytometry Data Sharing
...
Q-Learning, and Dynamic Weighted Survival Modeling (DWSurv)
  * [DelayedArray-0.12.0](https://www.bioconductor.org/packages/release/bioc/html/DelayedArray.html) A unified framework for working transparently with on-disk and in-memory array-like datasets
  ...
  * [EBImage-4.28.0](https://www.bioconductor.org/packages/release/bioc/html/EBImage.html) Image processing and analysis toolbox for R
  ...
  * [EpiModel-1.7.3](https://cran.r-project.org/web/packages/EpiModel/index.html) Mathematical Modeling of Infectious Disease Dynamics
...
Model
  ...
  * [GenomeInfoDb-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/GenomeInfoDb.html) Utilities for manipulating chromosome names, including modifying them to follow a particular naming style
  ...
  * [GenomicFeatures-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicFeatures.html) Conveniently import and query gene models
  ...
  * [Gviz-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/Gviz.html) Plotting data and annotation information along genomic coordinates
  * HCsnip 1.2.0
  * [HDF5Array-1.14.1](https://www.bioconductor.org/packages/release/bioc/html/HDF5Array.html) HDF5 backend for DelayedArray objects
  * [HMMcopy-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/HMMcopy.html) Copy number prediction with correction for GC and mappability bias for HTS data
...
(www.zhaw.ch/idp)'
  ...
  * [IRanges-2.20.1](https://www.bioconductor.org/packages/release/bioc/html/IRanges.html) Foundation of integer range manipulation in Bioconductor
...
Buttlar
  ...
  * [LogicReg-1.6.1](https://cran.r-project.org/web/packages/LogicReg/index.html) Logic Regression
...
Optimization
  ...
  * [MatrixEQTL-2.2](https://cran.r-project.org/web/packages/MatrixEQTL/index.html) Matrix eQTL: Ultra Fast eQTL Analysis via Large Matrix
Operations
...
Metric
  ...
  * [REDCapR-0.10.2](https://cran.r-project.org/web/packages/REDCapR/index.html) Interaction Between R and REDCap
...
(SNNS)
  ...
  * [RcppAnnoy-0.0.14](https://cran.r-project.org/web/packages/RcppAnnoy/index.html) 'Rcpp' Bindings for 'Annoy', a Library for Approximate Nearest
Neighbors
...
Library
  ...
  * [RcppParallel-4.4.4](https://cran.r-project.org/web/packages/RcppParallel/index.html) Parallel Programming Tools for 'Rcpp'
...
Packages
  ...
  * [Rhtslib-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/Rhtslib.html) HTSlib high-throughput sequencing library as an R package
  * [Ringo-1.50.0](https://www.bioconductor.org/packages/release/bioc/html/Ringo.html) R Investigation of ChIP-chip Oligoarrays
  * [Rlabkey-2.3.3](https://cran.r-project.org/web/packages/Rlabkey/index.html) Data Exchange Between R and 'LabKey' Server
  ...
  * [Rsamtools-2.2.1](https://www.bioconductor.org/packages/release/bioc/html/Rsamtools.html) Binary alignment (BAM), FASTA, variant call (BCF), and tabix file import
  * [Rssa-1.0](https://cran.r-project.org/web/packages/Rssa/index.html) A Collection of Methods for Singular Spectrum Analysis
  * [Rsubread-2.0.0](https://www.bioconductor.org/packages/release/bioc/html/Rsubread.html) Subread Sequence Alignment and Counting for R
...
Implementation
  ...
  * [S4Vectors-0.24.1](https://www.bioconductor.org/packages/release/bioc/html/S4Vectors.html) Foundation of vector-like and list-like containers in Bioconductor
...
Algorithms
  * [SeqArray-1.26.1](https://www.bioconductor.org/packages/release/bioc/html/SeqArray.html) Data Management of Large-scale Whole-genome Sequence Variant Calls
  * [SeqVarTools-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/SeqVarTools.html) Tools for variant data
  * [Seurat-3.1.1](https://cran.r-project.org/web/packages/Seurat/index.html) Tools for Single Cell Genomics
  * [ShortRead-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/ShortRead.html) FASTQ input and manipulation
...
Regression
  ...
  * [StanHeaders-2.19.0](https://cran.r-project.org/web/packages/StanHeaders/index.html) C++ Header Files for Stan
  * [SummarizedExperiment-1.16.0](https://www.bioconductor.org/packages/release/bioc/html/SummarizedExperiment.html) SummarizedExperiment container
...
in Environmental Sciences
  ...
  * [affycoretools-1.58.2](https://www.bioconductor.org/packages/release/bioc/html/affycoretools.html) Functions useful for those doing repetitive analyses with Affymetrix GeneChips
...
Files
  ...
  * [biomaRt-2.42.0](https://www.bioconductor.org/packages/release/bioc/html/biomaRt.html) Interface to BioMart databases (i.e. Ensembl)
  * [biovizBase-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/biovizBase.html) Basic graphic utilities for visualization of genomic data.
...
Inference
  ...
  * [bookdown-0.16](https://cran.r-project.org/web/packages/bookdown/index.html) Authoring Books and Technical Documents with R Markdown
...
Plots
  ...
  * [dada2-1.14.0](https://www.bioconductor.org/packages/release/bioc/html/dada2.html) Accurate, high-resolution sample inference from amplicon sequencing data
...
Flow Diagrams
  * [dials-0.0.4](https://cran.r-project.org/web/packages/dials/index.html) Tools for Creating Tuning Parameter Values
...
Package
  * [doBy-4.6-3](https://cran.r-project.org/web/packages/doBy/index.html) Groupwise Statistics, LSmeans, Linear Contrasts, Utilities
...
Theory Group (Formerly: E1071), TU Wien
  * [edgeR-3.28.0](https://www.bioconductor.org/packages/release/bioc/html/edgeR.html) Empirical Analysis of Digital Gene Expression Data in R
...
Regions
  ...
  * [epitools-0.5-10](https://cran.r-project.org/web/packages/epitools/index.html) Epidemiology Tools
...
Censored Data
  ...
  * [flowCore-1.52.0](https://www.bioconductor.org/packages/release/bioc/html/flowCore.html) flowCore: Basic structures for flow cytometry data
  ...
  * [flowWorkspace-3.34.0](https://www.bioconductor.org/packages/release/bioc/html/flowWorkspace.html) Infrastructure for representing and interacting with gated and ungated cytometry data sets.
...
'Systat', 'Weka', 'dBase', ...
  ...
  * [future.apply-1.3.0](https://cran.r-project.org/web/packages/future.apply/index.html) Apply Function to Elements in Parallel using Futures
...
and Shape
  ...
  * [geepack-1.3-0](https://cran.r-project.org/web/packages/geepack/index.html) Generalized Estimating Equation Package
...
Enhancements
  ...
  * [ggcyto-1.14.0](https://www.bioconductor.org/packages/release/bioc/html/ggcyto.html) Visualize Cytometry data with ggplot
...
'ggplot2'
  ...
  * [ggtree-2.0.1](https://www.bioconductor.org/packages/release/bioc/html/ggtree.html) an R package for visualization of tree and annotation data
...
when Linkage Phase is Ambiguous
  ...
  * [hypergate-0.8.1](https://cran.r-project.org/web/packages/hypergate/index.html) Machine Learning of Hyperrectangular Gating Strategies for
...
Loops
  ...
  * [leiden-0.3.1](https://cran.r-project.org/web/packages/leiden/index.html) R Implementation of Leiden Clustering Algorithm
  ...
  * [limma-3.42.0](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
  * [linprog-0.9-2](https://cran.r-project.org/web/packages/linprog/index.html) Linear Programming / Optimization
  * [lintr-2.0.0](https://cran.r-project.org/web/packages/lintr/index.html) A 'Linter' for R Code
...
Classification, and Density Estimation
  ...
  * [metagenomeSeq-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/metagenomeSeq.html) Statistical analysis for sparse high-throughput sequencing
  * [metap-1.2](https://cran.r-project.org/web/packages/metap/index.html) Meta-Analysis of Significance Values
  * methods built in
  * [methylumi-2.32.0](https://www.bioconductor.org/packages/release/bioc/html/methylumi.html) Handle Illumina methylation data
  * [mets-1.2.6](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [mixOmics-6.10.6](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
  ...
  * [mutoss-0.1-12](https://cran.r-project.org/web/packages/mutoss/index.html) Unified Multiple Testing Procedures
...
8601 Formats
  * [parsnip-0.0.4](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
...
Model Comparison
  ...
  * [pdftools-2.3](https://cran.r-project.org/web/packages/pdftools/index.html) Text Extraction, Rendering and Converting of PDF Documents
...
Graphical Model Estimation
  ...
  * [quantreg-5.52](https://cran.r-project.org/web/packages/quantreg/index.html) Quantile Regression
  ...
  * [qvcalc-1.0.1](https://cran.r-project.org/web/packages/qvcalc/index.html) Quasi Variances for Factor Effects in Statistical Models
  ...
  * [rGADEM-2.34.0](https://www.bioconductor.org/packages/release/bioc/html/rGADEM.html) de novo motif discovery
...
and Logs
  ...
  * [rasterVis-0.46](https://cran.r-project.org/web/packages/rasterVis/index.html) Visualization Methods for Raster Data
...
'Ensembl' and 'UCSC' Genome Browsers
  ...
  * [regioneR-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/regioneR.html) Association analysis of genomic regions based on permutation tests
...
'GitHub'
  ...
  * [repr-1.0.1](https://cran.r-project.org/web/packages/repr/index.html) Serializable Representations
  ...
  * [rmarkdown-1.18](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Ordinary Differential Equations
  ...
  * [rsample-0.0.5](https://cran.r-project.org/web/packages/rsample/index.html) General Resampling Infrastructure
  * [rsconnect-0.8.15](https://cran.r-project.org/web/packages/rsconnect/index.html) Deployment Interface for R Markdown Documents and Shiny
Applications
  * [rslurm-0.5.0](https://cran.r-project.org/web/packages/rslurm/index.html) Submit R Calculations to a 'Slurm' Cluster
  * [rstan-2.19.2](https://cran.r-project.org/web/packages/rstan/index.html) R Interface to Stan
  * [rstanarm-2.19.2](https://cran.r-project.org/web/packages/rstanarm/index.html) Bayesian Applied Regression Modeling via Stan
  ...
  * [rsvd-1.0.2](https://cran.r-project.org/web/packages/rsvd/index.html) Randomized Singular Value Decomposition
  ...
  * [rvcheck-0.1.7](https://cran.r-project.org/web/packages/rvcheck/index.html) R/Package Version Check
  ...
  * [sctransform-0.2.0](https://cran.r-project.org/web/packages/sctransform/index.html) Variance Stabilizing Transformations for Single Cell UMI Data
  ...
  * [shinyFiles-0.7.5](https://cran.r-project.org/web/packages/shinyFiles/index.html) A Server-Side File System Viewer for Shiny
...
Estimation
  ...
  * [sparklyr-1.0.5](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
...
Stack and List structures.
  ...
  * [tidymodels-0.0.3](https://cran.r-project.org/web/packages/tidymodels/index.html) Easily Install and Load the 'Tidymodels' Packages
  ...
  * [tidypredict-0.4.3](https://cran.r-project.org/web/packages/tidypredict/index.html) Run Predictions Inside the Database
  ...
  * [tidytree-0.3.0](https://cran.r-project.org/web/packages/tidytree/index.html) A Tidy Tool for Phylogenetic Tree Data Manipulation
  ...
  * [timeSeries-3042.102](https://cran.r-project.org/web/packages/timeSeries/index.html) Financial Time Series Objects (Rmetrics)
...
'LaTeX' Documents
  ...
  * [uwot-0.1.5](https://cran.r-project.org/web/packages/uwot/index.html) The Uniform Manifold Approximation and Projection (UMAP) Method
...
Signal Processing
  ...
  * [yardstick-0.0.4](https://cran.r-project.org/web/packages/yardstick/index.html) Tidy Characterizations of Model Performance
