...
### Package List
  ...
  * [AnnotationHub-2.12.1](https://www.bioconductor.org/packages/release/bioc/html/AnnotationHub.html) Client to access AnnotationHub resources
  ...
  * [DelayedArray-0.6.6](https://www.bioconductor.org/packages/release/bioc/html/DelayedArray.html) Delayed operations on array-like objects
  ...
  * [GENESIS-2.10.1](https://www.bioconductor.org/packages/release/bioc/html/GENESIS.html) GENetic EStimation and Inference in Structured samples (GENESIS): Statistical methods for analyzing genetic data from samples with population structure and/or relatedness
  ...
  * [GenomicFeatures-1.32.3](https://www.bioconductor.org/packages/release/bioc/html/GenomicFeatures.html) Tools for making and manipulating transcript centric annotations
  ...
  * [GenomicRanges-1.32.7](https://www.bioconductor.org/packages/release/bioc/html/GenomicRanges.html) Representation and manipulation of genomic intervals and variables defined along a genome
  ...
  * [IRanges-2.14.12](https://www.bioconductor.org/packages/release/bioc/html/IRanges.html) Infrastructure for manipulating intervals on sequences
  * [IRdisplay-0.6](https://cran.r-project.org/web/packages/IRdisplay/index.html) 'Jupyter' Display Machinery
  ...
  * [KEGGREST-1.20.2](https://www.bioconductor.org/packages/release/bioc/html/KEGGREST.html) Client-side REST access to KEGG
  ...
  * [KEGGprofile-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/KEGGprofile.html) An annotation and visualization package for multi-types and multi-groups expression data in KEGG pathway
...
Models
  ...
  * [RcppParallel-4.4.1](https://cran.r-project.org/web/packages/RcppParallel/index.html) Parallel Programming Tools for 'Rcpp'
  ...
  * [Rlabkey-2.2.3](https://cran.r-project.org/web/packages/Rlabkey/index.html) Data Exchange Between R and 'LabKey' Server
  * [Rsamtools-1.32.3](https://www.bioconductor.org/packages/release/bioc/html/Rsamtools.html) Binary alignment (BAM), FASTA, variant call (BCF), and tabix file import
  * [Rsubread-1.30.9](https://www.bioconductor.org/packages/release/bioc/html/Rsubread.html) Subread sequence alignment and counting for R
...
(GWAS)
  ...
  * [SeqArray-1.20.2](https://www.bioconductor.org/packages/release/bioc/html/SeqArray.html) Big Data Management of Whole-genome Sequence Variant Calls
  ...
  * [StanHeaders-2.18.0](https://cran.r-project.org/web/packages/StanHeaders/index.html) C++ Header Files for Stan
...
Visualizing Intersecting Sets
  ...
  * [biovizBase-1.28.2](https://www.bioconductor.org/packages/release/bioc/html/biovizBase.html) Basic graphic utilities for visualization of genomic data.
  ...
  * [clue-0.3-56](https://cran.r-project.org/web/packages/clue/index.html) Cluster Ensembles
...
Plots
  ...
  * [edgeR-3.22.5](https://www.bioconductor.org/packages/release/bioc/html/edgeR.html) Empirical Analysis of Digital Gene Expression Data in R
...
One-Dimensional Multivariate, and Two-Dimensional Transform
  ...
  * [flowCore-1.46.2](https://www.bioconductor.org/packages/release/bioc/html/flowCore.html) flowCore: Basic structures for flow cytometry data
  ...
  * [flowWorkspace-3.28.2](https://www.bioconductor.org/packages/release/bioc/html/flowWorkspace.html) Infrastructure for representing and interacting with the gated cytometry
  * [forge-0.1.0](https://cran.r-project.org/web/packages/forge/index.html) Casting Values into Shape
...
Enhancements
  * [ggbio-1.28.5](https://www.bioconductor.org/packages/release/bioc/html/ggbio.html) Visualization tools for genomic data
  * [ggthemes-4.0.1](https://cran.r-project.org/web/packages/ggthemes/index.html) Extra Themes, Scales and Geoms for 'ggplot2'
  * [ggtree-1.12.7](https://www.bioconductor.org/packages/release/bioc/html/ggtree.html) an R package for visualization and annotation of phylogenetic trees with their covariates and other associated data
...
Proportional Hazards Model
  ...
  * [graph-1.58.2](https://cran.r-project.org/web/packages/graph/index.html) graph: A package to handle graph data structures
...
when Linkage Phase is Ambiguous
  ...
  * [kyotil-2018.7-16](https://cran.r-project.org/web/packages/kyotil/index.html) Utility Functions for Statistical Analysis Report Generation and
Monte Carlo Studies
  ...
  * [limma-3.36.5](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
...
Bandwidth
  ...
  * [mets-1.2.4](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
...
Dependencies
  ...
  * [r2d3-0.2.2](https://cran.r-project.org/web/packages/r2d3/index.html) Interface to 'D3' Visualizations
...
and Logs
  ...
  * [rhdf5-2.24.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5.html) HDF5 interface to R
...
Applications
  ...
  * [rtracklayer-1.40.6](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  * [rvcheck-0.1.1](https://cran.r-project.org/web/packages/rvcheck/index.html) R/Package Version Check
  * [rzmq-0.9.4](https://cran.r-project.org/web/packages/rzmq/index.html) R Bindings for 'ZeroMQ'
  ...
  * [seqLogo-1.46.0](https://www.bioconductor.org/packages/release/bioc/html/seqLogo.html) Sequence logos for DNA sequence alignments
  ...
  * [shinyFiles-0.7.1](https://cran.r-project.org/web/packages/shinyFiles/index.html) A Server-Side File System Viewer for Shiny
  ...
  * [sigaR-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/sigaR.html) Statistics for Integrative Genomics Analyses in R
  * [siggenes-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/siggenes.html) Multiple testing using SAM and Efron's empirical Bayes approaches
  * [snpStats-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/snpStats.html) SnpMatrix and XSnpMatrix classes and methods
  * [sparklyr-0.9.2](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [sqldf-0.4-11](https://cran.r-project.org/web/packages/sqldf/index.html) Manipulate R Data Frames Using SQL
  * [ssgraph-1.4](https://cran.r-project.org/web/packages/ssgraph/index.html) Bayesian Graphical Estimation using Spike-and-Slab Priors
  ...
  * [survey-3.34](https://cran.r-project.org/web/packages/survey/index.html) Analysis of Complex Survey Samples
  * synapseClient 1.13-4
  * [systemPipeR-1.14.0](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
  * [tables-0.8.4](https://cran.r-project.org/web/packages/tables/index.html) Formula-Driven Table Generation
...
Exponential-Family Random Graph Models
  * [tidytree-0.1.9](https://cran.r-project.org/web/packages/tidytree/index.html) A Tidy Tool for Phylogenetic Tree Data Manipulation
  * [tilingArray-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/tilingArray.html) Transcript mapping with high-density oligonucleotide tiling arrays
  * [timeSeries-3042.102](https://cran.r-project.org/web/packages/timeSeries/index.html) Rmetrics - Financial Time Series Objects
  * [tkWidgets-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/tkWidgets.html) R based tk widgets
  * [tmle-1.3.0-1](https://cran.r-project.org/web/packages/tmle/index.html) Targeted Maximum Likelihood Estimation
  * [treeio-1.4.3](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [vsn-3.48.1](https://www.bioconductor.org/packages/release/bioc/html/vsn.html) Variance stabilization and calibration for microarray data
  ...
  * [widgetTools-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/widgetTools.html) Creates an interactive tcltk widget
  * [zlibbioc-1.26.0](https://www.bioconductor.org/packages/release/bioc/html/zlibbioc.html) An R packaged zlib-1.2.5
