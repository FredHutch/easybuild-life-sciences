...
PostScript) and display (X11 and Win32) output
  ...
  * [DBI-0.6-1](https://cran.r-project.org/web/packages/DBI/index.html) R Database Interface
...
Analysis for Multiblock Data
  ...
  * [RMySQL-0.10.11](https://cran.r-project.org/web/packages/RMySQL/index.html) Database Interface and 'MySQL' Driver for R
...
(SNNS)
  ...
  * [RWeka-0.4-33](https://cran.r-project.org/web/packages/RWeka/index.html) R/Weka Interface
  ...
  * [RcppArmadillo-0.7.800.2.0](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
...
Library
  ...
  * [Rlabkey-2.1.134](https://cran.r-project.org/web/packages/Rlabkey/index.html) Data Exchange Between R and 'LabKey' Server
  ...
  * [StanHeaders-2.15.0-1](https://cran.r-project.org/web/packages/StanHeaders/index.html) C++ Header Files for Stan
...
Sequences
  * [VGAM-1.0-3](https://cran.r-project.org/web/packages/VGAM/index.html) Vector Generalized Linear and Additive Models
  ...
  * [XML-3.98-1.6](https://cran.r-project.org/web/packages/XML/index.html) Tools for Parsing and Generating XML Within R and S-Plus
...
Files
  ...
  * [bit64-0.9-5](https://cran.r-project.org/web/packages/bit64/index.html) A S3 Class for Vectors of 64bit Integers
  * [bitops-1.0-6](https://cran.r-project.org/web/packages/bitops/index.html) Bitwise Operations
  * [bnlearn-4.1.1](https://cran.r-project.org/web/packages/bnlearn/index.html) Bayesian Network Structure Learning, Parameter Learning and
Inference
  * [bold-0.4.0](https://cran.r-project.org/web/packages/bold/index.html) Interface to Bold Systems API
  * [boot-1.3-19](https://cran.r-project.org/web/packages/boot/index.html) Bootstrap Functions (Originally by Angelo Canty for S)
  ...
  * [cellranger-2.0.0](https://cran.r-project.org/web/packages/cellranger/index.html) Translate Spreadsheet Cell Ranges to Rows and Columns
...
al.
  ...
  * [crul-0.3.4](https://cran.r-project.org/web/packages/crul/index.html) HTTP Client
  ...
  * [curl-2.5](https://cran.r-project.org/web/packages/curl/index.html) A Modern and Flexible Web Client for R
...
'Systat', 'Weka', 'dBase', ...
  ...
  * [gam-1.14-3](https://cran.r-project.org/web/packages/gam/index.html) Generalized Additive Models
...
Network
  ...
  * [irace-2.2](https://cran.r-project.org/web/packages/irace/index.html) Iterated Racing for Automatic Algorithm Configuration
...
Components Analysis for Large Dense and Sparse Matrices
  ...
  * [jsonlite-1.4](https://cran.r-project.org/web/packages/jsonlite/index.html) A Robust, High Performance JSON Parser and Generator for R
...
Multilocus Genetic Data
  * [pracma-2.0.4](https://cran.r-project.org/web/packages/pracma/index.html) Practical Numerical Math Functions
  ...
  * [psych-1.7.3.21](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
...
Graphical Model Estimation
  ...
  * [quantmod-0.4-8](https://cran.r-project.org/web/packages/quantmod/index.html) Quantitative Financial Modelling Framework
...
and Logs
  ...
  * [readr-1.1.0](https://cran.r-project.org/web/packages/readr/index.html) Read Rectangular Text Data
  ...
  * [rmarkdown-1.4](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Ordinary Differential Equations
  ...
  * [rstan-2.15.1](https://cran.r-project.org/web/packages/rstan/index.html) R Interface to Stan
  ...
  * [rzmq-0.9.1](https://cran.r-project.org/web/packages/rzmq/index.html) R Bindings for 'ZeroMQ'
  ...
  * [scatterplot3d-0.3-39](https://cran.r-project.org/web/packages/scatterplot3d/index.html) 3D Scatter Plot
  ...
  * [seqinr-3.3-6](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
  ...
  * [shiny-1.0.2](https://cran.r-project.org/web/packages/shiny/index.html) Web Application Framework for R
...
Estimation
  ...
  * [sparklyr-0.5.3](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [spatial-7.3-11](https://cran.r-project.org/web/packages/spatial/index.html) Functions for Kriging and Point Pattern Analysis
  * [spatstat-1.50-0](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  * [spatstat.utils-1.4-1](https://cran.r-project.org/web/packages/spatstat.utils/index.html) Utility Functions for 'spatstat'
  * [spdep-0.6-12](https://cran.r-project.org/web/packages/spdep/index.html) Spatial Dependence: Weighting Schemes, Statistics and Models
  * splines built in
...
Exponential-Family Random Graph Models
  ...
  * [tibble-1.3.0](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
  ...
  * [tseries-0.10-40](https://cran.r-project.org/web/packages/tseries/index.html) Time Series Analysis and Computational Finance
