...
and Shape
  ...
  * [gdsfmt-1.30.0](https://cran.r-project.org/web/packages/gdsfmt/index.html) R Interface to CoreArray Genomic Data Structure (GDS) files
...
Applications
  ...
  * [rsvg-2.1.2](https://cran.r-project.org/web/packages/rsvg/index.html) Render SVG Images into PDF, PNG, PostScript, or Bitmap Arrays
