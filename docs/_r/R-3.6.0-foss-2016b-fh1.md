...
### Known Issues
 * Major and minor version numbers are part of the user search path.  User installed libraries for 3.5.x R need to be re-installed for use with 3.6.x.

 * There is a bug with devtools which does not set the default path for
...
Dependencies
  ...
  * [repr-1.0.0](https://cran.r-project.org/web/packages/repr/index.html) Serializable Representations
...
Analysis for Bayesian Models
  ...
  * [tidytext-0.2.0](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
