...
Sensitivity, Identifiability and Monte Carlo Analysis
  ...
  * [GJRM-0.2-6.1](https://cran.r-project.org/web/packages/GJRM/index.html) Generalised Joint Regression Modelling
...
(CGDS)
  ...
  * [changepoint-2.2.4](https://cran.r-project.org/web/packages/changepoint/index.html) Methods for Changepoint Detection
...
Enhancements
  ...
  * [ggplot2-3.4.2](https://cran.r-project.org/web/packages/ggplot2/index.html) Create Elegant Data Visualisations Using the Grammar of Graphics
...
Arrays/Dictionaries
  ...
  * [httr-1.4.6](https://cran.r-project.org/web/packages/httr/index.html) Tools for Working with URLs and HTTP
...
Loops
  ...
  * [leaflet-2.1.2](https://cran.r-project.org/web/packages/leaflet/index.html) Create Interactive Web Maps with the JavaScript 'Leaflet'
Library
...
Likelihood or Least Squares
  ...
  * [maptools-1.1-7](https://cran.r-project.org/web/packages/maptools/index.html) Tools for Handling Spatial Objects
  ...
  * [matrixStats-0.63.0](https://cran.r-project.org/web/packages/matrixStats/index.html) Functions that Apply to Rows and Columns of Matrices (and to
Vectors)
...
Classification, and Density Estimation
  ...
  * [memisc-0.99.31.6](https://cran.r-project.org/web/packages/memisc/index.html) Management of Survey Data and Presentation of Analysis Results
  ...
  * [metafor-4.2-0](https://cran.r-project.org/web/packages/metafor/index.html) Meta-Analysis Package for R
  * methods built in 
  * [mets-1.3.2](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
  * [mgcv-1.8-42](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
  ...
  * [mice-3.15.0](https://cran.r-project.org/web/packages/mice/index.html) Multivariate Imputation by Chained Equations
  * [miceadds-3.16-18](https://cran.r-project.org/web/packages/miceadds/index.html) Some Additional Multiple Imputation Functions, Especially for
'mice'
...
Analysis
  ...
  * [minpack.lm-1.2-3](https://cran.r-project.org/web/packages/minpack.lm/index.html) R Interface to the Levenberg-Marquardt Nonlinear Least-Squares
...
Approximation
  * [mirt-1.39](https://cran.r-project.org/web/packages/mirt/index.html) Multidimensional Item Response Theory
  ...
  * [mlbench-2.1-3.1](https://cran.r-project.org/web/packages/mlbench/index.html) Machine Learning Benchmark Problems
...
Versions
  ...
  * [mosaicCore-0.9.2.1](https://cran.r-project.org/web/packages/mosaicCore/index.html) Common Utilities for Other MOSAIC-Family Packages
  * [mpath-0.4-2.23](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
  * [msm-1.7](https://cran.r-project.org/web/packages/msm/index.html) Multi-State Markov and Hidden Markov Models in Continuous Time
...
Models
  * [multcomp-1.4-23](https://cran.r-project.org/web/packages/multcomp/index.html) Simultaneous Inference in General Parametric Models
  * [multcompView-0.1-9](https://cran.r-project.org/web/packages/multcompView/index.html) Visualizations of Paired Comparisons
...
Dimensions
  * [naniar-1.0.0](https://cran.r-project.org/web/packages/naniar/index.html) Data Structures, Summaries, and Visualisations for Missing Data
  ...
  * [ncdf4-1.21](https://cran.r-project.org/web/packages/ncdf4/index.html) Interface to Unidata netCDF (Version 4 or Earlier) Format Data
Files
...
Linear Mixed Models for Areal Data
  ...
  * [nlme-3.1-162](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
...
Methods)
  * [norm-1.0-11.0](https://cran.r-project.org/web/packages/norm/index.html) Analysis of Multivariate Normal Datasets with Missing Values
  ...
  * [oce-1.8-0](https://cran.r-project.org/web/packages/oce/index.html) Analysis of Oceanographic Data
  * [oddsratio-2.0.1](https://cran.r-project.org/web/packages/oddsratio/index.html) Odds Ratio Calculation for GAM(M)s & GLM(M)s
  * [openair-2.17-0](https://cran.r-project.org/web/packages/openair/index.html) Tools for the Analysis of Air Pollution Data
  * [openssl-2.0.6](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  ...
  * [optmatch-0.10.6](https://cran.r-project.org/web/packages/optmatch/index.html) Functions for Optimal Matching
...
Polynomials
  ...
  * [packrat-0.9.1](https://cran.r-project.org/web/packages/packrat/index.html) A Dependency Management System for Projects and their R Package
Dependencies
  * [pacman-0.5.1](https://cran.r-project.org/web/packages/pacman/index.html) Package Management Tool
  * [pammtools-0.5.91](https://cran.r-project.org/web/packages/pammtools/index.html) Piece-Wise Exponential Additive Mixed Modeling Tools for
Survival Analysis
  ...
  * [parallelly-1.36.0](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
...
8601 Formats
  * [party-1.3-13](https://cran.r-project.org/web/packages/party/index.html) A Laboratory for Recursive Partytioning
  * [partykit-1.2-20](https://cran.r-project.org/web/packages/partykit/index.html) A Toolkit for Recursive Partytioning
  ...
  * [pbapply-1.7-0](https://cran.r-project.org/web/packages/pbapply/index.html) Adding Progress Bar to '*apply' Functions
...
in GLMs and in the Cox Model
  ...
  * [phytools-1.5-1](https://cran.r-project.org/web/packages/phytools/index.html) Phylogenetic Tools for Comparative Biology (and Other Things)
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [pkgbuild-1.4.0](https://cran.r-project.org/web/packages/pkgbuild/index.html) Find Tools Needed to Build R Packages
  * [pkgconfig-2.0.3](https://cran.r-project.org/web/packages/pkgconfig/index.html) Private Configuration for 'R' Packages
  * [pkgdown-2.0.7](https://cran.r-project.org/web/packages/pkgdown/index.html) Make Static HTML Documentation for a Package
  * [pkgload-1.3.2](https://cran.r-project.org/web/packages/pkgload/index.html) Simulate Package Installation and Attach
  ...
  * [plotly-4.10.1](https://cran.r-project.org/web/packages/plotly/index.html) Create Interactive Web Graphics via 'plotly.js'
  ...
  * [pls-2.8-2](https://cran.r-project.org/web/packages/pls/index.html) Partial Least Squares and Principal Component Regression
  * [plyr-1.8.8](https://cran.r-project.org/web/packages/plyr/index.html) Tools for Splitting, Applying and Combining Data
  ...
  * [polspline-1.1.22](https://cran.r-project.org/web/packages/polspline/index.html) Polynomial Spline Routines
...
Abundance and Multilocus Genetic Data
  ...
  * [processx-3.8.1](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
  * [prodlim-2023.03.31](https://cran.r-project.org/web/packages/prodlim/index.html) Product-Limit Estimation for Censored Event History Analysis
  ...
  * [profvis-0.3.8](https://cran.r-project.org/web/packages/profvis/index.html) Interactive Visualizations for Profiling R Code
  * [progress-1.2.2](https://cran.r-project.org/web/packages/progress/index.html) Terminal Progress Bars
  * [progressr-0.13.0](https://cran.r-project.org/web/packages/progressr/index.html) An Inclusive, Unifying API for Progress Updates
  * [projpred-2.5.0](https://cran.r-project.org/web/packages/projpred/index.html) Projection Predictive Feature Selection
  ...
  * [proxyC-0.3.3](https://cran.r-project.org/web/packages/proxyC/index.html) Computes Proximity in Large Sparse Matrices
  * [pryr-0.1.6](https://cran.r-project.org/web/packages/pryr/index.html) Tools for Computing on the Language
  * [ps-1.7.5](https://cran.r-project.org/web/packages/ps/index.html) List, Query, Manipulate System Processes
  * [pscl-1.5.5.1](https://cran.r-project.org/web/packages/pscl/index.html) Political Science Computational Laboratory
  * [pspline-1.0-19](https://cran.r-project.org/web/packages/pspline/index.html) Penalized Smoothing Splines
  * [psych-2.3.3](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
  * [pulsar-0.3.10](https://cran.r-project.org/web/packages/pulsar/index.html) Parallel Utilities for Lambda Selection along a Regularization
Path
  * [purrr-1.0.1](https://cran.r-project.org/web/packages/purrr/index.html) Functional Programming Tools
...
Resampling
  ...
  * [qgraph-1.9.5](https://cran.r-project.org/web/packages/qgraph/index.html) Graph Plotting Methods, Psychometric Data Visualization and
Graphical Model Estimation
  * [qqman-0.1.8](https://cran.r-project.org/web/packages/qqman/index.html) Q-Q and Manhattan Plots for GWAS Data
  * [qrnn-2.1](https://cran.r-project.org/web/packages/qrnn/index.html) Quantile Regression Neural Network
  ...
  * [quanteda-3.3.1](https://cran.r-project.org/web/packages/quanteda/index.html) Quantitative Analysis of Textual Data
  * [quantmod-0.4.22](https://cran.r-project.org/web/packages/quantmod/index.html) Quantitative Financial Modelling Framework
  ...
  * [ragg-1.2.5](https://cran.r-project.org/web/packages/ragg/index.html) Graphic Devices Based on AGG
...
Regression
  * [randomForestSRC-3.2.2](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
Classification (RF-SRC)
  * [randtoolbox-2.0.4](https://cran.r-project.org/web/packages/randtoolbox/index.html) Toolbox for Pseudo and Quasi Random Number Generation and Random
Generator Tests
...
Range Models
  * [ranger-0.15.1](https://cran.r-project.org/web/packages/ranger/index.html) A Fast Implementation of Random Forests
...
and Logs
  * [raster-3.6-20](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
  * [rasterVis-0.51.5](https://cran.r-project.org/web/packages/rasterVis/index.html) Visualization Methods for Raster Data
  ...
  * [reactR-0.4.4](https://cran.r-project.org/web/packages/reactR/index.html) React Helpers
  * [reactable-0.4.4](https://cran.r-project.org/web/packages/reactable/index.html) Interactive Data Tables for R
  * [readODS-1.8.0](https://cran.r-project.org/web/packages/readODS/index.html) Read and Write ODS Files
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [readr-2.1.4](https://cran.r-project.org/web/packages/readr/index.html) Read Rectangular Text Data
  * [readxl-1.4.2](https://cran.r-project.org/web/packages/readxl/index.html) Read Excel Files
  ...
  * [recipes-1.0.6](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing and Feature Engineering Steps for Modeling
...
'GitHub'
  ...
  * [renv-0.17.3](https://cran.r-project.org/web/packages/renv/index.html) Project Environments
  ...
  * [reticulate-1.28](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  * [rex-1.2.1](https://cran.r-project.org/web/packages/rex/index.html) Friendly Regular Expressions
  * [rgbif-3.7.7](https://cran.r-project.org/web/packages/rgbif/index.html) Interface to the Global Biodiversity Information Facility API
  * [rgdal-1.6-6](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  * [rgeos-0.6-3](https://cran.r-project.org/web/packages/rgeos/index.html) Interface to Geometry Engine - Open Source ('GEOS')
  * [rgexf-0.16.2](https://cran.r-project.org/web/packages/rgexf/index.html) Build, Import and Export GEXF Graph Files
  * [rgl-1.1.3](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [riskRegression-2023.03.22](https://cran.r-project.org/web/packages/riskRegression/index.html) Risk Regression Models and Prediction Scores for Survival
Analysis with Competing Risks
  ...
  * [rlang-1.1.1](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  * [rle-0.9.2](https://cran.r-project.org/web/packages/rle/index.html) Common Functions for Run-Length Encoded Vectors
  * [rlecuyer-0.3-7](https://cran.r-project.org/web/packages/rlecuyer/index.html) R Interface to RNG with Multiple Streams
  ...
  * [rmarkdown-2.21](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Annealing (Rgraph C Library Wrapper for R)
  * [rngWELL-0.10-9](https://cran.r-project.org/web/packages/rngWELL/index.html) Toolbox for WELL Random Number Generators
  ...
  * [robustbase-0.95-1](https://cran.r-project.org/web/packages/robustbase/index.html) Basic Robust Statistics
...
Ordinary Differential Equations
  ...
  * [roxygen2-7.2.3](https://cran.r-project.org/web/packages/roxygen2/index.html) In-Line Documentation for R
  * [rpact-3.3.4](https://cran.r-project.org/web/packages/rpact/index.html) Confirmatory Adaptive Clinical Trial Design and Analysis
  ...
  * [rrcov-1.7-3](https://cran.r-project.org/web/packages/rrcov/index.html) Scalable Robust Estimators with High Breakdown Point
  * [rredlist-0.7.1](https://cran.r-project.org/web/packages/rredlist/index.html) 'IUCN' Red List Client
  * [rsconnect-0.8.29](https://cran.r-project.org/web/packages/rsconnect/index.html) Deployment Interface for R Markdown Documents and Shiny
Applications
  * [rstan-2.21.8](https://cran.r-project.org/web/packages/rstan/index.html) R Interface to Stan
  * [rstantools-2.3.1](https://cran.r-project.org/web/packages/rstantools/index.html) Tools for Developing R Packages Interfacing with 'Stan'
  ...
  * [sass-0.4.6](https://cran.r-project.org/web/packages/sass/index.html) Syntactically Awesome Style Sheets ('Sass')
  * [scales-1.2.1](https://cran.r-project.org/web/packages/scales/index.html) Scale Functions for Visualization
  * [scam-1.2-14](https://cran.r-project.org/web/packages/scam/index.html) Shape Constrained Additive Models
  * [scatterpie-0.2.0](https://cran.r-project.org/web/packages/scatterpie/index.html) Scatter Pie Plot
  ...
  * [segmented-1.6-4](https://cran.r-project.org/web/packages/segmented/index.html) Regression Models with Break-Points / Change-Points (with
...
Aggregation and Prediction
  * [seqinr-4.2-30](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
  * [servr-0.27](https://cran.r-project.org/web/packages/servr/index.html) A Simple HTTP Server to Serve Static Files or Dynamic Documents
  ...
  * [sfheaders-0.4.2](https://cran.r-project.org/web/packages/sfheaders/index.html) Converts Between R Objects and Simple Feature Objects
  ...
  * [shiny-1.7.4](https://cran.r-project.org/web/packages/shiny/index.html) Web Application Framework for R
...
the SUN
  ...
  * [sp-1.6-1](https://cran.r-project.org/web/packages/sp/index.html) Classes and Methods for Spatial Data
  * [spData-2.2.2](https://cran.r-project.org/web/packages/spData/index.html) Datasets for Spatial Analysis
...
Use in Ecological Models
  * [spaMM-4.3.0](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, with or without Spatial Random Effects
  ...
  * [spatial-7.3-16](https://cran.r-project.org/web/packages/spatial/index.html) Functions for Kriging and Point Pattern Analysis
  * [spatstat-3.0-6](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  ...
  * [spatstat.data-3.0-1](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat' Family
  * [spatstat.explore-3.2-1](https://cran.r-project.org/web/packages/spatstat.explore/index.html) Exploratory Data Analysis for the 'spatstat' Family
  * [spatstat.geom-3.2-1](https://cran.r-project.org/web/packages/spatstat.geom/index.html) Geometrical Functionality of the 'spatstat' Family
  * [spatstat.linnet-3.1-1](https://cran.r-project.org/web/packages/spatstat.linnet/index.html) Linear Networks Functionality of the 'spatstat' Family
  * [spatstat.model-3.2-4](https://cran.r-project.org/web/packages/spatstat.model/index.html) Parametric Statistical Modelling and Inference for the
'spatstat' Family
  * [spatstat.random-3.1-5](https://cran.r-project.org/web/packages/spatstat.random/index.html) Random Generation Functionality for the 'spatstat' Family
  * [spatstat.sparse-3.0-1](https://cran.r-project.org/web/packages/spatstat.sparse/index.html) Sparse Three-Dimensional Arrays and Linear Algebra Utilities
  * [spatstat.utils-3.0-3](https://cran.r-project.org/web/packages/spatstat.utils/index.html) Utility Functions for 'spatstat'
  * splines built in 
...
Classification
  * [spocc-1.2.2](https://cran.r-project.org/web/packages/spocc/index.html) Interface to Species Occurrence Data Sources
  ...
  * [stars-0.6-1](https://cran.r-project.org/web/packages/stars/index.html) Spatiotemporal Arrays, Raster and Vector Data Cubes
...
Distance Functions
  * [stringi-1.7.12](https://cran.r-project.org/web/packages/stringi/index.html) Fast and Portable Character String Processing Facilities
  * [stringr-1.5.0](https://cran.r-project.org/web/packages/stringr/index.html) Simple, Consistent Wrappers for Common String Operations
  ...
  * [styler-1.10.0](https://cran.r-project.org/web/packages/styler/index.html) Non-Invasive Pretty Printing of R Code
  ...
  * [survival-3.5-5](https://cran.r-project.org/web/packages/survival/index.html) Survival Analysis
  ...
  * [svd-0.5.4](https://cran.r-project.org/web/packages/svd/index.html) Interfaces to Various State-of-Art SVD and Eigensolvers
  * [swagger-3.33.1](https://cran.r-project.org/web/packages/swagger/index.html) Dynamically Generates Documentation from a 'Swagger' Compliant
API
...
Normal Distribution
  * [sys-3.4.2](https://cran.r-project.org/web/packages/sys/index.html) Powerful and Reliable Tools for Running System Commands in R
...
without Propensity Score Weights
  * [tau-0.0-24](https://cran.r-project.org/web/packages/tau/index.html) Text Analysis Utilities
  ...
  * [tclust-1.5-4](https://cran.r-project.org/web/packages/tclust/index.html) Robust Trimmed Clustering
...
Exponential-Family Random Graph Models
  * [terra-1.7-29](https://cran.r-project.org/web/packages/terra/index.html) Spatial Data Analysis
  * [testit-0.13](https://cran.r-project.org/web/packages/testit/index.html) A Simple Package for Testing R Packages
  * [testthat-3.1.8](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  * [textcat-1.0-8](https://cran.r-project.org/web/packages/textcat/index.html) N-Gram Based Text Categorization
...
Shaping
  ...
  * [tictoc-1.2](https://cran.r-project.org/web/packages/tictoc/index.html) Functions for Timing R Scripts, as Well as Implementations of
"Stack" and "StackList" Structures
  * [tidygraph-1.2.3](https://cran.r-project.org/web/packages/tidygraph/index.html) A Tidy API for Graph Manipulation
  * [tidyr-1.3.0](https://cran.r-project.org/web/packages/tidyr/index.html) Tidy Messy Data
  * [tidyselect-1.2.0](https://cran.r-project.org/web/packages/tidyselect/index.html) Select from a Set of Strings
  * [tidytext-0.4.1](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
  ...
  * [timeDate-4022.108](https://cran.r-project.org/web/packages/timeDate/index.html) Rmetrics - Chronological and Calendar Objects
  * [timechange-0.2.0](https://cran.r-project.org/web/packages/timechange/index.html) Efficient Manipulation of Date-Times
  * [timereg-2.0.5](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
  * [tinytex-0.45](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain TeX Live, and Compile
LaTeX Documents
  * [tkrplot-0.0-27](https://cran.r-project.org/web/packages/tkrplot/index.html) TK Rplot
  * [tm-0.7-11](https://cran.r-project.org/web/packages/tm/index.html) Text Mining Package
  ...
  * tools built in 
  * [topicmodels-0.2-14](https://cran.r-project.org/web/packages/topicmodels/index.html) Topic Models
  ...
  * [tseries-0.10-54](https://cran.r-project.org/web/packages/tseries/index.html) Time Series Analysis and Computational Finance
  ...
  * [tuneR-1.4.4](https://cran.r-project.org/web/packages/tuneR/index.html) Analysis of Music and Speech
...
Dependency Parsing with the 'UDPipe' 'NLP' Toolkit
  ...
  * [unikn-0.8.0](https://cran.r-project.org/web/packages/unikn/index.html) Graphical Elements of the University of Konstanz's Corporate
Design
  ...
  * [utf8-1.2.3](https://cran.r-project.org/web/packages/utf8/index.html) Unicode Text Processing
  * utils built in 
  * [uuid-1.1-0](https://cran.r-project.org/web/packages/uuid/index.html) Tools for Generating and Handling of UUIDs
  * [varhandle-2.0.5](https://cran.r-project.org/web/packages/varhandle/index.html) Functions for Robust Variable Handling
  * [vcd-1.4-11](https://cran.r-project.org/web/packages/vcd/index.html) Visualizing Categorical Data
  * [vcfR-1.14.0](https://cran.r-project.org/web/packages/vcfR/index.html) Manipulate and Visualize VCF Data
  * [vctrs-0.6.2](https://cran.r-project.org/web/packages/vctrs/index.html) Vector Helpers
  * [vegan-2.6-4](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
  * [vioplot-0.4.0](https://cran.r-project.org/web/packages/vioplot/index.html) Violin Plot
...
Estimates
  ...
  * [vroom-1.6.3](https://cran.r-project.org/web/packages/vroom/index.html) Read and Write Rectangular Text Data Quickly
  * [waldo-0.5.1](https://cran.r-project.org/web/packages/waldo/index.html) Find Differences Between R Objects
...
Signal Processing
  ...
  * [webutils-1.1](https://cran.r-project.org/web/packages/webutils/index.html) Utility Functions for Developing Web Applications
  ...
  * [word2vec-0.3.4](https://cran.r-project.org/web/packages/word2vec/index.html) Distributed Representations of Words
  ...
  * [xfun-0.39](https://cran.r-project.org/web/packages/xfun/index.html) Supporting Functions for Packages Maintained by 'Yihui Xie'
  * [xgboost-1.7.5.1](https://cran.r-project.org/web/packages/xgboost/index.html) Extreme Gradient Boosting
  ...
  * [xml2-1.3.4](https://cran.r-project.org/web/packages/xml2/index.html) Parse XML
  ...
  * [yaml-2.3.7](https://cran.r-project.org/web/packages/yaml/index.html) Methods to Convert R Data to YAML and Back
  ...
  * [zip-2.3.0](https://cran.r-project.org/web/packages/zip/index.html) Cross-Platform 'zip' Compression
