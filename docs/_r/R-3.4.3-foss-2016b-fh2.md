...
### Package List
  ...
  * [BDgraph-2.45](https://cran.r-project.org/web/packages/BDgraph/index.html) Bayesian Structure Learning in Graphical Models using
Birth-Death MCMC
...
PostScript) and display (X11 and Win32) output
  ...
  * [DBI-0.8](https://cran.r-project.org/web/packages/DBI/index.html) R Database Interface
  * DEGseq 1.32.0
  * DESeq 1.30.0
  * DESeq2 1.18.1
  ...
  * [EpiModel-1.6.1](https://cran.r-project.org/web/packages/EpiModel/index.html) Mathematical Modeling of Infectious Disease Dynamics
  ...
  * [FactoMineR-1.40](https://cran.r-project.org/web/packages/FactoMineR/index.html) Multivariate Exploratory Data Analysis and Data Mining
  ...
  * [MASS-7.3-49](https://cran.r-project.org/web/packages/MASS/index.html) Support Functions and Datasets for Venables and Ripley's MASS
  ...
  * [Matrix-1.2-13](https://cran.r-project.org/web/packages/Matrix/index.html) Sparse and Dense Matrix Classes and Methods
...
Metric
  * [RBGL-1.54.0](https://cran.r-project.org/web/packages/RBGL/index.html) An interface to the BOOST graph library
...
(SNNS)
  * [RSQLite-2.1.0](https://cran.r-project.org/web/packages/RSQLite/index.html) 'SQLite' Interface for R
  ...
  * [RcppArmadillo-0.8.400.0.0](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
...
Library
  ...
  * [Rgraphviz-2.22.0](https://cran.r-project.org/web/packages/Rgraphviz/index.html) Provides plotting capabilities for R graph objects
  * Rhdf5lib 1.0.0
  ...
  * S4Vectors 0.16.0
  * [SNPRelate-1.12.2](https://cran.r-project.org/web/packages/SNPRelate/index.html) Parallel Computing Toolset for Genome-Wide Association Studies
(GWAS)
  * SPIA 2.30.0
...
Sequences
  ...
  * [XML-3.98-1.10](https://cran.r-project.org/web/packages/XML/index.html) Tools for Parsing and Generating XML Within R and S-Plus
  * XVector 0.18.0
...
Inference
  ...
  * [callr-2.0.2](https://cran.r-project.org/web/packages/callr/index.html) Call R from R
...
(CGDS)
  ...
  * [classInt-0.1-24](https://cran.r-project.org/web/packages/classInt/index.html) Choose Univariate Class Intervals
  ...
  * [clue-0.3-54](https://cran.r-project.org/web/packages/clue/index.html) Cluster Ensembles
  * [cluster-2.0.7](https://cran.r-project.org/web/packages/cluster/index.html) "Finding Groups in Data": Cluster Analysis Extended Rousseeuw et
al.
...
Plots
  ...
  * [ddalpha-1.3.1.1](https://cran.r-project.org/web/packages/ddalpha/index.html) Depth-Based Classification and Calculation of Data Depth
...
('ODE', 'DAE', 'DDE')
  ...
  * [desc-1.1.1](https://cran.r-project.org/web/packages/desc/index.html) Manipulate DESCRIPTION Files
...
'Systat', 'Weka', 'dBase', ...
  ...
  * [gamlss.dist-5.0-4](https://cran.r-project.org/web/packages/gamlss.dist/index.html) Distributions for Generalized Additive Models for Location Scale
and Shape
...
Enhancements
  ...
  * [ggrepel-0.7.0](https://cran.r-project.org/web/packages/ggrepel/index.html) Automatically Position Non-Overlapping Text Labels with
'ggplot2'
  * [ggthemes-3.4.2](https://cran.r-project.org/web/packages/ggthemes/index.html) Extra Themes, Scales and Geoms for 'ggplot2'
...
Likelihood
  ...
  * [grpreg-3.1-2](https://cran.r-project.org/web/packages/grpreg/index.html) Regularization Paths for Regression Models with Grouped
Covariates
...
when Linkage Phase is Ambiguous
  ...
  * [hopach-2.38.0](https://cran.r-project.org/web/packages/hopach/index.html) Hierarchical Ordered Partitioning and Collapsing Hybrid (HOPACH)
  ...
  * [htmlwidgets-1.0](https://cran.r-project.org/web/packages/htmlwidgets/index.html) HTML Widgets for R
  * [httpcode-0.2.0](https://cran.r-project.org/web/packages/httpcode/index.html) 'HTTP' Status Code Helper
  * [httpuv-1.3.6.2](https://cran.r-project.org/web/packages/httpuv/index.html) HTTP and WebSocket Server Library
  ...
  * illuminaio 0.20.0
  * [impute-1.52.0](https://cran.r-project.org/web/packages/impute/index.html) impute: Imputation for microarray data
...
Components Analysis for Large Dense and Sparse Matrices
  ...
  * [ks-1.11.0](https://cran.r-project.org/web/packages/ks/index.html) Kernel Smoothing
...
Monte Carlo Studies
  ...
  * [limma-3.34.9](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
...
Bandwidth
  ...
  * [lubridate-1.7.3](https://cran.r-project.org/web/packages/lubridate/index.html) Make Dealing with Dates a Little Easier
  * lumi 2.30.0
  * maSigPro 1.50.0
...
Classification, and Density Estimation
  ...
  * methods built in
  * methylumi 2.24.1
  * [mets-1.2.3](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
...
Estimation
  ...
  * [multtest-2.34.0](https://cran.r-project.org/web/packages/multtest/index.html) Resampling-based multiple hypothesis testing
...
Data and Resting State Data
  ...
  * [nlme-3.1-131.1](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
  ...
  * [np-0.60-6](https://cran.r-project.org/web/packages/np/index.html) Nonparametric Kernel Smoothing Methods for Mixed Data Types
...
OpenSSL
  ...
  * org.Hs.eg.db 3.5.0
  * [pROC-1.11.0](https://cran.r-project.org/web/packages/pROC/index.html) Display and Analyze ROC Curves
  * [packrat-0.4.9-1](https://cran.r-project.org/web/packages/packrat/index.html) A Dependency Management System for Projects and their R Package
Dependencies
  ...
  * [party-1.2-4](https://cran.r-project.org/web/packages/party/index.html) A Laboratory for Recursive Partytioning
...
in GLMs and in the Cox Model
  ...
  * [pillar-1.2.1](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
Multilocus Genetic Data
  ...
  * [psych-1.8.3.3](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
...
Resampling
  * [qgraph-1.4.4](https://cran.r-project.org/web/packages/qgraph/index.html) Graph Plotting Methods, Psychometric Data Visualization and
Graphical Model Estimation
  ...
  * [quantmod-0.4-12](https://cran.r-project.org/web/packages/quantmod/index.html) Quantitative Financial Modelling Framework
  ...
  * [qvalue-2.10.0](https://cran.r-project.org/web/packages/qvalue/index.html) Q-value estimation for false discovery rate control
...
Applications
  ...
  * [selectr-0.4-0](https://cran.r-project.org/web/packages/selectr/index.html) Translate CSS Selectors to XPath Expressions
  ...
  * sigaR 1.26.0
  * siggenes 1.52.0
  * [slam-0.1-42](https://cran.r-project.org/web/packages/slam/index.html) Sparse Lightweight Arrays and Matrices
...
Estimation
  ...
  * [spam-2.1-3](https://cran.r-project.org/web/packages/spam/index.html) SPArse Matrix
  * [sparklyr-0.7.0](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
...
Software
  ...
  * [stringi-1.1.7](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
...
Exponential-Family Random Graph Models
  ...
  * [tseries-0.10-43](https://cran.r-project.org/web/packages/tseries/index.html) Time Series Analysis and Computational Finance
  ...
  * [vegan-2.4-6](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
  * [venn-1.5](https://cran.r-project.org/web/packages/venn/index.html) Draw Venn Diagrams
  ...
  * [yaml-2.1.18](https://cran.r-project.org/web/packages/yaml/index.html) Methods to Convert R Data to YAML and Back
  * zlibbioc 1.24.0
