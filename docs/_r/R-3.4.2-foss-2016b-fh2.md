...
### Package List
  ...
  * [BDgraph-2.42](https://cran.r-project.org/web/packages/BDgraph/index.html) Bayesian Structure Learning in Graphical Models using
Birth-Death MCMC
...
PostScript) and display (X11 and Win32) output
  ...
  * DelayedArray 0.4.1
  * [Deriv-3.8.2](https://cran.r-project.org/web/packages/Deriv/index.html) Symbolic Differentiation
  ...
  * [FactoMineR-1.38](https://cran.r-project.org/web/packages/FactoMineR/index.html) Multivariate Exploratory Data Analysis and Data Mining
  ...
  * [Matrix-1.2-11](https://cran.r-project.org/web/packages/Matrix/index.html) Sparse and Dense Matrix Classes and Methods
...
(SNNS)
  ...
  * [RWeka-0.4-35](https://cran.r-project.org/web/packages/RWeka/index.html) R/Weka Interface
  * [RWekajars-3.9.1-4](https://cran.r-project.org/web/packages/RWekajars/index.html) R/Weka Interface Jars
  * [Rcpp-0.12.13](https://cran.r-project.org/web/packages/Rcpp/index.html) Seamless R and C++ Integration
  * [RcppArmadillo-0.8.100.1.0](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
...
Library
  ...
  * S4Vectors 0.16.0
  * [SNPRelate-1.12.0](https://cran.r-project.org/web/packages/SNPRelate/index.html) Parallel Computing Toolset for Genome-Wide Association Studies
(GWAS)
  * SPIA 2.30.0
  * SeqArray 1.18.1
  * SeqVarTools 1.16.0
...
(CGDS)
  ...
  * chipseq 1.28.0
  * [chron-2.3-51](https://cran.r-project.org/web/packages/chron/index.html) Chronological Objects which can Handle Dates and Times
...
and Shape
  ...
  * [gdsfmt-1.14.0](https://cran.r-project.org/web/packages/gdsfmt/index.html) R Interface to CoreArray Genomic Data Structure (GDS) files
...
when Linkage Phase is Ambiguous
  ...
  * [inferference-0.5.4](https://cran.r-project.org/web/packages/inferference/index.html) Methods for Causal Inference with Interference
...
Components Analysis for Large Dense and Sparse Matrices
  ...
  * [knitr-1.17](https://cran.r-project.org/web/packages/knitr/index.html) A General-Purpose Package for Dynamic Report Generation in R
...
Monte Carlo Studies
  ...
  * [limma-3.34.0](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
  * [lintr-1.0.1](https://cran.r-project.org/web/packages/lintr/index.html) A 'Linter' for R Code
...
Estimation
  ...
  * [mixOmics-6.3.0](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
  ...
  * [multcomp-1.4-7](https://cran.r-project.org/web/packages/multcomp/index.html) Simultaneous Inference in General Parametric Models
...
Data and Resting State Data
  ...
  * oligoClasses 1.40.0
  * [openssl-0.9.8](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
...
and Logs
  ...
  * [recipes-0.1.0](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing Tools to Create Design Matrices
...
Ordinary Differential Equations
  ...
  * [segmented-0.5-2.2](https://cran.r-project.org/web/packages/segmented/index.html) Regression Models with Break-Points / Change-Points Estimation
...
Estimation
  ...
  * [spatstat-1.53-2](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  * [spatstat.data-1.1-1](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat'
  * [spatstat.utils-1.7-1](https://cran.r-project.org/web/packages/spatstat.utils/index.html) Utility Functions for 'spatstat'
  * [spdep-0.6-15](https://cran.r-project.org/web/packages/spdep/index.html) Spatial Dependence: Weighting Schemes, Statistics and Models
  * splines built in
...
Software
  ...
  * [taxize-0.9.0](https://cran.r-project.org/web/packages/taxize/index.html) Taxonomic Information from Around the Web
...
Exponential-Family Random Graph Models
  ...
  * [vegan-2.4-4](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
  * [venn-1.2](https://cran.r-project.org/web/packages/venn/index.html) Draw Venn Diagrams
