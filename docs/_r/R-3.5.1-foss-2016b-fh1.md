...
Enhancements
  * [ggbio-1.28.4](https://www.bioconductor.org/packages/release/bioc/html/ggbio.html) Visualization tools for genomic data
...
Model Comparison
  ...
  * [pdftools-1.8](https://cran.r-project.org/web/packages/pdftools/index.html) Text Extraction, Rendering and Converting of PDF Documents
...
and Logs
  ...
  * [rgdal-1.2-16](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  ...
  * [rlang-0.2.1](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  ...
  * [rmatio-0.12.0](https://cran.r-project.org/web/packages/rmatio/index.html) Read and Write 'Matlab' Files
...
Applications
  ...
  * [rtracklayer-1.40.3](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  * [rvcheck-0.1.0](https://cran.r-project.org/web/packages/rvcheck/index.html) R/Package Version Check
...
Estimation
  ...
  * [sparklyr-0.8.4](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
...
'LaTeX' Documents
  ...
  * [treeio-1.4.2](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
