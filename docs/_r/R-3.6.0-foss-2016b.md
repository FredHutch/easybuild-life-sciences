...
Data and Resting State Data
  ...
  * [nlme-3.1-139](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
  ...
  * [openssl-1.3](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  ...
  * [pROC-1.14.0](https://cran.r-project.org/web/packages/pROC/index.html) Display and Analyze ROC Curves
...
in GLMs and in the Cox Model
  ...
  * [phangorn-2.5.3](https://cran.r-project.org/web/packages/phangorn/index.html) Phylogenetic Reconstruction and Analysis
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [plotrix-3.7-5](https://cran.r-project.org/web/packages/plotrix/index.html) Various Plotting Functions
...
Graphical Model Estimation
  ...
  * [quadprog-1.5-6](https://cran.r-project.org/web/packages/quadprog/index.html) Functions to Solve Quadratic Programming Problems
  * [quantmod-0.4-14](https://cran.r-project.org/web/packages/quantmod/index.html) Quantitative Financial Modelling Framework
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [recipes-0.1.5](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing Tools to Create Design Matrices
  ...
  * [remotes-2.0.4](https://cran.r-project.org/web/packages/remotes/index.html) R Package Installation from Remote Repositories, Including
'GitHub'
  ...
  * [rgdal-1.4-3](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  * [rgexf-0.15.3](https://cran.r-project.org/web/packages/rgexf/index.html) Build, Import and Export GEXF Graph Files
  * [rgl-0.100.19](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [rlang-0.3.4](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  * [rlecuyer-0.3-4](https://cran.r-project.org/web/packages/rlecuyer/index.html) R Interface to RNG with Multiple Streams
  * [rmarkdown-1.12](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
  ...
  * [rngtools-1.3.1.1](https://cran.r-project.org/web/packages/rngtools/index.html) Utility Functions for Working with Random Number Generators
  * [robustbase-0.93-4](https://cran.r-project.org/web/packages/robustbase/index.html) Basic Robust Statistics
...
Ordinary Differential Equations
  ...
  * [rversions-1.1.0](https://cran.r-project.org/web/packages/rversions/index.html) Query 'R' Versions, Including 'r-release' and 'r-oldrel'
  * [rvest-0.3.3](https://cran.r-project.org/web/packages/rvest/index.html) Easily Harvest (Scrape) Web Pages
  ...
  * [sf-0.7-4](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
...
Estimation
  ...
  * [spaMM-2.7.1](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, Particularly Spatial Models
  ...
  * [spatstat-1.59-0](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
...
Exponential-Family Random Graph Models
  ...
  * [tibble-2.1.1](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
  ...
  * [tinytex-0.12](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain 'TeX Live', and Compile
'LaTeX' Documents
...
Signal Processing
  ...
  * [xfun-0.6](https://cran.r-project.org/web/packages/xfun/index.html) Miscellaneous Functions by 'Yihui Xie'
  ...
  * [zip-2.0.1](https://cran.r-project.org/web/packages/zip/index.html) Cross-Platform 'zip' Compression
