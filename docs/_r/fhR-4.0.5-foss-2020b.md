...
PostScript) and Display (X11 and Win32) Output
  ...
  * [CytoML-2.2.2](https://www.bioconductor.org/packages/release/bioc/html/CytoML.html) A GatingML Interface for Cross Platform Cytometry Data Sharing
...
Packages
  ...
  * [Rhdf5lib-1.12.1](https://www.bioconductor.org/packages/release/bioc/html/Rhdf5lib.html) hdf5 library as an R package
...
Hazards Model
  ...
  * [cpp11-0.2.7](https://cran.r-project.org/web/packages/cpp11/index.html) A C++11 Interface for R's C Interface
...
Distribution
  ...
  * [glmnet-4.1-1](https://cran.r-project.org/web/packages/glmnet/index.html) Lasso and Elastic-Net Regularized Generalized Linear Models
...
Likelihood
  ...
  * [grpreg-3.3.1](https://cran.r-project.org/web/packages/grpreg/index.html) Regularization Paths for Regression Models with Grouped
Covariates
...
when Linkage Phase is Ambiguous
  ...
  * [hms-1.0.0](https://cran.r-project.org/web/packages/hms/index.html) Pretty Time of Day
  * [hopach-2.50.0](https://cran.r-project.org/web/packages/hopach/index.html) Hierarchical Ordered Partitioning and Collapsing Hybrid (HOPACH)
  * [htmlTable-2.1.0](https://cran.r-project.org/web/packages/htmlTable/index.html) Advanced Tables for Markdown/HTML
  * [htmltools-0.5.1.1](https://cran.r-project.org/web/packages/htmltools/index.html) Tools for HTML
  ...
  * [httpuv-1.5.5](https://cran.r-project.org/web/packages/httpuv/index.html) HTTP and WebSocket Server Library
...
High-Dimensional Cytometry
  ...
  * [illuminaio-0.32.0](https://www.bioconductor.org/packages/release/bioc/html/illuminaio.html) Parsing Illumina Microarray Output Files
  * [imager-0.42.8](https://cran.r-project.org/web/packages/imager/index.html) Image Processing Library Based on 'CImg'
  ...
  * [impute-1.64.0](https://cran.r-project.org/web/packages/impute/index.html) impute: Imputation for microarray data
  * [ineq-0.2-13](https://cran.r-project.org/web/packages/ineq/index.html) Measuring Inequality, Concentration, and Poverty
  * [infer-0.5.4](https://cran.r-project.org/web/packages/infer/index.html) Tidy Statistical Inference
...
Network
  ...
  * [inline-0.3.17](https://cran.r-project.org/web/packages/inline/index.html) Functions to Inline C, C++, Fortran Function Calls from R
  * [interactiveDisplayBase-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/interactiveDisplayBase.html) Base package for enabling powerful shiny web displays of Bioconductor objects
  ...
  * [inum-1.0-3](https://cran.r-project.org/web/packages/inum/index.html) Interval and Enum-Type Representation of Vectors
  * [invgamma-1.1](https://cran.r-project.org/web/packages/invgamma/index.html) The Inverse Gamma Distribution
  * [iotools-0.3-1](https://cran.r-project.org/web/packages/iotools/index.html) I/O Tools for Streaming
...
Components Analysis for Large Dense and Sparse Matrices
  * [isoband-0.2.4](https://cran.r-project.org/web/packages/isoband/index.html) Generate Isolines and Isobands from Regularly Spaced Elevation
Grids
  ...
  * [jquerylib-0.1.3](https://cran.r-project.org/web/packages/jquerylib/index.html) Obtain 'jQuery' as an HTML Dependency Object
  ...
  * [jstable-1.0.2](https://cran.r-project.org/web/packages/jstable/index.html) Create Tables from Different Types of Regression
  * [karyoploteR-1.16.0](https://www.bioconductor.org/packages/release/bioc/html/karyoploteR.html) Plot customizable linear genomes displaying arbitrary data
...
Derivatives
  ...
  * [knitr-1.31](https://cran.r-project.org/web/packages/knitr/index.html) A General-Purpose Package for Dynamic Report Generation in R
  ...
  * [ks-1.12.0](https://cran.r-project.org/web/packages/ks/index.html) Kernel Smoothing
  * [kyotil-2020.10-12](https://cran.r-project.org/web/packages/kyotil/index.html) Utility Functions for Statistical Analysis Report Generation and
Monte Carlo Studies
...
Loops
  ...
  * [lava-1.6.9](https://cran.r-project.org/web/packages/lava/index.html) Latent Variable Models
  * [lavaan-0.6-8](https://cran.r-project.org/web/packages/lavaan/index.html) Latent Variable Analysis
  ...
  * [leiden-0.3.7](https://cran.r-project.org/web/packages/leiden/index.html) R Implementation of Leiden Clustering Algorithm
  * [lhs-1.1.1](https://cran.r-project.org/web/packages/lhs/index.html) Latin Hypercube Samples
  ...
  * [limma-3.46.0](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
  ...
  * [lme4-1.1-26](https://cran.r-project.org/web/packages/lme4/index.html) Linear Mixed-Effects Models using 'Eigen' and S4
  ...
  * [lokern-1.1-8.1](https://cran.r-project.org/web/packages/lokern/index.html) Kernel Regression Smoothing with Local or Global Plug-in
Bandwidth
...
Models
  ...
  * [lpsymphony-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/lpsymphony.html) Symphony integer linear programming solver in R
...
Ensemble Feature Selection"
  ...
  * [maptools-1.1-1](https://cran.r-project.org/web/packages/maptools/index.html) Tools for Handling Spatial Objects
...
Occurrence Using Presence-Only Data
  * [maxnet-0.1.2](https://cran.r-project.org/web/packages/maxnet/index.html) Fitting 'Maxent' Species Distribution Models with 'glmnet'
  * [mboost-2.9-4](https://cran.r-project.org/web/packages/mboost/index.html) Model-Based Boosting
...
Classification, and Density Estimation
  ...
  * [metafor-2.4-0](https://cran.r-project.org/web/packages/metafor/index.html) Meta-Analysis Package for R
  * [metagenomeSeq-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/metagenomeSeq.html) Statistical analysis for sparse high-throughput sequencing
  * methods built in
  * [methylKit-1.16.1](https://www.bioconductor.org/packages/release/bioc/html/methylKit.html) DNA methylation analysis from high-throughput bisulfite sequencing results
  * [methylumi-2.36.0](https://www.bioconductor.org/packages/release/bioc/html/methylumi.html) Handle Illumina methylation data
  * [mets-1.2.8.1](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
  * [mgcv-1.8-34](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
  * [mgsub-1.7.2](https://cran.r-project.org/web/packages/mgsub/index.html) Safe, Multiple, Simultaneous String Substitution
  ...
  * [mime-0.10](https://cran.r-project.org/web/packages/mime/index.html) Map Filenames to MIME Types
  * [minfi-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/minfi.html) Analyze Illumina Infinium DNA methylation arrays
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [mixOmics-6.14.0](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
...
Versions
  * [modeldata-0.1.0](https://cran.r-project.org/web/packages/modeldata/index.html) Data Sets Used Useful for Modeling Packages
  ...
  * [motifmatchr-1.12.0](https://www.bioconductor.org/packages/release/bioc/html/motifmatchr.html) Fast Motif Matching in R
  * [mpath-0.4-2.18](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
  * [msa-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/msa.html) Multiple Sequence Alignment
  * [msigdbr-7.2.1](https://cran.r-project.org/web/packages/msigdbr/index.html) MSigDB Gene Sets for Multiple Organisms in a Tidy Data Format
  ...
  * [multcomp-1.4-16](https://cran.r-project.org/web/packages/multcomp/index.html) Simultaneous Inference in General Parametric Models
  * [multicool-0.1-11](https://cran.r-project.org/web/packages/multicool/index.html) Permutations of Multisets in Cool-Lex Order
  * [multtest-2.46.0](https://cran.r-project.org/web/packages/multtest/index.html) Resampling-based multiple hypothesis testing
  * [munsell-0.5.0](https://cran.r-project.org/web/packages/munsell/index.html) Utilities for Using Munsell Colours
  * [mvabund-4.1.9](https://cran.r-project.org/web/packages/mvabund/index.html) Statistical Methods for Analysing Multivariate Abundance Data
  * [mvnfast-0.2.5.1](https://cran.r-project.org/web/packages/mvnfast/index.html) Fast Multivariate Normal and Student's t Methods
...
Dimensions
  * [nanotime-0.3.2](https://cran.r-project.org/web/packages/nanotime/index.html) Nanosecond-Resolution Time Support for R
...
Files
  * [ncdfFlow-2.36.0](https://www.bioconductor.org/packages/release/bioc/html/ncdfFlow.html) ncdfFlow: A package that provides HDF5 based storage for flow cytometry data.
  * [ndtv-0.13.0](https://cran.r-project.org/web/packages/ndtv/index.html) Network Dynamic Temporal Visualizations
  * [network-1.16.1](https://cran.r-project.org/web/packages/network/index.html) Classes for Relational Data
...
Linear Mixed Models for Areal Data
  ...
  * [nlme-3.1-152](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
  ...
  * [nnet-7.3-15](https://cran.r-project.org/web/packages/nnet/index.html) Feed-Forward Neural Networks and Multinomial Log-Linear Models
...
Methods)
  ...
  * [openssl-1.4.3](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  * [openxlsx-4.2.3](https://cran.r-project.org/web/packages/openxlsx/index.html) Read, Write and Edit xlsx Files
  ...
  * [optimx-2020-4.2](https://cran.r-project.org/web/packages/optimx/index.html) Expanded Replacement and Extension of the 'optim' Function
  ...
  * [org.Hs.eg.db-3.12.0](https://www.bioconductor.org/packages/release/bioc/html/org.Hs.eg.db.html) Genome wide annotation for Human
  * [org.Mm.eg.db-3.12.0](https://www.bioconductor.org/packages/release/bioc/html/org.Mm.eg.db.html) Genome wide annotation for Mouse
  ...
  * [pROC-1.17.0.1](https://cran.r-project.org/web/packages/pROC/index.html) Display and Analyze ROC Curves
  * [pack-0.1-1](https://cran.r-project.org/web/packages/pack/index.html) Convert values to/from raw vectors
  * [packrat-0.6.0](https://cran.r-project.org/web/packages/packrat/index.html) A Dependency Management System for Projects and their R Package
Dependencies
  ...
  * [parallelly-1.24.0](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
...
8601 Formats
  * [parsnip-0.1.5](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
  * [partools-1.1.6](https://cran.r-project.org/web/packages/partools/index.html) Tools for the 'Parallel' Package
  * [party-1.3-7](https://cran.r-project.org/web/packages/party/index.html) A Laboratory for Recursive Partytioning
  * [partykit-1.2-13](https://cran.r-project.org/web/packages/partykit/index.html) A Toolkit for Recursive Partytioning
  ...
  * [pathview-1.30.1](https://www.bioconductor.org/packages/release/bioc/html/pathview.html) a tool set for pathway based data integration and visualization
...
Methods for Test in Mixed Models
  ...
  * [pcaMethods-1.82.0](https://www.bioconductor.org/packages/release/bioc/html/pcaMethods.html) A collection of PCA methods
...
in GLMs and in the Cox Model
  ...
  * [phangorn-2.6.2](https://cran.r-project.org/web/packages/phangorn/index.html) Phylogenetic Reconstruction and Analysis
  ...
  * [phyloseq-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/phyloseq.html) Handling and analysis of high-throughput microbiome census data
  * [phytools-0.7-70](https://cran.r-project.org/web/packages/phytools/index.html) Phylogenetic Tools for Comparative Biology (and Other Things)
  * [pillar-1.5.1](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [pkgload-1.2.0](https://cran.r-project.org/web/packages/pkgload/index.html) Simulate Package Installation and Attach
  ...
  * [plotly-4.9.3](https://cran.r-project.org/web/packages/plotly/index.html) Create Interactive Web Graphics via 'plotly.js'
  * [plotmo-3.6.0](https://cran.r-project.org/web/packages/plotmo/index.html) Plot a Model's Residuals, Response, and Partial Dependence Plots
  * [plotrix-3.8-1](https://cran.r-project.org/web/packages/plotrix/index.html) Various Plotting Functions
  * [pls-2.7-3](https://cran.r-project.org/web/packages/pls/index.html) Partial Least Squares and Principal Component Regression
  ...
  * [polyester-1.26.0](https://www.bioconductor.org/packages/release/bioc/html/polyester.html) Simulate RNA-seq reads
...
Abundance and Multilocus Genetic Data
  ...
  * [preprocessCore-1.52.1](https://www.bioconductor.org/packages/release/bioc/html/preprocessCore.html) A collection of pre-processing functions
  ...
  * [processx-3.5.0](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
  ...
  * [proxy-0.4-25](https://cran.r-project.org/web/packages/proxy/index.html) Distance and Similarity Measures
  ...
  * [psych-2.1.3](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
  * [psychotools-0.6-0](https://cran.r-project.org/web/packages/psychotools/index.html) Psychometric Modeling Infrastructure
...
Graphical Model Estimation
  ...
  * [qqman-0.1.4](https://cran.r-project.org/web/packages/qqman/index.html) Q-Q and Manhattan Plots for GWAS Data
  ...
  * [qvalue-2.22.0](https://cran.r-project.org/web/packages/qvalue/index.html) Q-value estimation for false discovery rate control
  ...
  * [rGADEM-2.38.0](https://www.bioconductor.org/packages/release/bioc/html/rGADEM.html) de novo motif discovery
...
Regression
  * [randomForestSRC-2.11.0](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [readr-1.4.0](https://cran.r-project.org/web/packages/readr/index.html) Read Rectangular Text Data
  * [readxl-1.3.1](https://cran.r-project.org/web/packages/readxl/index.html) Read Excel Files
  * [recipes-0.1.15](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing Tools to Create Design Matrices
...
'Ensembl' and 'UCSC' Genome Browsers
  * [refund-0.1-23](https://cran.r-project.org/web/packages/refund/index.html) Regression with Functional Data
  * [regioneR-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/regioneR.html) Association analysis of genomic regions based on permutation tests
  ...
  * [remotes-2.2.0](https://cran.r-project.org/web/packages/remotes/index.html) R Package Installation from Remote Repositories, Including
'GitHub'
  ...
  * [reprex-1.0.0](https://cran.r-project.org/web/packages/reprex/index.html) Prepare Reproducible Example Code via the Clipboard
  ...
  * [rgl-0.105.22](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  * [rhdf5-2.34.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5.html) R Interface to HDF5
  * [rhdf5filters-1.2.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5filters.html) HDF5 Compression Filters
  * [rio-0.5.26](https://cran.r-project.org/web/packages/rio/index.html) A Swiss-Army Knife for Data I/O
  ...
  * [robustbase-0.93-7](https://cran.r-project.org/web/packages/robustbase/index.html) Basic Robust Statistics
...
Ordinary Differential Equations
  ...
  * [rsample-0.0.9](https://cran.r-project.org/web/packages/rsample/index.html) General Resampling Infrastructure
...
Applications
  ...
  * [rtracklayer-1.50.0](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  ...
  * [rvest-1.0.0](https://cran.r-project.org/web/packages/rvest/index.html) Easily Harvest (Scrape) Web Pages
  ...
  * [segmented-1.3-3](https://cran.r-project.org/web/packages/segmented/index.html) Regression Models with Break-Points / Change-Points Estimation
  ...
  * [seqLogo-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/seqLogo.html) Sequence logos for DNA sequence alignments
  * [seqinr-4.2-5](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
...
Format and BGEN Format) into R
  ...
  * [servr-0.21](https://cran.r-project.org/web/packages/servr/index.html) A Simple HTTP Server to Serve Static Files or Dynamic Documents
  ...
  * [sfsmisc-1.1-10](https://cran.r-project.org/web/packages/sfsmisc/index.html) Utilities from 'Seminar fuer Statistik' ETH Zurich
  * [shadowtext-0.0.7](https://cran.r-project.org/web/packages/shadowtext/index.html) Shadow Text Grob and Layer
  * [shape-1.4.5](https://cran.r-project.org/web/packages/shape/index.html) Functions for Plotting Graphical Shapes, Colors
...
Analysis for Bayesian Models
  ...
  * [siggenes-1.64.0](https://www.bioconductor.org/packages/release/bioc/html/siggenes.html) Multiple Testing using SAM and Efron's Empirical Bayes Approaches
...
Files
  ...
  * [slider-0.2.1](https://cran.r-project.org/web/packages/slider/index.html) Sliding Window Functions
...
Estimation
  * [smfishHmrf-0.1](https://cran.r-project.org/web/packages/smfishHmrf/index.html) Hidden Markov Random Field for Spatial Transcriptomic Data
...
the SUN
  ...
  * [snpStats-1.40.0](https://www.bioconductor.org/packages/release/bioc/html/snpStats.html) SnpMatrix and XSnpMatrix classes and methods
  ...
  * [spData-0.3.8](https://cran.r-project.org/web/packages/spData/index.html) Datasets for Spatial Analysis
  * [spaMM-3.7.2](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, Particularly Spatial Models
  * [spaa-0.2.2](https://cran.r-project.org/web/packages/spaa/index.html) SPecies Association Analysis
  * [spam-2.6-0](https://cran.r-project.org/web/packages/spam/index.html) SPArse Matrix
  * [sparklyr-1.6.2](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [sparseMatrixStats-1.2.1](https://www.bioconductor.org/packages/release/bioc/html/sparseMatrixStats.html) Summary Statistics for Rows and Columns of Sparse Matrices
  * [spatial-7.3-13](https://cran.r-project.org/web/packages/spatial/index.html) Functions for Kriging and Point Pattern Analysis
  * [spatstat-2.0-1](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  * [spatstat.core-2.0-0](https://cran.r-project.org/web/packages/spatstat.core/index.html) Core Functionality of the 'spatstat' Family
  * [spatstat.data-2.1-0](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat' Family
  * [spatstat.geom-2.0-1](https://cran.r-project.org/web/packages/spatstat.geom/index.html) Geometrical Functionality of the 'spatstat' Family
  * [spatstat.linnet-2.1-1](https://cran.r-project.org/web/packages/spatstat.linnet/index.html) Linear Networks Functionality of the 'spatstat' Family
  ...
  * [spatstat.utils-2.1-0](https://cran.r-project.org/web/packages/spatstat.utils/index.html) Utility Functions for 'spatstat'
  * splines built in
...
Classification
  ...
  * [statmod-1.4.35](https://cran.r-project.org/web/packages/statmod/index.html) Statistical Modeling
  ...
  * [statnet.common-4.4.1](https://cran.r-project.org/web/packages/statnet.common/index.html) Common R Scripts and Utilities Used by the Statnet Project
Software
  * stats built in
  * stats4 built in
  * [stdReg-3.4.0](https://cran.r-project.org/web/packages/stdReg/index.html) Regression Standardization
  * [stopwords-2.2](https://cran.r-project.org/web/packages/stopwords/index.html) Multilingual Stopword Lists
  * [stringdist-0.9.6.3](https://cran.r-project.org/web/packages/stringdist/index.html) Approximate String Matching, Fuzzy Text Search, and String
Distance Functions
  * [stringi-1.5.3](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
  ...
  * [styler-1.4.1](https://cran.r-project.org/web/packages/styler/index.html) Non-Invasive Pretty Printing of R Code
  ...
  * [survival-3.2-10](https://cran.r-project.org/web/packages/survival/index.html) Survival Analysis
  ...
  * [sva-3.38.0](https://www.bioconductor.org/packages/release/bioc/html/sva.html) Surrogate Variable Analysis
  ...
  * [systemPipeR-1.24.3](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
  * [systemfonts-1.0.1](https://cran.r-project.org/web/packages/systemfonts/index.html) System Native Font Finding
  * [tableone-0.12.0](https://cran.r-project.org/web/packages/tableone/index.html) Create 'Table 1' to Describe Baseline Characteristics with or
without Propensity Score Weights
  ...
  * [tergm-3.7.0](https://cran.r-project.org/web/packages/tergm/index.html) Fit, Simulate and Diagnose Models for Network Evolution Based on
Exponential-Family Random Graph Models
  * [tergmLite-2.2.1](https://cran.r-project.org/web/packages/tergmLite/index.html) Fast Simulation of Simple Temporal Exponential Random Graph
Models
  * [testit-0.12](https://cran.r-project.org/web/packages/testit/index.html) A Simple Package for Testing R Packages
  * [testthat-3.0.2](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  * [threejs-0.3.3](https://cran.r-project.org/web/packages/threejs/index.html) Interactive 3D Scatter Plots, Networks and Globes
  * [tibble-3.1.0](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
...
Stack and List Structures
  ...
  * [tidymodels-0.1.2](https://cran.r-project.org/web/packages/tidymodels/index.html) Easily Install and Load the 'Tidymodels' Packages
  ...
  * [tidytext-0.3.0](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
  ...
  * [tilingArray-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/tilingArray.html) Transcript mapping with high-density oligonucleotide tiling arrays
  ...
  * [timereg-1.9.8](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
  * [tinytex-0.31](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain TeX Live, and Compile
LaTeX Documents
  * [tkWidgets-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/tkWidgets.html) R based tk widgets
  ...
  * [treeio-1.14.3](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [tune-0.1.3](https://cran.r-project.org/web/packages/tune/index.html) Tidy Tuning Tools
  ...
  * [units-0.7-1](https://cran.r-project.org/web/packages/units/index.html) Measurement Units for R Vectors
  * [unmarked-1.0.1](https://cran.r-project.org/web/packages/unmarked/index.html) Models for Data from Unmarked Animals
  ...
  * [utf8-1.2.1](https://cran.r-project.org/web/packages/utf8/index.html) Unicode Text Processing
  * utils built in
...
for Dimensionality Reduction
  ...
  * [vctrs-0.3.7](https://cran.r-project.org/web/packages/vctrs/index.html) Vector Helpers
  ...
  * [vimp-2.1.9](https://cran.r-project.org/web/packages/vimp/index.html) Perform Inference on Algorithm-Agnostic Variable Importance
...
Estimates
  ...
  * [waldo-0.2.5](https://cran.r-project.org/web/packages/waldo/index.html) Find Differences Between R Objects
...
Signal Processing
  ...
  * [widgetTools-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/widgetTools.html) Creates an interactive tcltk widget
  * [wikitaxa-0.4.0](https://cran.r-project.org/web/packages/wikitaxa/index.html) Taxonomic Information from 'Wikipedia'
  * [withr-2.4.1](https://cran.r-project.org/web/packages/withr/index.html) Run Code 'With' Temporarily Modified Global State
  * [wordcloud-2.6](https://cran.r-project.org/web/packages/wordcloud/index.html) Word Clouds
  * [workflows-0.2.2](https://cran.r-project.org/web/packages/workflows/index.html) Modeling Workflows
...
Compositional Data Sets
  ...
  * [zip-2.1.1](https://cran.r-project.org/web/packages/zip/index.html) Cross-Platform 'zip' Compression
  * [zlibbioc-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/zlibbioc.html) An R packaged zlib-1.2.5
