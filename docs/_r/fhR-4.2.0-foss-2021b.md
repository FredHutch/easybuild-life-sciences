...
### Package List
  ...
  * [ALDEx2-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/ALDEx2.html) Analysis Of Differential Abundance Taking Sample Variation Into Account
  * [ALL-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/ALL.html) A data package
  * ASCAT 2.5.2
...
Classifiers
  * [AgiMicroRna-2.46.0](https://www.bioconductor.org/packages/release/bioc/html/AgiMicroRna.html) Processing and Differential Expression Analysis of Agilent microRNA chips
...
NIFTI Format
  * [AnnotationDbi-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/AnnotationDbi.html) Manipulation of SQLite-based annotations in Bioconductor
  * [AnnotationFilter-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/AnnotationFilter.html) Facilities for Filtering Bioconductor Annotation Resources
  * [AnnotationForge-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/AnnotationForge.html) Tools for building SQLite-based annotation data packages
  * [AnnotationHub-3.4.0](https://www.bioconductor.org/packages/release/bioc/html/AnnotationHub.html) Client to access AnnotationHub resources
  * ArchR 1.0.1
  * [BB-2019.10-1](https://cran.r-project.org/web/packages/BB/index.html) Solving and Optimizing Large-Scale Nonlinear Systems
  * [BBmisc-1.12](https://cran.r-project.org/web/packages/BBmisc/index.html) Miscellaneous Helper Functions for B. Bischl
  * [BCEE-1.3.0](https://cran.r-project.org/web/packages/BCEE/index.html) The Bayesian Causal Effect Estimation Algorithm
  * [BDgraph-2.66](https://cran.r-project.org/web/packages/BDgraph/index.html) Bayesian Structure Learning in Graphical Models using
Birth-Death MCMC
  ...
  * [BSgenome-1.64.0](https://www.bioconductor.org/packages/release/bioc/html/BSgenome.html) Software infrastructure for efficient representation of full genomes and their SNPs
...
Statistics
  ...
  * [BiocFileCache-2.4.0](https://www.bioconductor.org/packages/release/bioc/html/BiocFileCache.html) Manage Files Across Sessions
  ...
  * [BiocIO-1.6.0](https://www.bioconductor.org/packages/release/bioc/html/BiocIO.html) Standard Input and Output for Bioconductor Packages
  * [BiocManager-1.30.17](https://cran.r-project.org/web/packages/BiocManager/index.html) Access the Bioconductor Project Package Repository
  ...
  * [BiocParallel-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/BiocParallel.html) Bioconductor facilities for parallel evaluation
  ...
  * [BiocStyle-2.24.0](https://www.bioconductor.org/packages/release/bioc/html/BiocStyle.html) Standard styles for vignettes and other Bioconductor documents
  * [BiocVersion-3.15.2](https://www.bioconductor.org/packages/release/bioc/html/BiocVersion.html) Set the appropriate version of Bioconductor packages
  ...
  * [Brobdingnag-1.2-7](https://cran.r-project.org/web/packages/Brobdingnag/index.html) Very Large Numbers in R
  * [CATALYST-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/CATALYST.html) Cytometry dATa anALYSis Tools
  * [CBPS-0.23](https://cran.r-project.org/web/packages/CBPS/index.html) Covariate Balancing Propensity Score
  * [CGHbase-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/CGHbase.html) CGHbase: Base functions and classes for arrayCGH data analysis.
  * [CLONETv2-2.2.1](https://cran.r-project.org/web/packages/CLONETv2/index.html) Clonality Estimates in Tumor
  * [CMA-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/CMA.html) Synthesis of microarray-based classification
  * [CNEr-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/CNEr.html) CNE Detection and Visualization
  * [COMPASS-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/COMPASS.html) Combinatorial Polyfunctionality Analysis of Single Cells
  * [CVST-0.2-3](https://cran.r-project.org/web/packages/CVST/index.html) Fast Cross-Validation via Sequential Testing
  * [CVXR-1.0-10](https://cran.r-project.org/web/packages/CVXR/index.html) Disciplined Convex Optimization
  * [Cairo-1.5-15](https://cran.r-project.org/web/packages/Cairo/index.html) R Graphics Device using Cairo Graphics Library for Creating
High-Quality Bitmap (PNG, JPEG, TIFF), Vector (PDF, SVG,
PostScript) and Display (X11 and Win32) Output
  * [Category-2.62.0](https://www.bioconductor.org/packages/release/bioc/html/Category.html) Category Analysis
  * [ChIPpeakAnno-3.30.0](https://www.bioconductor.org/packages/release/bioc/html/ChIPpeakAnno.html) Batch annotation of the peaks identified from either ChIP-seq, ChIP-chip experiments or any experiments resulted in large number of chromosome ranges
  * [ChIPseeker-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/ChIPseeker.html) ChIPseeker for ChIP peak Annotation, Comparison, and Visualization
  ...
  * [ComplexHeatmap-2.12.0](https://www.bioconductor.org/packages/release/bioc/html/ComplexHeatmap.html) Make Complex Heatmaps
  * [ConsensusClusterPlus-1.60.0](https://www.bioconductor.org/packages/release/bioc/html/ConsensusClusterPlus.html) ConsensusClusterPlus
  * [CovSel-1.2.1](https://cran.r-project.org/web/packages/CovSel/index.html) Model-Free Covariate Selection
  * [CytoML-2.8.0](https://www.bioconductor.org/packages/release/bioc/html/CytoML.html) A GatingML Interface for Cross Platform Cytometry Data Sharing
  * [DAAG-1.24](https://cran.r-project.org/web/packages/DAAG/index.html) Data Analysis and Graphics Data and Functions
  * [DBI-1.1.2](https://cran.r-project.org/web/packages/DBI/index.html) R Database Interface
  * [DECIPHER-2.24.0](https://www.bioconductor.org/packages/release/bioc/html/DECIPHER.html) Tools for curating, analyzing, and manipulating biological sequences
  * [DEGseq-1.50.0](https://www.bioconductor.org/packages/release/bioc/html/DEGseq.html) Identify Differentially Expressed Genes from RNA-seq data
  * [DESeq2-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/DESeq2.html) Differential gene expression analysis based on the negative binomial distribution
  ...
  * [DHARMa-0.4.5](https://cran.r-project.org/web/packages/DHARMa/index.html) Residual Diagnostics for Hierarchical (Multi-Level / Mixed)
Regression Models
  ...
  * [DNAcopy-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/DNAcopy.html) DNA copy number data analysis
  ...
  * [DOSE-3.22.0](https://www.bioconductor.org/packages/release/bioc/html/DOSE.html) Disease Ontology Semantic and Enrichment analysis
  ...
  * [DT-0.22](https://cran.r-project.org/web/packages/DT/index.html) A Wrapper of the JavaScript Library 'DataTables'
...
Q-Learning, and Dynamic Weighted Survival Modeling (DWSurv)
  ...
  * [DescTools-0.99.44](https://cran.r-project.org/web/packages/DescTools/index.html) Tools for Descriptive Statistics
  ...
  * [DiffBind-3.6.0](https://www.bioconductor.org/packages/release/bioc/html/DiffBind.html) Differential Binding Analysis of ChIP-Seq Peak Data
  * [DirichletMultinomial-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/DirichletMultinomial.html) Dirichlet-Multinomial Mixture Model Machine Learning for Microbiome Data
  ...
  * [DynDoc-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/DynDoc.html) Dynamic document tools
  * [EBImage-4.38.0](https://www.bioconductor.org/packages/release/bioc/html/EBImage.html) Image processing and analysis toolbox for R
  ...
  * [EpiModel-2.2.1](https://cran.r-project.org/web/packages/EpiModel/index.html) Mathematical Modeling of Infectious Disease Dynamics
  * [Exact-3.1](https://cran.r-project.org/web/packages/Exact/index.html) Unconditional Exact Test
  * [ExperimentHub-2.4.0](https://www.bioconductor.org/packages/release/bioc/html/ExperimentHub.html) Client to access ExperimentHub resources
...
Sensitivity, Identifiability and Monte Carlo Analysis
  ...
  * [FactorCopula-0.8](https://cran.r-project.org/web/packages/FactorCopula/index.html) Factor, Bi-Factor and Second-Order Copula Models
  * [FlowSOM-2.4.0](https://www.bioconductor.org/packages/release/bioc/html/FlowSOM.html) Using self-organizing maps for visualization and interpretation of cytometry data
  * [Formula-1.2-4](https://cran.r-project.org/web/packages/Formula/index.html) Extended Model Formulas
  * [GENESIS-2.26.0](https://www.bioconductor.org/packages/release/bioc/html/GENESIS.html) GENetic EStimation and Inference in Structured samples (GENESIS): Statistical methods for analyzing genetic data from samples with population structure and/or relatedness
  * [GEOquery-2.64.0](https://www.bioconductor.org/packages/release/bioc/html/GEOquery.html) Get data from NCBI Gene Expression Omnibus (GEO)
  ...
  * [GO.db-3.15.0](https://www.bioconductor.org/packages/release/bioc/html/GO.db.html) A set of annotation maps describing the entire Gene Ontology
  * [GOSemSim-2.22.0](https://www.bioconductor.org/packages/release/bioc/html/GOSemSim.html) GO-terms Semantic Similarity Measures
  * [GOstats-2.62.0](https://www.bioconductor.org/packages/release/bioc/html/GOstats.html) Tools for manipulating GO and microarrays
  * [GPArotation-2022.4-1](https://cran.r-project.org/web/packages/GPArotation/index.html) GPA Factor Rotation
  ...
  * [GSEABase-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/GSEABase.html) Gene set enrichment data structures and methods
  * [GSVA-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/GSVA.html) Gene Set Variation Analysis for microarray and RNA-seq data
...
Model
  ...
  * [GWASTools-1.42.0](https://www.bioconductor.org/packages/release/bioc/html/GWASTools.html) Tools for Genome Wide Association Studies
  ...
  * [GenomicAlignments-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicAlignments.html) Representation and manipulation of short genomic alignments
  * [GenomicFeatures-1.48.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicFeatures.html) Conveniently import and query gene models
  * [GenomicFiles-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicFiles.html) Distributed computing by file or by range
  ...
  * [Glimma-2.6.0](https://www.bioconductor.org/packages/release/bioc/html/Glimma.html) Interactive HTML graphics
  ...
  * [GreyListChIP-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/GreyListChIP.html) Grey Lists -- Mask Artefact Regions Based on ChIP Inputs
  * [Gviz-1.40.0](https://www.bioconductor.org/packages/release/bioc/html/Gviz.html) Plotting data and annotation information along genomic coordinates
  * [GxEScanR-2.0.2](https://cran.r-project.org/web/packages/GxEScanR/index.html) Run GWAS/GWEIS Scans Using Binary Dosage Files
  * [HDF5Array-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/HDF5Array.html) HDF5 backend for DelayedArray objects
  * [HMMcopy-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/HMMcopy.html) Copy number prediction with correction for GC and mappability bias for HTS data
  * [HSMMSingleCell-1.16.0](https://www.bioconductor.org/packages/release/bioc/html/HSMMSingleCell.html) Single-cell RNA-Seq for differentiating human skeletal muscle myoblasts (HSMM)
  ...
  * [Hmisc-4.7-0](https://cran.r-project.org/web/packages/Hmisc/index.html) Harrell Miscellaneous
...
(www.zhaw.ch/idp)'
  * [IHW-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/IHW.html) Independent Hypothesis Weighting
  ...
  * [ISOcodes-2022.01.10](https://cran.r-project.org/web/packages/ISOcodes/index.html) Selected ISO Codes
  ...
  * [InteractionSet-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/InteractionSet.html) Base Classes for Storing Genomic Interaction Data
...
Buttlar
  * [KEGGREST-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/KEGGREST.html) Client-side REST access to the Kyoto Encyclopedia of Genes and Genomes (KEGG)
  * [KEGGgraph-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/KEGGgraph.html) KEGGgraph: A graph approach to KEGG PATHWAY in R and Bioconductor
  * [KODAMA-1.9](https://cran.r-project.org/web/packages/KODAMA/index.html) Knowledge Discovery by Accuracy Maximization
  ...
  * [LymphoSeq-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/LymphoSeq.html) Analyze high-throughput sequencing of T and B cell receptors
  * [LymphoSeqDB-0.99.2](https://www.bioconductor.org/packages/release/bioc/html/LymphoSeqDB.html) LymphoSeq annotation databases
  * [MAGeCKFlute-2.0.0](https://www.bioconductor.org/packages/release/bioc/html/MAGeCKFlute.html) Integrative Analysis Pipeline for Pooled CRISPR Functional Genetic Screens
  ...
  * [MASS-7.3-57](https://cran.r-project.org/web/packages/MASS/index.html) Support Functions and Datasets for Venables and Ripley's MASS
  * [MAST-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/MAST.html) Model-based Analysis of Single Cell Transcriptomics
  * [MCMCglmm-2.33](https://cran.r-project.org/web/packages/MCMCglmm/index.html) MCMC Generalised Linear Mixed Models
...
Structural Equation Models
  ...
  * [MatchIt-4.3.4](https://cran.r-project.org/web/packages/MatchIt/index.html) Nonparametric Preprocessing for Parametric Causal Inference
  * [Matching-4.10-2](https://cran.r-project.org/web/packages/Matching/index.html) Multivariate and Propensity Score Matching with Balance
Optimization
  * [Matrix-1.4-1](https://cran.r-project.org/web/packages/Matrix/index.html) Sparse and Dense Matrix Classes and Methods
...
Operations
  * [MatrixExtra-0.1.9-1](https://cran.r-project.org/web/packages/MatrixExtra/index.html) Extra Methods for Sparse Matrices
  ...
  * [Mfuzz-2.56.0](https://www.bioconductor.org/packages/release/bioc/html/Mfuzz.html) Soft clustering of time series gene expression data
...
Scripts
  ...
  * [NOISeq-2.40.0](https://www.bioconductor.org/packages/release/bioc/html/NOISeq.html) Exploratory analysis and differential expression for RNA-seq data
  ...
  * [OpenMx-2.20.6](https://cran.r-project.org/web/packages/OpenMx/index.html) Extended Structural Equation Modelling
  * [OrganismDbi-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/OrganismDbi.html) Software to enable the smooth interfacing of different database packages
  ...
  * [PFAM.db-3.15.0](https://www.bioconductor.org/packages/release/bioc/html/PFAM.db.html) A set of protein ID mappings for PFAM
  * [PICS-2.40.0](https://www.bioconductor.org/packages/release/bioc/html/PICS.html) Probabilistic inference of ChIP-seq
...
Machine Learning
  * [PearsonDS-1.2.2](https://cran.r-project.org/web/packages/PearsonDS/index.html) Pearson Distribution System
...
linear model
  ...
  * [ProtGenerics-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/ProtGenerics.html) Generic infrastructure for Bioconductor mass spectrometry packages
...
Metric
  * [RBGL-1.72.0](https://cran.r-project.org/web/packages/RBGL/index.html) An interface to the BOOST graph library
  ...
  * [RCurl-1.98-1.6](https://cran.r-project.org/web/packages/RCurl/index.html) General Network (HTTP/FTP/...) Client Interface for R
...
Analysis for Multiblock Data
  ...
  * [RItools-0.1-18](https://cran.r-project.org/web/packages/RItools/index.html) Randomization Inference Tools
...
Theory
  * [RNASeqPower-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/RNASeqPower.html) Sample size for RNAseq studies
  * [RNeXML-2.4.6](https://cran.r-project.org/web/packages/RNeXML/index.html) Semantically Rich I/O for the 'NeXML' Format
  * [RNifti-1.4.0](https://cran.r-project.org/web/packages/RNifti/index.html) Fast R and C++ Access to NIfTI Images
  ...
  * [RProtoBufLib-2.8.0](https://www.bioconductor.org/packages/release/bioc/html/RProtoBufLib.html) C++ headers and static libraries of Protocol buffers
...
(SNNS)
  * [RSQLite-2.2.12](https://cran.r-project.org/web/packages/RSQLite/index.html) SQLite Interface for R
...
Algorithm
  * [Rcgmin-2013-2.21](https://cran.r-project.org/web/packages/Rcgmin/index.html) Conjugate Gradient Minimization of Nonlinear Functions with Box
Constraints
  * [Rcpp-1.0.8.3](https://cran.r-project.org/web/packages/Rcpp/index.html) Seamless R and C++ Integration
...
Neighbors
  * [RcppArmadillo-0.11.0.0.0](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
  * [RcppCCTZ-0.2.10](https://cran.r-project.org/web/packages/RcppCCTZ/index.html) 'Rcpp' Bindings for the 'CCTZ' Library
  ...
  * [RcppEigen-0.3.3.9.2](https://cran.r-project.org/web/packages/RcppEigen/index.html) 'Rcpp' Integration for the 'Eigen' Templated Linear Algebra
Library
  * [RcppGSL-0.3.11](https://cran.r-project.org/web/packages/RcppGSL/index.html) 'Rcpp' Integration for 'GNU GSL' Vectors and Matrices
...
Implementations
  * [Rdpack-2.3](https://cran.r-project.org/web/packages/Rdpack/index.html) Update and Manipulate Rd Documentation Objects
  ...
  * [ReportingTools-2.36.0](https://www.bioconductor.org/packages/release/bioc/html/ReportingTools.html) Tools for making reports in various formats
  ...
  * [Rgraphviz-2.40.0](https://cran.r-project.org/web/packages/Rgraphviz/index.html) Provides plotting capabilities for R graph objects
  ...
  * [Ringo-1.60.0](https://www.bioconductor.org/packages/release/bioc/html/Ringo.html) R Investigation of ChIP-chip Oligoarrays
  * [Rlabkey-2.8.4](https://cran.r-project.org/web/packages/Rlabkey/index.html) Data Exchange Between R and 'LabKey' Server
  * [Rmpfr-0.8-7](https://cran.r-project.org/web/packages/Rmpfr/index.html) R MPFR - Multiple Precision Floating-Point Reliable
  ...
  * [Rsubread-2.10.0](https://www.bioconductor.org/packages/release/bioc/html/Rsubread.html) Mapping, quantification and variant analysis of sequencing data
...
Implementation
  * [Rttf2pt1-1.3.10](https://cran.r-project.org/web/packages/Rttf2pt1/index.html) 'ttf2pt1' Program
...
associated with species distribution modelling exercises
  ...
  * [SNPRelate-1.30.0](https://cran.r-project.org/web/packages/SNPRelate/index.html) Parallel Computing Toolset for Genome-Wide Association Studies
(GWAS)
  * [SNPassoc-2.0-11](https://cran.r-project.org/web/packages/SNPassoc/index.html) SNPs-Based Whole Genome Association Studies
  ...
  * [SPIA-2.48.0](https://www.bioconductor.org/packages/release/bioc/html/SPIA.html) Signaling Pathway Impact Analysis (SPIA) using combined evidence of pathway over-representation and unusual signaling perturbations
...
Algorithms
  ...
  * [SeqArray-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/SeqArray.html) Data management of large-scale whole-genome sequence variant calls
  * [SeqVarTools-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/SeqVarTools.html) Tools for variant data
  * [ShortRead-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/ShortRead.html) FASTQ input and manipulation
...
Generalized Linear Regression
  ...
  * [TFBSTools-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/TFBSTools.html) Software Package for Transcription Factor Binding Site (TFBS) Analysis
...
Matrices
  ...
  * [TMB-1.8.1](https://cran.r-project.org/web/packages/TMB/index.html) Template Model Builder: A General Random Effect Tool Inspired by
'ADMB'
  ...
  * [TitanCNA-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/TitanCNA.html) Subclonal copy number and LOH prediction from whole genome sequencing of tumours
  * [TraMineR-2.2-3](https://cran.r-project.org/web/packages/TraMineR/index.html) Trajectory Miner: a Toolbox for Exploring and Rendering
Sequences
...
Visualizing Intersecting Sets
  * [V8-4.1.0](https://cran.r-project.org/web/packages/V8/index.html) Embedded JavaScript and WebAssembly Engine for R
  * [VGAM-1.1-6](https://cran.r-project.org/web/packages/VGAM/index.html) Vector Generalized Linear and Additive Models
  ...
  * [VariantAnnotation-1.42.0](https://www.bioconductor.org/packages/release/bioc/html/VariantAnnotation.html) Annotation of Genetic Variants
  ...
  * [VineCopula-2.4.3](https://cran.r-project.org/web/packages/VineCopula/index.html) Statistical Inference of Vine Copulas
  ...
  * [Wrench-1.14.0](https://www.bioconductor.org/packages/release/bioc/html/Wrench.html) Wrench normalization for sparse count data
...
and Excel 2007 (XLSX) Files
  * [XML-3.99-0.9](https://cran.r-project.org/web/packages/XML/index.html) Tools for Parsing and Generating XML Within R and S-Plus
  ...
  * [ade4-1.7-19](https://cran.r-project.org/web/packages/ade4/index.html) Analysis of Ecological Data: Exploratory and Euclidean Methods
in Environmental Sciences
  * [admisc-0.26](https://cran.r-project.org/web/packages/admisc/index.html) Adrian Dusa's Miscellaneous
  * [affxparser-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/affxparser.html) Affymetrix File Parsing SDK
  * [affy-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/affy.html) Methods for Affymetrix Oligonucleotide Arrays
  * [affycoretools-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/affycoretools.html) Functions useful for those doing repetitive analyses with Affymetrix GeneChips
  * [affyio-1.66.0](https://www.bioconductor.org/packages/release/bioc/html/affyio.html) Tools for parsing Affymetrix data files
  * [aggregation-1.0.1](https://cran.r-project.org/web/packages/aggregation/index.html) p-Value Aggregation Methods
  * [akima-0.6-3.3](https://cran.r-project.org/web/packages/akima/index.html) Interpolation of Irregularly and Regularly Spaced Data
...
Animations
  * [annaffy-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/annaffy.html) Annotation tools for Affymetrix biological metadata
  * [annotate-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/annotate.html) Annotation for microarrays
  ...
  * [apeglm-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/apeglm.html) Approximate posterior estimation for GLM coefficients
  * [aplot-0.1.3](https://cran.r-project.org/web/packages/aplot/index.html) Decorate a 'ggplot' with Associated Information
  * [argparse-2.1.5](https://cran.r-project.org/web/packages/argparse/index.html) Command Line Optional and Positional Argument Parser
...
Summaries
  * [arules-1.7-3](https://cran.r-project.org/web/packages/arules/index.html) Mining Association Rules and Frequent Itemsets
...
'fmri', 'dwi'
  * [babelgene-22.3](https://cran.r-project.org/web/packages/babelgene/index.html) Gene Orthologs for Model Organisms in a Tidy Data Format
  ...
  * [bamsignals-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/bamsignals.html) Extract read count signals from bam files
  ...
  * [baySeq-2.30.0](https://www.bioconductor.org/packages/release/bioc/html/baySeq.html) Empirical Bayesian analysis of patterns of differential expression in count data
...
Files
  ...
  * [bio3d-2.4-3](https://cran.r-project.org/web/packages/bio3d/index.html) Biological Structure Analysis
  * [biom-0.3.12](https://cran.r-project.org/web/packages/biom/index.html) An interface package (beta) for the BIOM file format.
  * [biomaRt-2.52.0](https://www.bioconductor.org/packages/release/bioc/html/biomaRt.html) Interface to BioMart databases (i.e. Ensembl)
  * [biomformat-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/biomformat.html) An interface package for the BIOM file format
  ...
  * [biovizBase-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/biovizBase.html) Basic graphic utilities for visualization of genomic data.
  ...
  * [blavaan-0.4-1](https://cran.r-project.org/web/packages/blavaan/index.html) Bayesian Latent Variable Analysis
...
('BLOBS')
  ...
  * [bnlearn-4.7.1](https://cran.r-project.org/web/packages/bnlearn/index.html) Bayesian Network Structure Learning, Parameter Learning and
Inference
  * [bold-1.2.0](https://cran.r-project.org/web/packages/bold/index.html) Interface to Bold Systems API
  * [bookdown-0.26](https://cran.r-project.org/web/packages/bookdown/index.html) Authoring Books and Technical Documents with R Markdown
  ...
  * [breakaway-4.7.9](https://cran.r-project.org/web/packages/breakaway/index.html) Species Richness Estimation and Modeling
  * [brew-1.0-7](https://cran.r-project.org/web/packages/brew/index.html) Templating Framework for Report Generation
...
in Wang and Louis (2003)
  ...
  * [brms-2.17.0](https://cran.r-project.org/web/packages/brms/index.html) Bayesian Regression Models using 'Stan'
  * [broom-0.8.0](https://cran.r-project.org/web/packages/broom/index.html) Convert Statistical Objects into Tidy Tibbles
  * [broom.helpers-1.7.0](https://cran.r-project.org/web/packages/broom.helpers/index.html) Helpers for Model Coefficients Tibbles
  ...
  * [bumphunter-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/bumphunter.html) Bump Hunter
  * [cNORM-3.0.1](https://cran.r-project.org/web/packages/cNORM/index.html) Continuous Norming
  ...
  * [car-3.0-12](https://cran.r-project.org/web/packages/car/index.html) Companion to Applied Regression
  * [carData-3.0-5](https://cran.r-project.org/web/packages/carData/index.html) Companion to Applied Regression Data Sets
  * [caret-6.0-92](https://cran.r-project.org/web/packages/caret/index.html) Classification and Regression Training
...
(CGDS)
  ...
  * [chipseq-1.46.0](https://www.bioconductor.org/packages/release/bioc/html/chipseq.html) chipseq: A package for analyzing chipseq data
  * [chromVAR-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/chromVAR.html) Chromatin Variation Across Regions
  ...
  * [circlize-0.4.14](https://cran.r-project.org/web/packages/circlize/index.html) Circular Visualization
  * [circular-0.4-94.1](https://cran.r-project.org/web/packages/circular/index.html) Circular Statistics
  ...
  * [cli-3.3.0](https://cran.r-project.org/web/packages/cli/index.html) Helpers for Developing Command Line Interfaces
  ...
  * [clue-0.3-60](https://cran.r-project.org/web/packages/clue/index.html) Cluster Ensembles
  * [cluster-2.1.3](https://cran.r-project.org/web/packages/cluster/index.html) "Finding Groups in Data": Cluster Analysis Extended Rousseeuw et
al.
  ...
  * [clusterProfiler-4.4.1](https://www.bioconductor.org/packages/release/bioc/html/clusterProfiler.html) A universal enrichment tool for interpreting omics data
  ...
  * [clustree-0.4.4](https://cran.r-project.org/web/packages/clustree/index.html) Visualise Clusterings at Different Resolutions
  * [cobalt-4.3.2](https://cran.r-project.org/web/packages/cobalt/index.html) Covariate Balance Tables and Plots
  ...
  * [collapse-1.7.6](https://cran.r-project.org/web/packages/collapse/index.html) Advanced and Fast Data Transformation
...
Plots
  ...
  * [commonmark-1.8.0](https://cran.r-project.org/web/packages/commonmark/index.html) High Performance CommonMark and Github Markdown Rendering in R
  ...
  * [conquer-1.3.0](https://cran.r-project.org/web/packages/conquer/index.html) Convolution-Type Smoothed Quantile Regression
  ...
  * [copynumber-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/copynumber.html) Segmentation of single- and multi-track copy number data by penalized least squares regression.
  ...
  * [covsim-0.2.1](https://cran.r-project.org/web/packages/covsim/index.html) VITA, IG and PLSIM Simulation for Given Covariance and Marginals
...
Hazards Model
  ...
  * [cpp11-0.4.2](https://cran.r-project.org/web/packages/cpp11/index.html) A C++11 Interface for R's C Interface
  * [crayon-1.5.1](https://cran.r-project.org/web/packages/crayon/index.html) Colored Terminal Output
  ...
  * [crul-1.2.0](https://cran.r-project.org/web/packages/crul/index.html) HTTP Client
  ...
  * [cubature-2.0.4.4](https://cran.r-project.org/web/packages/cubature/index.html) Adaptive Multivariate Integration over Hypercubes
  * [cubelyr-1.0.1](https://cran.r-project.org/web/packages/cubelyr/index.html) A Data Cube 'dplyr' Backend
  * [cummeRbund-2.38.0](https://www.bioconductor.org/packages/release/bioc/html/cummeRbund.html) Analysis, exploration, manipulation, and visualization of Cufflinks high-throughput sequencing data.
  ...
  * [cytolib-2.8.0](https://www.bioconductor.org/packages/release/bioc/html/cytolib.html) C++ infrastructure for representing and interacting with the gated cytometry data
  ...
  * [dada2-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/dada2.html) Accurate, high-resolution sample inference from amplicon sequencing data
  ...
  * [dbscan-1.1-10](https://cran.r-project.org/web/packages/dbscan/index.html) Density-Based Spatial Clustering of Applications with Noise
(DBSCAN) and Related Algorithms
  ...
  * [deSolve-1.32](https://cran.r-project.org/web/packages/deSolve/index.html) Solvers for Initial Value Problems of Differential Equations
('ODE', 'DAE', 'DDE')
  ...
  * [depmap-1.10.0](https://www.bioconductor.org/packages/release/bioc/html/depmap.html) Cancer Dependency Map Data Package
  * [derfinder-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/derfinder.html) Annotation-agnostic differential expression analysis of RNA-seq data at base-pair resolution via the DER Finder approach
  * [derfinderHelper-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/derfinderHelper.html) derfinder helper package
  * [desc-1.4.1](https://cran.r-project.org/web/packages/desc/index.html) Manipulate DESCRIPTION Files
  * [descr-1.1.5](https://cran.r-project.org/web/packages/descr/index.html) Descriptive Statistics
  * [devtools-2.4.3](https://cran.r-project.org/web/packages/devtools/index.html) Tools to Make Developing R Packages Easier
...
Flow Diagrams
  * [dials-0.1.1](https://cran.r-project.org/web/packages/dials/index.html) Tools for Creating Tuning Parameter Values
  ...
  * [digest-0.6.29](https://cran.r-project.org/web/packages/digest/index.html) Create Compact Hash Digests of R Objects
  * [dimRed-0.2.5](https://cran.r-project.org/web/packages/dimRed/index.html) A Framework for Dimensionality Reduction
...
Information from an Object
  ...
  * [distributional-0.3.0](https://cran.r-project.org/web/packages/distributional/index.html) Vectorised Probability Distributions
...
Package
  * [doBy-4.6.12](https://cran.r-project.org/web/packages/doBy/index.html) Groupwise Statistics, LSmeans, Linear Estimates, Utilities
  ...
  * [dplyr-1.0.8](https://cran.r-project.org/web/packages/dplyr/index.html) A Grammar of Data Manipulation
...
Harbron's Approach
  ...
  * [dtplyr-1.2.1](https://cran.r-project.org/web/packages/dtplyr/index.html) Data Table Back-End for 'dplyr'
...
Theory Group (Formerly: E1071), TU Wien
  ...
  * [edgeR-3.38.0](https://www.bioconductor.org/packages/release/bioc/html/edgeR.html) Empirical Analysis of Digital Gene Expression Data in R
...
Regions
  ...
  * [enrichplot-1.16.0](https://www.bioconductor.org/packages/release/bioc/html/enrichplot.html) Visualization of Functional Enrichment Result
  * [ensembldb-2.20.0](https://www.bioconductor.org/packages/release/bioc/html/ensembldb.html) Utilities to create and use Ensembl-based annotation databases
...
Networks with Count Edges
  ...
  * [evaluate-0.15](https://cran.r-project.org/web/packages/evaluate/index.html) Parsing and Evaluation Tools that Provide More Details than the
Default
  * [evd-2.3-6](https://cran.r-project.org/web/packages/evd/index.html) Functions for Extreme Value Distributions
  ...
  * [fastseg-1.42.0](https://www.bioconductor.org/packages/release/bioc/html/fastseg.html) fastseg - a fast segmentation algorithm
  ...
  * [fda-6.0.3](https://cran.r-project.org/web/packages/fda/index.html) Functional Data Analysis
...
Three-Dimensional, and Multivariate Transforms
  * [fgsea-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/fgsea.html) Fast Gene Set Enrichment Analysis
  ...
  * [finalfit-1.0.4](https://cran.r-project.org/web/packages/finalfit/index.html) Quickly Create Elegant Regression Results Tables and Plots when
Modelling
...
Censored Data
  ...
  * [flowClust-3.34.0](https://www.bioconductor.org/packages/release/bioc/html/flowClust.html) Clustering for Flow Cytometry
  * [flowCore-2.8.0](https://www.bioconductor.org/packages/release/bioc/html/flowCore.html) flowCore: Basic structures for flow cytometry data
  * [flowStats-4.8.0](https://www.bioconductor.org/packages/release/bioc/html/flowStats.html) Statistical methods for the analysis of flow cytometry data
  * [flowViz-1.60.0](https://www.bioconductor.org/packages/release/bioc/html/flowViz.html) Visualization for flow cytometry
  * [flowWorkspace-4.8.0](https://www.bioconductor.org/packages/release/bioc/html/flowWorkspace.html) Infrastructure for representing and interacting with gated and ungated cytometry data sets.
...
Makridakis, Wheelwright & Hyndman (1998)
  ...
  * [forecast-8.16](https://cran.r-project.org/web/packages/forecast/index.html) Forecasting Functions for Time Series and Linear Models
  * [foreign-0.8-82](https://cran.r-project.org/web/packages/foreign/index.html) Read Data Stored by 'Minitab', 'S', 'SAS', 'SPSS', 'Stata',
'Systat', 'Weka', 'dBase', ...
...
Calls, Assignments and Other R Objects
  ...
  * [future-1.25.0](https://cran.r-project.org/web/packages/future/index.html) Unified Parallel and Distributed Processing in R for Everyone
  * [future.apply-1.9.0](https://cran.r-project.org/web/packages/future.apply/index.html) Apply Function to Elements in Parallel using Futures
  ...
  * [gage-2.46.0](https://www.bioconductor.org/packages/release/bioc/html/gage.html) Generally Applicable Gene-set Enrichment for Pathway Analysis
  * [gam-1.20.1](https://cran.r-project.org/web/packages/gam/index.html) Generalized Additive Models
...
Shape
  * [gamlss.dist-6.0-3](https://cran.r-project.org/web/packages/gamlss.dist/index.html) Distributions for Generalized Additive Models for Location Scale
and Shape
  ...
  * [gap-1.2.3-1](https://cran.r-project.org/web/packages/gap/index.html) Genetic Analysis Package
  * [gapfill-0.9.6-1](https://cran.r-project.org/web/packages/gapfill/index.html) Fill Missing Values in Satellite Data
  * [gargle-1.2.0](https://cran.r-project.org/web/packages/gargle/index.html) Utilities for Working with Google APIs
  ...
  * [gcrma-2.68.0](https://www.bioconductor.org/packages/release/bioc/html/gcrma.html) Background Adjustment Using Sequence Information
  ...
  * [gdsfmt-1.32.0](https://cran.r-project.org/web/packages/gdsfmt/index.html) 
  * [gdtools-0.2.4](https://cran.r-project.org/web/packages/gdtools/index.html) Utilities for Graphical Rendering
  * [gee-4.13-22](https://cran.r-project.org/web/packages/gee/index.html) Generalized Estimation Equation Solver
  * [geepack-1.3.3](https://cran.r-project.org/web/packages/geepack/index.html) Generalized Estimating Equation Package
  * [geex-1.0.12](https://cran.r-project.org/web/packages/geex/index.html) An API for M-Estimation
  * [geiger-2.0.7](https://cran.r-project.org/web/packages/geiger/index.html) Analysis of Evolutionary Diversification
  * [geneLenDataBase-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/geneLenDataBase.html) Lengths of mRNA transcripts for a number of genomes
  * [genefilter-1.78.0](https://www.bioconductor.org/packages/release/bioc/html/genefilter.html) genefilter: methods for filtering genes from high-throughput experiments
  * [geneplotter-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/geneplotter.html) Graphics related functions for Bioconductor
  * [generics-0.1.2](https://cran.r-project.org/web/packages/generics/index.html) Common S3 Generics not Provided by Base R Methods Related to
Model Fitting
  * [genoPlotR-0.8.11](https://cran.r-project.org/web/packages/genoPlotR/index.html) Plot Publication-Grade Gene and Genome Maps
  * [geojsonsf-2.0.2](https://cran.r-project.org/web/packages/geojsonsf/index.html) GeoJSON to Simple Feature Converter
  ...
  * [geometry-0.4.6](https://cran.r-project.org/web/packages/geometry/index.html) Mesh Generation and Surface Tessellation
  * [gert-1.6.0](https://cran.r-project.org/web/packages/gert/index.html) Simple Git Client for R
...
Enhancements
  ...
  * [ggbio-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/ggbio.html) Visualization tools for genomic data
  * [ggcyto-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/ggcyto.html) Visualize Cytometry data with ggplot
  ...
  * [ggfun-0.0.6](https://cran.r-project.org/web/packages/ggfun/index.html) Miscellaneous Functions for 'ggplot2'
  * [ggnetwork-0.5.10](https://cran.r-project.org/web/packages/ggnetwork/index.html) Geometries to Plot Networks with 'ggplot2'
  * [ggnewscale-0.4.7](https://cran.r-project.org/web/packages/ggnewscale/index.html) Multiple Fill and Colour Scales in 'ggplot2'
  * [ggplot2-3.3.5](https://cran.r-project.org/web/packages/ggplot2/index.html) Create Elegant Data Visualisations Using the Grammar of Graphics
...
'ggplot2'
  * [ggsignif-0.6.3](https://cran.r-project.org/web/packages/ggsignif/index.html) Significance Brackets for 'ggplot2'
  * [ggthemes-4.2.4](https://cran.r-project.org/web/packages/ggthemes/index.html) Extra Themes, Scales and Geoms for 'ggplot2'
  * [ggtree-3.4.0](https://www.bioconductor.org/packages/release/bioc/html/ggtree.html) an R package for visualization of tree and annotation data
  * [ggvis-0.4.7](https://cran.r-project.org/web/packages/ggvis/index.html) Interactive Grammar of Graphics
  * [gh-1.3.0](https://cran.r-project.org/web/packages/gh/index.html) 'GitHub' 'API'
  ...
  * [gld-2.6.4](https://cran.r-project.org/web/packages/gld/index.html) Estimation and Use of the Generalised (Tukey) Lambda
Distribution
  * [gllvm-1.3.1](https://cran.r-project.org/web/packages/gllvm/index.html) Generalized Linear Latent Variable Models
  * [glmmML-1.1.2](https://cran.r-project.org/web/packages/glmmML/index.html) Generalized Linear Models with Clustering
  * [glmmTMB-1.1.3](https://cran.r-project.org/web/packages/glmmTMB/index.html) Generalized Linear Mixed Models using Template Model Builder
...
Proportional Hazards Model
  ...
  * [gmm-1.6-6](https://cran.r-project.org/web/packages/gmm/index.html) Generalized Method of Moments and Generalized Empirical
Likelihood
  * [gmodels-2.18.1](https://cran.r-project.org/web/packages/gmodels/index.html) Various R Programming Tools for Model Fitting
  * [gmp-0.6-5](https://cran.r-project.org/web/packages/gmp/index.html) Multiple Precision Arithmetic
  ...
  * [googlesheets4-1.0.0](https://cran.r-project.org/web/packages/googlesheets4/index.html) Access Google Sheets using the Sheets API V4
  * [goseq-1.48.0](https://www.bioconductor.org/packages/release/bioc/html/goseq.html) Gene Ontology analyser for RNA-seq and other length biased data
  ...
  * [graph-1.74.0](https://cran.r-project.org/web/packages/graph/index.html) graph: A package to handle graph data structures
  * graphics built in
  * [graphlayouts-0.8.0](https://cran.r-project.org/web/packages/graphlayouts/index.html) Additional Layout Algorithms for Network Visualizations
  * [grf-2.1.0](https://cran.r-project.org/web/packages/grf/index.html) Generalized Random Forests
  * grid built in
...
Covariates
  ...
  * [gsw-1.0-6](https://cran.r-project.org/web/packages/gsw/index.html) Gibbs Sea Water Functions
  * [gt-0.5.0](https://cran.r-project.org/web/packages/gt/index.html) Easily Create Presentation-Ready Display Tables
  * [gtable-0.3.0](https://cran.r-project.org/web/packages/gtable/index.html) Arrange 'Grobs' in Tables
  * [gtools-3.9.2](https://cran.r-project.org/web/packages/gtools/index.html) Various R Programming Tools
  * [gtsummary-1.6.0](https://cran.r-project.org/web/packages/gtsummary/index.html) Presentation-Ready Data Summary and Analytic Result Tables
  * [h2o-3.36.0.4](https://cran.r-project.org/web/packages/h2o/index.html) R Interface for the 'H2O' Scalable Machine Learning Platform
...
Attributes using the EM Algorithm
  * [haplo.stats-1.8.7](https://cran.r-project.org/web/packages/haplo.stats/index.html) Statistical Analysis of Haplotypes with Traits and Covariates
when Linkage Phase is Ambiguous
  * [hardhat-0.2.0](https://cran.r-project.org/web/packages/hardhat/index.html) Construct Modeling Packages
  * [haven-2.5.0](https://cran.r-project.org/web/packages/haven/index.html) Import and Export 'SPSS', 'Stata' and 'SAS' Files
  * [hdf5r-1.3.5](https://cran.r-project.org/web/packages/hdf5r/index.html) Interface to the 'HDF5' Binary Data Format
  ...
  * [hms-1.1.1](https://cran.r-project.org/web/packages/hms/index.html) Pretty Time of Day
  * [hopach-2.56.0](https://cran.r-project.org/web/packages/hopach/index.html) Hierarchical Ordered Partitioning and Collapsing Hybrid (HOPACH)
  * [htmlTable-2.4.0](https://cran.r-project.org/web/packages/htmlTable/index.html) Advanced Tables for Markdown/HTML
  * [htmltools-0.5.2](https://cran.r-project.org/web/packages/htmltools/index.html) Tools for HTML
  ...
  * [httpuv-1.6.5](https://cran.r-project.org/web/packages/httpuv/index.html) HTTP and WebSocket Server Library
...
High-Dimensional Cytometry
  ...
  * [igraph-1.3.1](https://cran.r-project.org/web/packages/igraph/index.html) Network Analysis and Visualization
  ...
  * [illuminaio-0.38.0](https://www.bioconductor.org/packages/release/bioc/html/illuminaio.html) Parsing Illumina Microarray Output Files
  * [image.binarization-0.1.2](https://cran.r-project.org/web/packages/image.binarization/index.html) Binarize Images for Enhancing Optical Character Recognition
  ...
  * [impute-1.70.0](https://cran.r-project.org/web/packages/impute/index.html) impute: Imputation for microarray data
  * [ineq-0.2-13](https://cran.r-project.org/web/packages/ineq/index.html) Measuring Inequality, Concentration, and Poverty
  * [infer-1.0.0](https://cran.r-project.org/web/packages/infer/index.html) Tidy Statistical Inference
...
Network
  ...
  * [interactiveDisplayBase-1.34.0](https://www.bioconductor.org/packages/release/bioc/html/interactiveDisplayBase.html) Base package for enabling powerful shiny web displays of Bioconductor objects
  ...
  * [ipred-0.9-12](https://cran.r-project.org/web/packages/ipred/index.html) Improved Predictors
  * [irace-3.4.1](https://cran.r-project.org/web/packages/irace/index.html) Iterated Racing for Automatic Algorithm Configuration
  * [irlba-2.3.5](https://cran.r-project.org/web/packages/irlba/index.html) Fast Truncated Singular Value Decomposition and Principal
Components Analysis for Large Dense and Sparse Matrices
  ...
  * [isoband-0.2.5](https://cran.r-project.org/web/packages/isoband/index.html) Generate Isolines and Isobands from Regularly Spaced Elevation
Grids
  ...
  * [jomo-2.7-3](https://cran.r-project.org/web/packages/jomo/index.html) Multilevel Joint Modelling Multiple Imputation
...
(JSON)
  * [jsonlite-1.8.0](https://cran.r-project.org/web/packages/jsonlite/index.html) A Simple and Robust JSON Parser and Generator for R
  * [jstable-1.0.7](https://cran.r-project.org/web/packages/jstable/index.html) Create Tables from Different Types of Regression
  * [karyoploteR-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/karyoploteR.html) Plot customizable linear genomes displaying arbitrary data
  * [kde1d-1.0.4](https://cran.r-project.org/web/packages/kde1d/index.html) Univariate Kernel Density Estimation
...
Derivatives
  * [kernlab-0.9-30](https://cran.r-project.org/web/packages/kernlab/index.html) Kernel-Based Machine Learning Lab
  * [keyring-1.3.0](https://cran.r-project.org/web/packages/keyring/index.html) Access the System Credential Store from R
  ...
  * [klaR-1.7-0](https://cran.r-project.org/web/packages/klaR/index.html) Classification and Visualization
  * [knitr-1.38](https://cran.r-project.org/web/packages/knitr/index.html) A General-Purpose Package for Dynamic Report Generation in R
  * [knockoff-0.3.5](https://cran.r-project.org/web/packages/knockoff/index.html) The Knockoff Filter for Controlled Variable Selection
  ...
  * [kyotil-2022.4-5](https://cran.r-project.org/web/packages/kyotil/index.html) Utility Functions for Statistical Analysis Report Generation and
Monte Carlo Studies
  ...
  * [labelled-2.9.0](https://cran.r-project.org/web/packages/labelled/index.html) Manipulating Labelled Data
...
Loops
  ...
  * [latticeExtra-0.6-29](https://cran.r-project.org/web/packages/latticeExtra/index.html) Extra Graphical Utilities Based on Lattice
  * [lava-1.6.10](https://cran.r-project.org/web/packages/lava/index.html) Latent Variable Models
  * [lavaan-0.6-11](https://cran.r-project.org/web/packages/lavaan/index.html) Latent Variable Analysis
  * [lazy-1.2-17](https://cran.r-project.org/web/packages/lazy/index.html) Lazy Learning for Local Regression
...
Library
  ...
  * [leiden-0.3.9](https://cran.r-project.org/web/packages/leiden/index.html) R Implementation of Leiden Clustering Algorithm
  * [lgr-0.4.3](https://cran.r-project.org/web/packages/lgr/index.html) A Fully Featured Logging Framework
  ...
  * [lifecycle-1.0.1](https://cran.r-project.org/web/packages/lifecycle/index.html) Manage the Life Cycle of your Package Functions
  * [limSolve-1.5.6](https://cran.r-project.org/web/packages/limSolve/index.html) Solving Linear Inverse Models
  * [limma-3.52.0](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
...
Communities in Networks
  ...
  * [lme4-1.1-29](https://cran.r-project.org/web/packages/lme4/index.html) Linear Mixed-Effects Models using 'Eigen' and S4
  * [lmerTest-3.1-3](https://cran.r-project.org/web/packages/lmerTest/index.html) Tests in Linear Mixed Effects Models
  * [lmom-2.8](https://cran.r-project.org/web/packages/lmom/index.html) L-Moments
  * [lmtest-0.9-40](https://cran.r-project.org/web/packages/lmtest/index.html) Testing Linear Regression Models
  * [lobstr-1.1.1](https://cran.r-project.org/web/packages/lobstr/index.html) Visualize R Data Structures with Trees
  * [locfdr-1.1-8](https://cran.r-project.org/web/packages/locfdr/index.html) Computes Local False Discovery Rates
  * [locfit-1.5-9.5](https://cran.r-project.org/web/packages/locfit/index.html) Local Regression, Likelihood and Density Estimation
...
Models
  * [lpSolve-5.6.15](https://cran.r-project.org/web/packages/lpSolve/index.html) Interface to 'Lp_solve' v. 5.5 to Solve Linear/Integer Programs
  * [lpSolveAPI-5.5.2.0-17.7](https://cran.r-project.org/web/packages/lpSolveAPI/index.html) R Interface to 'lp_solve' Version 5.5.2.0
  * [lpridge-1.0-8](https://cran.r-project.org/web/packages/lpridge/index.html) Local Polynomial (Ridge) Regression
  * [lpsymphony-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/lpsymphony.html) Symphony integer linear programming solver in R
...
Likelihood or Least Squares
  * [lubridate-1.8.0](https://cran.r-project.org/web/packages/lubridate/index.html) Make Dealing with Dates a Little Easier
  * [lumi-2.48.0](https://www.bioconductor.org/packages/release/bioc/html/lumi.html) BeadArray Specific Methods for Illumina Methylation and Expression Microarrays
  * [lwgeom-0.2-8](https://cran.r-project.org/web/packages/lwgeom/index.html) Bindings to Selected 'liblwgeom' Functions for Simple Features
  ...
  * [maSigPro-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/maSigPro.html) Significant Gene Expression Profile Differences in Time Course Gene Expression Data
  ...
  * [mapproj-1.2.8](https://cran.r-project.org/web/packages/mapproj/index.html) Map Projections
  * [maps-3.4.0](https://cran.r-project.org/web/packages/maps/index.html) Draw Geographical Maps
  * [maptools-1.1-4](https://cran.r-project.org/web/packages/maptools/index.html) Tools for Handling Spatial Objects
  * [markdown-1.1](https://cran.r-project.org/web/packages/markdown/index.html) Render Markdown with the C Library 'Sundown'
  * [marray-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/marray.html) Exploratory analysis for two-color spotted microarray data
  * [mathjaxr-1.6-0](https://cran.r-project.org/web/packages/mathjaxr/index.html) Using 'Mathjax' in Rd Files
  * [matlab-1.0.2](https://cran.r-project.org/web/packages/matlab/index.html) MATLAB emulation package
...
Vectors)
  * [matrixcalc-1.0-5](https://cran.r-project.org/web/packages/matrixcalc/index.html) Collection of Functions for Matrix Calculations
...
Occurrence Using Presence-Only Data
  ...
  * [mboost-2.9-6](https://cran.r-project.org/web/packages/mboost/index.html) Model-Based Boosting
  * [mclust-5.4.9](https://cran.r-project.org/web/packages/mclust/index.html) Gaussian Mixture Modelling for Model-Based Clustering,
Classification, and Density Estimation
  ...
  * [mda-0.5-2](https://cran.r-project.org/web/packages/mda/index.html) Mixture and Flexible Discriminant Analysis
  ...
  * [memuse-4.2-1](https://cran.r-project.org/web/packages/memuse/index.html) Memory Estimation Utilities
  * [metadat-1.2-0](https://cran.r-project.org/web/packages/metadat/index.html) Meta-Analysis Datasets
  * [metafor-3.4-0](https://cran.r-project.org/web/packages/metafor/index.html) Meta-Analysis Package for R
  * [metagenomeSeq-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/metagenomeSeq.html) Statistical analysis for sparse high-throughput sequencing
  * methods built in
  * [methylKit-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/methylKit.html) DNA methylation analysis from high-throughput bisulfite sequencing results
  * [methylumi-2.42.0](https://www.bioconductor.org/packages/release/bioc/html/methylumi.html) Handle Illumina methylation data
  * [mets-1.2.9](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
  * [mgcv-1.8-40](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
  ...
  * [miceadds-3.12-26](https://cran.r-project.org/web/packages/miceadds/index.html) Some Additional Multiple Imputation Functions, Especially for
'mice'
...
Analysis
  * [minfi-1.42.0](https://www.bioconductor.org/packages/release/bioc/html/minfi.html) Analyze Illumina Infinium DNA methylation arrays
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [mirt-1.36.1](https://cran.r-project.org/web/packages/mirt/index.html) Multidimensional Item Response Theory
  ...
  * [mixOmics-6.20.0](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
  * [mixsqp-0.3-43](https://cran.r-project.org/web/packages/mixsqp/index.html) Sequential Quadratic Programming for Fast Maximum-Likelihood
Estimation of Mixture Proportions
  ...
  * [mlr-2.19.0](https://cran.r-project.org/web/packages/mlr/index.html) Machine Learning in R
  * [mltools-0.3.5](https://cran.r-project.org/web/packages/mltools/index.html) Machine Learning Tools
  * [mnormt-2.0.2](https://cran.r-project.org/web/packages/mnormt/index.html) The Multivariate Normal and t Distributions, and Their Truncated
Versions
  * [modeldata-0.1.1](https://cran.r-project.org/web/packages/modeldata/index.html) Data Sets Used Useful for Modeling Packages
  * [modelr-0.1.8](https://cran.r-project.org/web/packages/modelr/index.html) Modelling Functions that Work with the Pipe
  * [modeltools-0.2-23](https://cran.r-project.org/web/packages/modeltools/index.html) Tools and Classes for Statistical Models
  * [momentfit-0.2](https://cran.r-project.org/web/packages/momentfit/index.html) Methods of Moments
  ...
  * [motifmatchr-1.18.0](https://www.bioconductor.org/packages/release/bioc/html/motifmatchr.html) Fast Motif Matching in R
  * [mpath-0.4-2.22](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
  * [msa-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/msa.html) Multiple Sequence Alignment
  ...
  * [multcomp-1.4-18](https://cran.r-project.org/web/packages/multcomp/index.html) Simultaneous Inference in General Parametric Models
  ...
  * [multtest-2.52.0](https://cran.r-project.org/web/packages/multtest/index.html) Resampling-based multiple hypothesis testing
...
Dimensions
  ...
  * [nanotime-0.3.6](https://cran.r-project.org/web/packages/nanotime/index.html) Nanosecond-Resolution Time Support for R
...
Files
  * [ncdfFlow-2.42.0](https://www.bioconductor.org/packages/release/bioc/html/ncdfFlow.html) ncdfFlow: A package that provides HDF5 based storage for flow cytometry data.
  * [ndtv-0.13.2](https://cran.r-project.org/web/packages/ndtv/index.html) Network Dynamic Temporal Visualizations
  * [network-1.17.1](https://cran.r-project.org/web/packages/network/index.html) Classes for Relational Data
  * [networkDynamic-0.11.1](https://cran.r-project.org/web/packages/networkDynamic/index.html) Dynamic Extensions for Network Objects
...
Linear Mixed Models for Areal Data
  ...
  * [nlme-3.1-157](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
  * [nloptr-2.0.0](https://cran.r-project.org/web/packages/nloptr/index.html) R Interface to NLopt
  * [nlsem-0.8](https://cran.r-project.org/web/packages/nlsem/index.html) Fitting Structural Equation Mixture Models
  * [nnet-7.3-17](https://cran.r-project.org/web/packages/nnet/index.html) Feed-Forward Neural Networks and Multinomial Log-Linear Models
...
Methods)
  ...
  * [np-0.60-11](https://cran.r-project.org/web/packages/np/index.html) Nonparametric Kernel Smoothing Methods for Mixed Data Types
  ...
  * [oce-1.7-2](https://cran.r-project.org/web/packages/oce/index.html) Analysis of Oceanographic Data
  ...
  * [oligo-1.60.0](https://www.bioconductor.org/packages/release/bioc/html/oligo.html) Preprocessing tools for oligonucleotide arrays
  * [oligoClasses-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/oligoClasses.html) Classes for high-throughput arrays supported by oligo and crlmm
  * [openCyto-2.8.0](https://www.bioconductor.org/packages/release/bioc/html/openCyto.html) Hierarchical Gating Pipeline for flow cytometry data
  * [openssl-2.0.0](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  * [openxlsx-4.2.5](https://cran.r-project.org/web/packages/openxlsx/index.html) Read, Write and Edit xlsx Files
  ...
  * [optimx-2021-10.12](https://cran.r-project.org/web/packages/optimx/index.html) Expanded Replacement and Extension of the 'optim' Function
  * [optmatch-0.10.0](https://cran.r-project.org/web/packages/optmatch/index.html) Functions for Optimal Matching
  * [optparse-1.7.1](https://cran.r-project.org/web/packages/optparse/index.html) Command Line Option Parser
  * [ordinal-2019.12-10](https://cran.r-project.org/web/packages/ordinal/index.html) Regression Models for Ordinal Data
  * [org.Hs.eg.db-3.15.0](https://www.bioconductor.org/packages/release/bioc/html/org.Hs.eg.db.html) Genome wide annotation for Human
  * [org.Mm.eg.db-3.15.0](https://www.bioconductor.org/packages/release/bioc/html/org.Mm.eg.db.html) Genome wide annotation for Mouse
  ...
  * [orthopolynom-1.0-5](https://cran.r-project.org/web/packages/orthopolynom/index.html) Collection of Functions for Orthogonal and Orthonormal
Polynomials
  * [osqp-0.6.0.5](https://cran.r-project.org/web/packages/osqp/index.html) Quadratic Programming Solver using the 'OSQP' Library
  ...
  * [packrat-0.7.0](https://cran.r-project.org/web/packages/packrat/index.html) A Dependency Management System for Projects and their R Package
Dependencies
  ...
  * [parallelly-1.31.1](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
  * [parsedate-1.3.0](https://cran.r-project.org/web/packages/parsedate/index.html) Recognize and Parse Dates in Various Formats, Including All ISO
8601 Formats
  * [parsnip-0.2.1](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
  * [partools-1.1.6](https://cran.r-project.org/web/packages/partools/index.html) Tools for the 'Parallel' Package
  * [party-1.3-9](https://cran.r-project.org/web/packages/party/index.html) A Laboratory for Recursive Partytioning
  * [partykit-1.2-15](https://cran.r-project.org/web/packages/partykit/index.html) A Toolkit for Recursive Partytioning
  ...
  * [pathview-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/pathview.html) a tool set for pathway based data integration and visualization
...
Methods for Test in Mixed Models
  ...
  * [pcaMethods-1.88.0](https://www.bioconductor.org/packages/release/bioc/html/pcaMethods.html) A collection of PCA methods
  * [pcaPP-1.9-74](https://cran.r-project.org/web/packages/pcaPP/index.html) Robust PCA by Projection Pursuit
  * [pdftools-3.2.0](https://cran.r-project.org/web/packages/pdftools/index.html) Text Extraction, Rendering and Converting of PDF Documents
...
in GLMs and in the Cox Model
  ...
  * [phangorn-2.8.1](https://cran.r-project.org/web/packages/phangorn/index.html) Phylogenetic Reconstruction and Analysis
  ...
  * [phyloseq-1.40.0](https://www.bioconductor.org/packages/release/bioc/html/phyloseq.html) Handling and analysis of high-throughput microbiome census data
  * [phytools-1.0-3](https://cran.r-project.org/web/packages/phytools/index.html) Phylogenetic Tools for Comparative Biology (and Other Things)
  * [pillar-1.7.0](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [pkgload-1.2.4](https://cran.r-project.org/web/packages/pkgload/index.html) Simulate Package Installation and Attach
  ...
  * [plot3Drgl-1.0.2](https://cran.r-project.org/web/packages/plot3Drgl/index.html) Plotting Multi-Dimensional Data - Using 'rgl'
  * [plotly-4.10.0](https://cran.r-project.org/web/packages/plotly/index.html) Create Interactive Web Graphics via 'plotly.js'
  * [plotmo-3.6.1](https://cran.r-project.org/web/packages/plotmo/index.html) Plot a Model's Residuals, Response, and Partial Dependence Plots
  * [plotrix-3.8-2](https://cran.r-project.org/web/packages/plotrix/index.html) Various Plotting Functions
  * [pls-2.8-0](https://cran.r-project.org/web/packages/pls/index.html) Partial Least Squares and Principal Component Regression
  ...
  * [polyester-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/polyester.html) Simulate RNA-seq reads
...
Polynomial Manipulations
  ...
  * [posterior-1.2.1](https://cran.r-project.org/web/packages/posterior/index.html) Tools for Working with Posterior Distributions
...
Abundance and Multilocus Genetic Data
  * [pracma-2.3.8](https://cran.r-project.org/web/packages/pracma/index.html) Practical Numerical Math Functions
  * [praise-1.0.0](https://cran.r-project.org/web/packages/praise/index.html) Praise Users
  * premessa 0.2.6
  * [preprocessCore-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/preprocessCore.html) A collection of pre-processing functions
  ...
  * [processx-3.5.3](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
  ...
  * [progressr-0.10.0](https://cran.r-project.org/web/packages/progressr/index.html) An Inclusive, Unifying API for Progress Updates
  * [projpred-2.1.1](https://cran.r-project.org/web/packages/projpred/index.html) Projection Predictive Feature Selection
  ...
  * [proxy-0.4-26](https://cran.r-project.org/web/packages/proxy/index.html) Distance and Similarity Measures
  * [pryr-0.1.5](https://cran.r-project.org/web/packages/pryr/index.html) Tools for Computing on the Language
  * [ps-1.7.0](https://cran.r-project.org/web/packages/ps/index.html) List, Query, Manipulate System Processes
  ...
  * [psych-2.2.3](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
  * [psychotools-0.7-0](https://cran.r-project.org/web/packages/psychotools/index.html) Psychometric Modeling Infrastructure
  * [pulsar-0.3.7](https://cran.r-project.org/web/packages/pulsar/index.html) Parallel Utilities for Lambda Selection along a Regularization
Path
  * [purrr-0.3.4](https://cran.r-project.org/web/packages/purrr/index.html) Functional Programming Tools
...
Resampling
  * [qdapRegex-0.7.2](https://cran.r-project.org/web/packages/qdapRegex/index.html) Regular Expression Removal, Extraction, and Replacement Tools
...
Graphical Model Estimation
  ...
  * [qtl-1.50](https://cran.r-project.org/web/packages/qtl/index.html) Tools for Analyzing QTL Experiments
  ...
  * [quantreg-5.88](https://cran.r-project.org/web/packages/quantreg/index.html) Quantile Regression
  * [quantsmooth-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/quantsmooth.html) Quantile smoothing and genomic visualization of array data
  * [questionr-0.7.7](https://cran.r-project.org/web/packages/questionr/index.html) Functions to Make Surveys Processing Easier
  * [qvalue-2.28.0](https://cran.r-project.org/web/packages/qvalue/index.html) Q-value estimation for false discovery rate control
  ...
  * [rGADEM-2.44.0](https://www.bioconductor.org/packages/release/bioc/html/rGADEM.html) de novo motif discovery
  * [rJava-1.0-6](https://cran.r-project.org/web/packages/rJava/index.html) Low-Level R to Java Interface
  * [rainbow-3.6](https://cran.r-project.org/web/packages/rainbow/index.html) Bagplots, Boxplots and Rainbow Plots for Functional Data
  * [randomForest-4.7-1](https://cran.r-project.org/web/packages/randomForest/index.html) Breiman and Cutler's Random Forests for Classification and
Regression
  * [randomForestSRC-3.1.0](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
Classification (RF-SRC)
  * [randtoolbox-1.31.1](https://cran.r-project.org/web/packages/randtoolbox/index.html) Toolbox for Pseudo and Quasi Random Number Generation and Random
Generator Tests
...
Range Models
  * [ranger-0.13.1](https://cran.r-project.org/web/packages/ranger/index.html) A Fast Implementation of Random Forests
...
and Logs
  * [raster-3.5-15](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
  ...
  * [rbibutils-2.2.8](https://cran.r-project.org/web/packages/rbibutils/index.html) Read 'Bibtex' Files and Convert Between Bibliography Formats
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [readr-2.1.2](https://cran.r-project.org/web/packages/readr/index.html) Read Rectangular Text Data
  * [readxl-1.4.0](https://cran.r-project.org/web/packages/readxl/index.html) Read Excel Files
  ...
  * [recipes-0.2.0](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing and Feature Engineering Steps for Modeling
...
'Ensembl' and 'UCSC' Genome Browsers
  * [refund-0.1-26](https://cran.r-project.org/web/packages/refund/index.html) Regression with Functional Data
  * [regioneR-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/regioneR.html) Association analysis of genomic regions based on permutation tests
  ...
  * [regsem-1.8.0](https://cran.r-project.org/web/packages/regsem/index.html) Regularized Structural Equation Modeling
...
'GitHub'
  ...
  * [reprex-2.0.1](https://cran.r-project.org/web/packages/reprex/index.html) Prepare Reproducible Example Code via the Clipboard
  ...
  * [restfulr-0.0.13](https://cran.r-project.org/web/packages/restfulr/index.html) R Interface to RESTful Web Services
  * [reticulate-1.24](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  * [rex-1.2.1](https://cran.r-project.org/web/packages/rex/index.html) Friendly Regular Expressions
  * [rgbif-3.7.2](https://cran.r-project.org/web/packages/rgbif/index.html) Interface to the Global Biodiversity Information Facility API
  * [rgdal-1.5-31](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  ...
  * [rgl-0.108.3](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [ridigbio-0.3.5](https://cran.r-project.org/web/packages/ridigbio/index.html) Interface to the iDigBio Data API
  ...
  * [rje-1.10.16](https://cran.r-project.org/web/packages/rje/index.html) Miscellaneous Useful Functions for Statistics
  * [rjson-0.2.21](https://cran.r-project.org/web/packages/rjson/index.html) JSON for R
  * [rlang-1.0.2](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  ...
  * [rmarkdown-2.14](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
  ...
  * [rnetcarto-0.2.4](https://cran.r-project.org/web/packages/rnetcarto/index.html) Fast Network Modularity and Roles Computation by Simulated
Annealing (Rgraph C Library Wrapper for R)
  * [rngWELL-0.10-7](https://cran.r-project.org/web/packages/rngWELL/index.html) Toolbox for WELL Random Number Generators
...
Ordinary Differential Equations
  * [rotl-3.0.12](https://cran.r-project.org/web/packages/rotl/index.html) Interface to the 'Open Tree of Life' API
  * [roxygen2-7.1.2](https://cran.r-project.org/web/packages/roxygen2/index.html) In-Line Documentation for R
  * [rpact-3.2.3](https://cran.r-project.org/web/packages/rpact/index.html) Confirmatory Adaptive Clinical Trial Design and Analysis
  * [rpart-4.1.16](https://cran.r-project.org/web/packages/rpart/index.html) Recursive Partitioning and Regression Trees
  ...
  * [rrcov-1.7-0](https://cran.r-project.org/web/packages/rrcov/index.html) Scalable Robust Estimators with High Breakdown Point
  * [rredlist-0.7.0](https://cran.r-project.org/web/packages/rredlist/index.html) 'IUCN' Red List Client
  * [rsample-0.1.1](https://cran.r-project.org/web/packages/rsample/index.html) General Resampling Infrastructure
  * [rsconnect-0.8.25](https://cran.r-project.org/web/packages/rsconnect/index.html) Deployment Interface for R Markdown Documents and Shiny
Applications
  * [rslurm-0.6.1](https://cran.r-project.org/web/packages/rslurm/index.html) Submit R Calculations to a 'Slurm' Cluster
  * [rsparse-0.5.0](https://cran.r-project.org/web/packages/rsparse/index.html) Statistical Learning on Sparse Matrices
  * [rstan-2.21.5](https://cran.r-project.org/web/packages/rstan/index.html) R Interface to Stan
  ...
  * [rstudioapi-0.13](https://cran.r-project.org/web/packages/rstudioapi/index.html) Safely Access the RStudio API
  * [rsvd-1.0.5](https://cran.r-project.org/web/packages/rsvd/index.html) Randomized Singular Value Decomposition
  * [rtracklayer-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  ...
  * [rversions-2.1.1](https://cran.r-project.org/web/packages/rversions/index.html) Query 'R' Versions, Including 'r-release' and 'r-oldrel'
  ...
  * [rvest-1.0.2](https://cran.r-project.org/web/packages/rvest/index.html) Easily Harvest (Scrape) Web Pages
  * [rvinecopulib-0.6.1.1.3](https://cran.r-project.org/web/packages/rvinecopulib/index.html) High Performance Algorithms for Vine Copula Modeling
  * [rzmq-0.9.8](https://cran.r-project.org/web/packages/rzmq/index.html) R Bindings for 'ZeroMQ'
  * [s2-1.0.7](https://cran.r-project.org/web/packages/s2/index.html) Spherical Geometry Operators Using the S2 Geometry Library
  ...
  * [sass-0.4.1](https://cran.r-project.org/web/packages/sass/index.html) Syntactically Awesome Style Sheets ('Sass')
  * [scales-1.2.0](https://cran.r-project.org/web/packages/scales/index.html) Scale Functions for Visualization
  * [scam-1.2-12](https://cran.r-project.org/web/packages/scam/index.html) Shape Constrained Additive Models
  * [scater-1.24.0](https://www.bioconductor.org/packages/release/bioc/html/scater.html) Single-Cell Analysis Toolkit for Gene Expression Data in R
  ...
  * [scs-3.0-0](https://cran.r-project.org/web/packages/scs/index.html) Splitting Conic Solver
  * [sctransform-0.3.3](https://cran.r-project.org/web/packages/sctransform/index.html) Variance Stabilizing Transformations for Single Cell UMI Data
  * [scuttle-1.6.0](https://www.bioconductor.org/packages/release/bioc/html/scuttle.html) Single-Cell RNA-Seq Analysis Utilities
  * [seewave-2.2.0](https://cran.r-project.org/web/packages/seewave/index.html) Sound Analysis and Synthesis
  * [segmented-1.5-0](https://cran.r-project.org/web/packages/segmented/index.html) Regression Models with Break-Points / Change-Points Estimation
  ...
  * [semTools-0.5-5](https://cran.r-project.org/web/packages/semTools/index.html) Useful Tools for Structural Equation Modeling
  ...
  * [seqLogo-1.62.0](https://www.bioconductor.org/packages/release/bioc/html/seqLogo.html) Sequence logos for DNA sequence alignments
  * [seqinr-4.2-8](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
...
Format and BGEN Format) into R
  ...
  * [servr-0.24](https://cran.r-project.org/web/packages/servr/index.html) A Simple HTTP Server to Serve Static Files or Dynamic Documents
  ...
  * [sf-1.0-7](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
  ...
  * [shiny-1.7.1](https://cran.r-project.org/web/packages/shiny/index.html) Web Application Framework for R
  * [shinyBS-0.61.1](https://cran.r-project.org/web/packages/shinyBS/index.html) Twitter Bootstrap Components for Shiny
  * [shinyFiles-0.9.1](https://cran.r-project.org/web/packages/shinyFiles/index.html) A Server-Side File System Viewer for Shiny
...
Analysis for Bayesian Models
  ...
  * [siggenes-1.70.0](https://www.bioconductor.org/packages/release/bioc/html/siggenes.html) Multiple Testing using SAM and Efron's Empirical Bayes Approaches
...
Files
  ...
  * [slider-0.2.2](https://cran.r-project.org/web/packages/slider/index.html) Sliding Window Functions
  * [sm-2.2-5.7](https://cran.r-project.org/web/packages/sm/index.html) Smoothing Methods for Nonparametric Regression and Density
Estimation
  ...
  * [sn-2.0.2](https://cran.r-project.org/web/packages/sn/index.html) The Skew-Normal and Related Distributions Such as the Skew-t and
the SUN
  * [sna-2.6](https://cran.r-project.org/web/packages/sna/index.html) Tools for Social Network Analysis
  ...
  * [snpStats-1.46.0](https://www.bioconductor.org/packages/release/bioc/html/snpStats.html) SnpMatrix and XSnpMatrix classes and methods
  * [sodium-1.2.0](https://cran.r-project.org/web/packages/sodium/index.html) A Modern and Easy-to-Use Crypto Library
  ...
  * [sp-1.4-7](https://cran.r-project.org/web/packages/sp/index.html) Classes and Methods for Spatial Data
  * [spData-2.0.1](https://cran.r-project.org/web/packages/spData/index.html) Datasets for Spatial Analysis
...
Use in Ecological Models
  * [spaMM-3.11.14](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, with or without Spatial Random Effects
  * [spaa-0.2.2](https://cran.r-project.org/web/packages/spaa/index.html) SPecies Association Analysis
  * [spam-2.8-0](https://cran.r-project.org/web/packages/spam/index.html) SPArse Matrix
  * [sparklyr-1.7.5](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  ...
  * [spatstat.core-2.4-2](https://cran.r-project.org/web/packages/spatstat.core/index.html) Core Functionality of the 'spatstat' Family
  * [spatstat.data-2.2-0](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat' Family
  * [spatstat.geom-2.4-0](https://cran.r-project.org/web/packages/spatstat.geom/index.html) Geometrical Functionality of the 'spatstat' Family
  ...
  * [spatstat.random-2.2-0](https://cran.r-project.org/web/packages/spatstat.random/index.html) Random Generation Functionality for the 'spatstat' Family
  * [spatstat.sparse-2.1-1](https://cran.r-project.org/web/packages/spatstat.sparse/index.html) Sparse Three-Dimensional Arrays and Linear Algebra Utilities
  * [spatstat.utils-2.3-0](https://cran.r-project.org/web/packages/spatstat.utils/index.html) Utility Functions for 'spatstat'
  * splines built in
...
Classification
  ...
  * [ssgraph-1.12](https://cran.r-project.org/web/packages/ssgraph/index.html) Bayesian Graph Structure Learning using Spike-and-Slab Priors
  ...
  * [stars-0.5-5](https://cran.r-project.org/web/packages/stars/index.html) Spatiotemporal Arrays, Raster and Vector Data Cubes
  * [startupmsg-0.9.6](https://cran.r-project.org/web/packages/startupmsg/index.html) Utilities for Start-Up Messages
  * [statmod-1.4.36](https://cran.r-project.org/web/packages/statmod/index.html) Statistical Modeling
  ...
  * [statnet.common-4.5.0](https://cran.r-project.org/web/packages/statnet.common/index.html) Common R Scripts and Utilities Used by the Statnet Project
Software
  * stats built in
  * stats4 built in
  ...
  * [stringdist-0.9.8](https://cran.r-project.org/web/packages/stringdist/index.html) Approximate String Matching, Fuzzy Text Search, and String
Distance Functions
  * [stringi-1.7.6](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
  ...
  * [styler-1.7.0](https://cran.r-project.org/web/packages/styler/index.html) Non-Invasive Pretty Printing of R Code
  ...
  * [survival-3.3-1](https://cran.r-project.org/web/packages/survival/index.html) Survival Analysis
  ...
  * [sva-3.44.0](https://www.bioconductor.org/packages/release/bioc/html/sva.html) Surrogate Variable Analysis
  * [svd-0.5.1](https://cran.r-project.org/web/packages/svd/index.html) Interfaces to Various State-of-Art SVD and Eigensolvers
...
Normal Distribution
  * [sys-3.4](https://cran.r-project.org/web/packages/sys/index.html) Powerful and Reliable Tools for Running System Commands in R
  * [systemPipeR-2.2.1](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
...
without Propensity Score Weights
  * [tables-0.9.6](https://cran.r-project.org/web/packages/tables/index.html) Formula-Driven Table Generation
  ...
  * [tclust-1.4-2](https://cran.r-project.org/web/packages/tclust/index.html) Robust Trimmed Clustering
  ...
  * [tergm-4.0.2](https://cran.r-project.org/web/packages/tergm/index.html) Fit, Simulate and Diagnose Models for Network Evolution Based on
Exponential-Family Random Graph Models
  * [tergmLite-2.5.5](https://cran.r-project.org/web/packages/tergmLite/index.html) Fast Simulation of Simple Temporal Exponential Random Graph
Models
  * [terra-1.5-21](https://cran.r-project.org/web/packages/terra/index.html) Spatial Data Analysis
  * [testit-0.13](https://cran.r-project.org/web/packages/testit/index.html) A Simple Package for Testing R Packages
  * [testthat-3.1.3](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  * [text2vec-0.6.1](https://cran.r-project.org/web/packages/text2vec/index.html) Modern Text Mining Framework for R
  * [threejs-0.3.3](https://cran.r-project.org/web/packages/threejs/index.html) Interactive 3D Scatter Plots, Networks and Globes
  * [tibble-3.1.6](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
  * [tictoc-1.0.1](https://cran.r-project.org/web/packages/tictoc/index.html) Functions for Timing R Scripts, as Well as Implementations of
Stack and List Structures
  * [tidygraph-1.2.1](https://cran.r-project.org/web/packages/tidygraph/index.html) A Tidy API for Graph Manipulation
  * [tidymodels-0.2.0](https://cran.r-project.org/web/packages/tidymodels/index.html) Easily Install and Load the 'Tidymodels' Packages
  * [tidyposterior-0.1.0](https://cran.r-project.org/web/packages/tidyposterior/index.html) Bayesian Analysis to Compare Models using Resampling Statistics
  * [tidypredict-0.4.8](https://cran.r-project.org/web/packages/tidypredict/index.html) Run Predictions Inside the Database
  * [tidyr-1.2.0](https://cran.r-project.org/web/packages/tidyr/index.html) Tidy Messy Data
  * [tidyselect-1.1.2](https://cran.r-project.org/web/packages/tidyselect/index.html) Select from a Set of Strings
  * [tidytext-0.3.2](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
  * [tidytree-0.3.9](https://cran.r-project.org/web/packages/tidytree/index.html) A Tidy Tool for Phylogenetic Tree Data Manipulation
  * [tidyverse-1.3.1](https://cran.r-project.org/web/packages/tidyverse/index.html) Easily Install and Load the 'Tidyverse'
  * [tiff-0.1-11](https://cran.r-project.org/web/packages/tiff/index.html) Read and Write TIFF Images
  * [tilingArray-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/tilingArray.html) Transcript mapping with high-density oligonucleotide tiling arrays
  ...
  * [timereg-2.0.2](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
  * [tinytex-0.38](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain TeX Live, and Compile
LaTeX Documents
  * [tkWidgets-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/tkWidgets.html) R based tk widgets
  * [tkrplot-0.0-26](https://cran.r-project.org/web/packages/tkrplot/index.html) TK Rplot
  * [tm-0.7-8](https://cran.r-project.org/web/packages/tm/index.html) Text Mining Package
  ...
  * [tree-1.0-41](https://cran.r-project.org/web/packages/tree/index.html) Classification and Regression Trees
  * [treeio-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [tseries-0.10-50](https://cran.r-project.org/web/packages/tseries/index.html) Time Series Analysis and Computational Finance
  ...
  * [tune-0.2.0](https://cran.r-project.org/web/packages/tune/index.html) Tidy Tuning Tools
  * [tuneR-1.4.0](https://cran.r-project.org/web/packages/tuneR/index.html) Analysis of Music and Speech
  ...
  * [tweedie-2.3.3](https://cran.r-project.org/web/packages/tweedie/index.html) Evaluation of Tweedie Exponential Family Models
  * [tweenr-1.0.2](https://cran.r-project.org/web/packages/tweenr/index.html) Interpolate Data for Smooth Animations
  ...
  * [unmarked-1.1.1](https://cran.r-project.org/web/packages/unmarked/index.html) Models for Data from Unmarked Animals
  ...
  * [usethis-2.1.5](https://cran.r-project.org/web/packages/usethis/index.html) Automate Package and Project Setup
...
for Dimensionality Reduction
  * [vcd-1.4-9](https://cran.r-project.org/web/packages/vcd/index.html) Visualizing Categorical Data
  * [vcfR-1.12.0](https://cran.r-project.org/web/packages/vcfR/index.html) Manipulate and Visualize VCF Data
  * [vctrs-0.4.1](https://cran.r-project.org/web/packages/vctrs/index.html) Vector Helpers
  * [vegan-2.6-2](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
  * [venn-1.10](https://cran.r-project.org/web/packages/venn/index.html) Draw Venn Diagrams
  * [vimp-2.2.5](https://cran.r-project.org/web/packages/vimp/index.html) Perform Inference on Algorithm-Agnostic Variable Importance
...
Estimates
  ...
  * [viridisLite-0.4.0](https://cran.r-project.org/web/packages/viridisLite/index.html) Colorblind-Friendly Color Maps (Lite Version)
  * [visNetwork-2.1.0](https://cran.r-project.org/web/packages/visNetwork/index.html) Network Visualization using 'vis.js' Library
  * [visdat-0.5.3](https://cran.r-project.org/web/packages/visdat/index.html) Preliminary Visualisation of Data
  * [vroom-1.5.7](https://cran.r-project.org/web/packages/vroom/index.html) Read and Write Rectangular Text Data Quickly
  * [vsn-3.64.0](https://www.bioconductor.org/packages/release/bioc/html/vsn.html) Variance stabilization and calibration for microarray data
  ...
  * [waveslim-1.8.2](https://cran.r-project.org/web/packages/waveslim/index.html) Basic Wavelet Routines for One-, Two-, and Three-Dimensional
Signal Processing
  * [wavethresh-4.6.9](https://cran.r-project.org/web/packages/wavethresh/index.html) Wavelets Statistics and Transforms
  ...
  * [webshot-0.5.3](https://cran.r-project.org/web/packages/webshot/index.html) Take Screenshots of Web Pages
  ...
  * [widgetTools-1.74.0](https://www.bioconductor.org/packages/release/bioc/html/widgetTools.html) Creates an interactive tcltk widget
  ...
  * [wk-0.6.0](https://cran.r-project.org/web/packages/wk/index.html) Lightweight Well-Known Geometry Parsing
  * [wordcloud-2.6](https://cran.r-project.org/web/packages/wordcloud/index.html) Word Clouds
  * [workflows-0.2.6](https://cran.r-project.org/web/packages/workflows/index.html) Modeling Workflows
  * [workflowsets-0.2.1](https://cran.r-project.org/web/packages/workflowsets/index.html) Create a Collection of 'tidymodels' Workflows
  * [worrms-0.4.2](https://cran.r-project.org/web/packages/worrms/index.html) World Register of Marine Species (WoRMS) Client
  * xCell 1.1.0
  * [xfun-0.30](https://cran.r-project.org/web/packages/xfun/index.html) Supporting Functions for Packages Maintained by 'Yihui Xie'
  ...
  * [xts-0.12.1](https://cran.r-project.org/web/packages/xts/index.html) eXtensible Time Series
  ...
  * [yaml-2.3.5](https://cran.r-project.org/web/packages/yaml/index.html) Methods to Convert R Data to YAML and Back
  * [yardstick-0.0.9](https://cran.r-project.org/web/packages/yardstick/index.html) Tidy Characterizations of Model Performance
  * [yulab.utils-0.0.4](https://cran.r-project.org/web/packages/yulab.utils/index.html) Supporting Functions for Packages Maintained by 'YuLab-SMU'
...
Compositional Data Sets
  ...
  * [zoo-1.8-10](https://cran.r-project.org/web/packages/zoo/index.html) S3 Infrastructure for Regular and Irregular Time Series (Z's
