...
### Package List
  ...
  * ASCAT 2.5.2
  * [AUC-0.3.0](https://cran.r-project.org/web/packages/AUC/index.html) Threshold Independent Performance Measures for Probabilistic
Classifiers
...
Model
  ...
  * [GenomicAlignments-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicAlignments.html) Representation and manipulation of short genomic alignments
...
Buttlar
  ...
  * [KEGGgraph-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/KEGGgraph.html) KEGGgraph: A graph approach to KEGG PATHWAY in R and Bioconductor
...
Models
  * [RMTstat-0.3](https://cran.r-project.org/web/packages/RMTstat/index.html) Distributions, Statistics and Tests Derived from Random Matrix
Theory
...
'fmri', 'dwi'
  ...
  * [beanplot-1.2](https://cran.r-project.org/web/packages/beanplot/index.html) Visualization via Beanplots (Like Boxplot/Stripchart/Violin
Plot)
...
in Wang and Louis (2003)
  ...
  * [broom-0.7.10](https://cran.r-project.org/web/packages/broom/index.html) Convert Statistical Objects into Tidy Tibbles
...
Hazards Model
  ...
  * [cpp11-0.4.0](https://cran.r-project.org/web/packages/cpp11/index.html) A C++11 Interface for R's C Interface
  ...
  * [dbscan-1.1-8](https://cran.r-project.org/web/packages/dbscan/index.html) Density-Based Spatial Clustering of Applications with Noise
...
('ODE', 'DAE', 'DDE')
  ...
  * [derfinderHelper-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/derfinderHelper.html) derfinder helper package
...
Package
  * [doBy-4.6.11](https://cran.r-project.org/web/packages/doBy/index.html) Groupwise Statistics, LSmeans, Linear Estimates, Utilities
...
Calls, Assignments and Other R Objects
  ...
  * [future-1.23.0](https://cran.r-project.org/web/packages/future/index.html) Unified Parallel and Distributed Processing in R for Everyone
...
and Shape
  ...
  * [gcrma-2.66.0](https://www.bioconductor.org/packages/release/bioc/html/gcrma.html) Background Adjustment Using Sequence Information
  ...
  * [gdsfmt-1.30.0](https://cran.r-project.org/web/packages/gdsfmt/index.html) 
  ...
  * [geneLenDataBase-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/geneLenDataBase.html) Lengths of mRNA transcripts for a number of genomes
  * [genefilter-1.76.0](https://www.bioconductor.org/packages/release/bioc/html/genefilter.html) genefilter: methods for filtering genes from high-throughput experiments
  * [geneplotter-1.72.0](https://www.bioconductor.org/packages/release/bioc/html/geneplotter.html) Graphics related functions for Bioconductor
  * [generics-0.1.1](https://cran.r-project.org/web/packages/generics/index.html) Common S3 Generics not Provided by Base R Methods Related to
Model Fitting
  * [geometry-0.4.5](https://cran.r-project.org/web/packages/geometry/index.html) Mesh Generation and Surface Tessellation
  * [gert-1.4.1](https://cran.r-project.org/web/packages/gert/index.html) Simple Git Client for R
...
Enhancements
  ...
  * [ggbio-1.42.0](https://www.bioconductor.org/packages/release/bioc/html/ggbio.html) Visualization tools for genomic data
  * [ggcyto-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/ggcyto.html) Visualize Cytometry data with ggplot
  ...
  * [ggfun-0.0.4](https://cran.r-project.org/web/packages/ggfun/index.html) Miscellaneous Functions for 'ggplot2'
  * [ggnetwork-0.5.10](https://cran.r-project.org/web/packages/ggnetwork/index.html) Geometries to Plot Networks with 'ggplot2'
  * [ggnewscale-0.4.5](https://cran.r-project.org/web/packages/ggnewscale/index.html) Multiple Fill and Colour Scales in 'ggplot2'
...
'ggplot2'
  ...
  * [ggtree-3.2.1](https://www.bioconductor.org/packages/release/bioc/html/ggtree.html) an R package for visualization of tree and annotation data
  ...
  * [gld-2.6.2](https://cran.r-project.org/web/packages/gld/index.html) Estimation and Use of the Generalised (Tukey) Lambda
Distribution
  ...
  * [glmmTMB-1.1.2.3](https://cran.r-project.org/web/packages/glmmTMB/index.html) Generalized Linear Mixed Models using Template Model Builder
  * [glmnet-4.1-2](https://cran.r-project.org/web/packages/glmnet/index.html) Lasso and Elastic-Net Regularized Generalized Linear Models
...
Likelihood
  ...
  * [gmp-0.6-2](https://cran.r-project.org/web/packages/gmp/index.html) Multiple Precision Arithmetic
  ...
  * [goseq-1.46.0](https://www.bioconductor.org/packages/release/bioc/html/goseq.html) Gene Ontology analyser for RNA-seq and other length biased data
  ...
  * [graph-1.72.0](https://cran.r-project.org/web/packages/graph/index.html) graph: A package to handle graph data structures
  * graphics built in
  ...
  * [grf-2.0.2](https://cran.r-project.org/web/packages/grf/index.html) Generalized Random Forests
  * grid built in
...
Covariates
  ...
  * [gsl-2.1-7](https://cran.r-project.org/web/packages/gsl/index.html) Wrapper for the Gnu Scientific Library
  ...
  * [gt-0.3.1](https://cran.r-project.org/web/packages/gt/index.html) Easily Create Presentation-Ready Display Tables
  ...
  * [gtsummary-1.5.0](https://cran.r-project.org/web/packages/gtsummary/index.html) Presentation-Ready Data Summary and Analytic Result Tables
  * [h2o-3.34.0.3](https://cran.r-project.org/web/packages/h2o/index.html) R Interface for the 'H2O' Scalable Machine Learning Platform
  * [hal9001-0.4.1](https://cran.r-project.org/web/packages/hal9001/index.html) The Scalable Highly Adaptive Lasso
...
when Linkage Phase is Ambiguous
  * [hardhat-0.1.6](https://cran.r-project.org/web/packages/hardhat/index.html) Construct Modeling Packages
  * [haven-2.4.3](https://cran.r-project.org/web/packages/haven/index.html) Import and Export 'SPSS', 'Stata' and 'SAS' Files
  * [hdf5r-1.3.4](https://cran.r-project.org/web/packages/hdf5r/index.html) Interface to the 'HDF5' Binary Data Format
  ...
  * [hopach-2.54.0](https://cran.r-project.org/web/packages/hopach/index.html) Hierarchical Ordered Partitioning and Collapsing Hybrid (HOPACH)
  * [htmlTable-2.3.0](https://cran.r-project.org/web/packages/htmlTable/index.html) Advanced Tables for Markdown/HTML
  ...
  * [httpuv-1.6.3](https://cran.r-project.org/web/packages/httpuv/index.html) HTTP and WebSocket Server Library
...
High-Dimensional Cytometry
  ...
  * [ie2misc-0.8.6](https://cran.r-project.org/web/packages/ie2misc/index.html) Irucka Embry's Miscellaneous USGS Functions
  * [igraph-1.2.7](https://cran.r-project.org/web/packages/igraph/index.html) Network Analysis and Visualization
  ...
  * [illuminaio-0.36.0](https://www.bioconductor.org/packages/release/bioc/html/illuminaio.html) Parsing Illumina Microarray Output Files
  ...
  * [imager-0.42.10](https://cran.r-project.org/web/packages/imager/index.html) Image Processing Library Based on 'CImg'
  ...
  * [impute-1.68.0](https://cran.r-project.org/web/packages/impute/index.html) impute: Imputation for microarray data
...
Network
  ...
  * [interactiveDisplayBase-1.32.0](https://www.bioconductor.org/packages/release/bioc/html/interactiveDisplayBase.html) Base package for enabling powerful shiny web displays of Bioconductor objects
...
Grids
  * [iterators-1.0.13](https://cran.r-project.org/web/packages/iterators/index.html) Provides Iterator Construct
  ...
  * [jomo-2.7-2](https://cran.r-project.org/web/packages/jomo/index.html) Multilevel Joint Modelling Multiple Imputation
  ...
  * [jsonlite-1.7.2](https://cran.r-project.org/web/packages/jsonlite/index.html) A Simple and Robust JSON Parser and Generator for R
  * [jstable-1.0.7](https://cran.r-project.org/web/packages/jstable/index.html) Create Tables from Different Types of Regression
  * [karyoploteR-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/karyoploteR.html) Plot customizable linear genomes displaying arbitrary data
...
Derivatives
  ...
  * [keyring-1.2.0](https://cran.r-project.org/web/packages/keyring/index.html) Access the System Credential Store from R
  ...
  * [knitr-1.36](https://cran.r-project.org/web/packages/knitr/index.html) A General-Purpose Package for Dynamic Report Generation in R
  ...
  * [ks-1.13.2](https://cran.r-project.org/web/packages/ks/index.html) Kernel Smoothing
  * [kyotil-2021.5-14](https://cran.r-project.org/web/packages/kyotil/index.html) Utility Functions for Statistical Analysis Report Generation and
Monte Carlo Studies
...
Loops
  ...
  * [lavaan-0.6-9](https://cran.r-project.org/web/packages/lavaan/index.html) Latent Variable Analysis
  ...
  * [lhs-1.1.3](https://cran.r-project.org/web/packages/lhs/index.html) Latin Hypercube Samples
  ...
  * [limma-3.50.0](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
...
Communities in Networks
  ...
  * [lme4-1.1-27.1](https://cran.r-project.org/web/packages/lme4/index.html) Linear Mixed-Effects Models using 'Eigen' and S4
  ...
  * [lmtest-0.9-38](https://cran.r-project.org/web/packages/lmtest/index.html) Testing Linear Regression Models
  ...
  * [logistf-1.24](https://cran.r-project.org/web/packages/logistf/index.html) Firth's Bias-Reduced Logistic Regression
...
Related Functionality
  * [loo-2.4.1](https://cran.r-project.org/web/packages/loo/index.html) Efficient Leave-One-Out Cross-Validation and WAIC for Bayesian
Models
  ...
  * [lpsymphony-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/lpsymphony.html) Symphony integer linear programming solver in R
...
Likelihood or Least Squares
  ...
  * [lumi-2.46.0](https://www.bioconductor.org/packages/release/bioc/html/lumi.html) BeadArray Specific Methods for Illumina Methylation and Expression Microarrays
  ...
  * [maSigPro-1.66.0](https://www.bioconductor.org/packages/release/bioc/html/maSigPro.html) Significant Gene Expression Profile Differences in Time Course Gene Expression Data
  ...
  * [magrittr-2.0.1](https://cran.r-project.org/web/packages/magrittr/index.html) A Forward-Pipe Operator for R
  ...
  * [maptools-1.1-2](https://cran.r-project.org/web/packages/maptools/index.html) Tools for Handling Spatial Objects
  * [markdown-1.1](https://cran.r-project.org/web/packages/markdown/index.html) Render Markdown with the C Library 'Sundown'
  * [marray-1.72.0](https://www.bioconductor.org/packages/release/bioc/html/marray.html) Exploratory analysis for two-color spotted microarray data
  * [mathjaxr-1.4-0](https://cran.r-project.org/web/packages/mathjaxr/index.html) Using 'Mathjax' in Rd Files
  * [matrixStats-0.61.0](https://cran.r-project.org/web/packages/matrixStats/index.html) Functions that Apply to Rows and Columns of Matrices (and to
Vectors)
...
Occurrence Using Presence-Only Data
  ...
  * [mboost-2.9-5](https://cran.r-project.org/web/packages/mboost/index.html) Model-Based Boosting
  * [mclust-5.4.7](https://cran.r-project.org/web/packages/mclust/index.html) Gaussian Mixture Modelling for Model-Based Clustering,
Classification, and Density Estimation
  ...
  * [memoise-2.0.0](https://cran.r-project.org/web/packages/memoise/index.html) 'Memoisation' of Functions
  * [memuse-4.2-1](https://cran.r-project.org/web/packages/memuse/index.html) Memory Estimation Utilities
  * [metafor-3.0-2](https://cran.r-project.org/web/packages/metafor/index.html) Meta-Analysis Package for R
  * [metagenomeSeq-1.36.0](https://www.bioconductor.org/packages/release/bioc/html/metagenomeSeq.html) Statistical analysis for sparse high-throughput sequencing
  * methods built in
  * [methylKit-1.20.0](https://www.bioconductor.org/packages/release/bioc/html/methylKit.html) DNA methylation analysis from high-throughput bisulfite sequencing results
  * [methylumi-2.40.1](https://www.bioconductor.org/packages/release/bioc/html/methylumi.html) Handle Illumina methylation data
  * [mets-1.2.9](https://cran.r-project.org/web/packages/mets/index.html) Analysis of Multivariate Event Times
  * [mgcv-1.8-38](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
  ...
  * [mice-3.13.0](https://cran.r-project.org/web/packages/mice/index.html) Multivariate Imputation by Chained Equations
  * [miceadds-3.11-6](https://cran.r-project.org/web/packages/miceadds/index.html) Some Additional Multiple Imputation Functions, Especially for
'mice'
...
Analysis
  * [minfi-1.40.0](https://www.bioconductor.org/packages/release/bioc/html/minfi.html) Analyze Illumina Infinium DNA methylation arrays
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [mixOmics-6.18.1](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
...
Estimation of Mixture Proportions
  ...
  * [mlegp-3.1.8](https://cran.r-project.org/web/packages/mlegp/index.html) Maximum Likelihood Estimates of Gaussian Processes
...
Versions
  ...
  * [motifmatchr-1.16.0](https://www.bioconductor.org/packages/release/bioc/html/motifmatchr.html) Fast Motif Matching in R
  * [mpath-0.4-2.19](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
  * [msa-1.26.0](https://www.bioconductor.org/packages/release/bioc/html/msa.html) Multiple Sequence Alignment
  * [msigdbr-7.4.1](https://cran.r-project.org/web/packages/msigdbr/index.html) MSigDB Gene Sets for Multiple Organisms in a Tidy Data Format
  ...
  * [multcomp-1.4-17](https://cran.r-project.org/web/packages/multcomp/index.html) Simultaneous Inference in General Parametric Models
  ...
  * [multtest-2.50.0](https://cran.r-project.org/web/packages/multtest/index.html) Resampling-based multiple hypothesis testing
  * [munsell-0.5.0](https://cran.r-project.org/web/packages/munsell/index.html) Utilities for Using Munsell Colours
  * [mvabund-4.1.12](https://cran.r-project.org/web/packages/mvabund/index.html) Statistical Methods for Analysing Multivariate Abundance Data
...
Dimensions
  ...
  * [nanotime-0.3.4](https://cran.r-project.org/web/packages/nanotime/index.html) Nanosecond-Resolution Time Support for R
...
Files
  * [ncdfFlow-2.40.0](https://www.bioconductor.org/packages/release/bioc/html/ncdfFlow.html) ncdfFlow: A package that provides HDF5 based storage for flow cytometry data.
  ...
  * [networkDynamic-0.11.0](https://cran.r-project.org/web/packages/networkDynamic/index.html) Dynamic Extensions for Network Objects
...
Linear Mixed Models for Areal Data
  ...
  * [nlme-3.1-153](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
...
Methods)
  * [norm-1.0-9.5](https://cran.r-project.org/web/packages/norm/index.html) Analysis of Multivariate Normal Datasets with Missing Values
  ...
  * [oce-1.4-0](https://cran.r-project.org/web/packages/oce/index.html) Analysis of Oceanographic Data
  * [odbc-1.3.2](https://cran.r-project.org/web/packages/odbc/index.html) Connect to ODBC Compatible Databases (using the DBI Interface)
  * [oddsratio-2.0.1](https://cran.r-project.org/web/packages/oddsratio/index.html) Odds Ratio Calculation for GAM(M)s & GLM(M)s
  * [oligo-1.58.0](https://www.bioconductor.org/packages/release/bioc/html/oligo.html) Preprocessing tools for oligonucleotide arrays
  * [oligoClasses-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/oligoClasses.html) Classes for high-throughput arrays supported by oligo and crlmm
  * [openCyto-2.6.0](https://www.bioconductor.org/packages/release/bioc/html/openCyto.html) Hierarchical Gating Pipeline for flow cytometry data
  * [openssl-1.4.5](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  * [openxlsx-4.2.4](https://cran.r-project.org/web/packages/openxlsx/index.html) Read, Write and Edit xlsx Files
  ...
  * [optmatch-0.9-15](https://cran.r-project.org/web/packages/optmatch/index.html) Functions for Optimal Matching
  ...
  * [org.Hs.eg.db-3.14.0](https://www.bioconductor.org/packages/release/bioc/html/org.Hs.eg.db.html) Genome wide annotation for Human
...
Dependencies
  ...
  * [parallelly-1.28.1](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
  * [parsedate-1.2.1](https://cran.r-project.org/web/packages/parsedate/index.html) Recognize and Parse Dates in Various Formats, Including All ISO
8601 Formats
  * [parsnip-0.1.7](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
...
Methods for Test in Mixed Models
  ...
  * [pcaMethods-1.86.0](https://www.bioconductor.org/packages/release/bioc/html/pcaMethods.html) A collection of PCA methods
  * [pcaPP-1.9-74](https://cran.r-project.org/web/packages/pcaPP/index.html) Robust PCA by Projection Pursuit
  * [pdftools-3.0.1](https://cran.r-project.org/web/packages/pdftools/index.html) Text Extraction, Rendering and Converting of PDF Documents
...
in GLMs and in the Cox Model
  * [peperr-1.3](https://cran.r-project.org/web/packages/peperr/index.html) Parallelised Estimation of Prediction Error
  ...
  * [phangorn-2.7.1](https://cran.r-project.org/web/packages/phangorn/index.html) Phylogenetic Reconstruction and Analysis
  ...
  * [phyloseq-1.38.0](https://www.bioconductor.org/packages/release/bioc/html/phyloseq.html) Handling and analysis of high-throughput microbiome census data
  * [phytools-0.7-90](https://cran.r-project.org/web/packages/phytools/index.html) Phylogenetic Tools for Comparative Biology (and Other Things)
  * [pillar-1.6.4](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [pkgbuild-1.2.0](https://cran.r-project.org/web/packages/pkgbuild/index.html) Find Tools Needed to Build R Packages
  * [pkgconfig-2.0.3](https://cran.r-project.org/web/packages/pkgconfig/index.html) Private Configuration for 'R' Packages
  * [pkgload-1.2.3](https://cran.r-project.org/web/packages/pkgload/index.html) Simulate Package Installation and Attach
  ...
  * [poLCA-1.4.1](https://cran.r-project.org/web/packages/poLCA/index.html) Polytomous Variable Latent Class Analysis
  ...
  * [polycor-0.7-10](https://cran.r-project.org/web/packages/polycor/index.html) Polychoric and Polyserial Correlations
  * [polyester-1.30.0](https://www.bioconductor.org/packages/release/bioc/html/polyester.html) Simulate RNA-seq reads
...
Polynomial Manipulations
  * [posterior-1.1.0](https://cran.r-project.org/web/packages/posterior/index.html) Tools for Working with Posterior Distributions
...
Abundance and Multilocus Genetic Data
  * [pracma-2.3.3](https://cran.r-project.org/web/packages/pracma/index.html) Practical Numerical Math Functions
  * [praise-1.0.0](https://cran.r-project.org/web/packages/praise/index.html) Praise Users
  * premessa 0.2.6
  * [preprocessCore-1.56.0](https://www.bioconductor.org/packages/release/bioc/html/preprocessCore.html) A collection of pre-processing functions
  ...
  * [processx-3.5.2](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
  ...
  * [progressr-0.9.0](https://cran.r-project.org/web/packages/progressr/index.html) An Inclusive, Unifying API for Progress Updates
  * [projpred-2.0.2](https://cran.r-project.org/web/packages/projpred/index.html) Projection Predictive Feature Selection
  ...
  * [ps-1.6.0](https://cran.r-project.org/web/packages/ps/index.html) List, Query, Manipulate System Processes
  ...
  * [psych-2.1.9](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
...
Resampling
  ...
  * [qgam-1.3.3](https://cran.r-project.org/web/packages/qgam/index.html) Smooth Additive Quantile Regression Models
  * [qgraph-1.9](https://cran.r-project.org/web/packages/qgraph/index.html) Graph Plotting Methods, Psychometric Data Visualization and
Graphical Model Estimation
  ...
  * [quantreg-5.86](https://cran.r-project.org/web/packages/quantreg/index.html) Quantile Regression
  * [quantsmooth-1.60.0](https://www.bioconductor.org/packages/release/bioc/html/quantsmooth.html) Quantile smoothing and genomic visualization of array data
  * [questionr-0.7.5](https://cran.r-project.org/web/packages/questionr/index.html) Functions to Make Surveys Processing Easier
  * [qvalue-2.26.0](https://cran.r-project.org/web/packages/qvalue/index.html) Q-value estimation for false discovery rate control
  ...
  * [r2d3-0.2.5](https://cran.r-project.org/web/packages/r2d3/index.html) Interface to 'D3' Visualizations
  ...
  * [rGADEM-2.42.0](https://www.bioconductor.org/packages/release/bioc/html/rGADEM.html) de novo motif discovery
  * [rJava-1.0-5](https://cran.r-project.org/web/packages/rJava/index.html) Low-Level R to Java Interface
...
Regression
  * [randomForestSRC-2.13.0](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
...
and Logs
  * [raster-3.5-2](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
  * [rasterVis-0.51.0](https://cran.r-project.org/web/packages/rasterVis/index.html) Visualization Methods for Raster Data
  ...
  * [rbibutils-2.2.4](https://cran.r-project.org/web/packages/rbibutils/index.html) Read 'Bibtex' Files and Convert Between Bibliography Formats
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [readr-2.0.2](https://cran.r-project.org/web/packages/readr/index.html) Read Rectangular Text Data
  ...
  * [recipes-0.1.17](https://cran.r-project.org/web/packages/recipes/index.html) Preprocessing and Feature Engineering Steps for Modeling
...
'Ensembl' and 'UCSC' Genome Browsers
  ...
  * [regioneR-1.26.0](https://www.bioconductor.org/packages/release/bioc/html/regioneR.html) Association analysis of genomic regions based on permutation tests
  ...
  * [relations-0.6-10](https://cran.r-project.org/web/packages/relations/index.html) Data Structures and Algorithms for Relations
  ...
  * [remotes-2.4.1](https://cran.r-project.org/web/packages/remotes/index.html) R Package Installation from Remote Repositories, Including
'GitHub'
  * [rentrez-1.2.3](https://cran.r-project.org/web/packages/rentrez/index.html) 'Entrez' in R
  * [repr-1.1.3](https://cran.r-project.org/web/packages/repr/index.html) Serializable Representations
  ...
  * [reticulate-1.22](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  * [rex-1.2.0](https://cran.r-project.org/web/packages/rex/index.html) Friendly Regular Expressions
  * [rgbif-3.6.0](https://cran.r-project.org/web/packages/rgbif/index.html) Interface to the Global Biodiversity Information Facility API
  * [rgdal-1.5-27](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  ...
  * [rgeos-0.5-8](https://cran.r-project.org/web/packages/rgeos/index.html) Interface to Geometry Engine - Open Source ('GEOS')
  * [rgexf-0.16.2](https://cran.r-project.org/web/packages/rgexf/index.html) Build, Import and Export GEXF Graph Files
  * [rgl-0.107.14](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [rhdf5-2.38.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5.html) R Interface to HDF5
  * [rhdf5filters-1.6.0](https://www.bioconductor.org/packages/release/bioc/html/rhdf5filters.html) HDF5 Compression Filters
  * [ridigbio-0.3.5](https://cran.r-project.org/web/packages/ridigbio/index.html) Interface to the iDigBio Data API
  * [rio-0.5.27](https://cran.r-project.org/web/packages/rio/index.html) A Swiss-Army Knife for Data I/O
  * [ritis-1.0.0](https://cran.r-project.org/web/packages/ritis/index.html) Integrated Taxonomic Information System Client
  * [rjags-4-12](https://cran.r-project.org/web/packages/rjags/index.html) Bayesian Graphical Models using MCMC
  * [rjson-0.2.20](https://cran.r-project.org/web/packages/rjson/index.html) JSON for R
  * [rlang-0.4.12](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  ...
  * [rmarkdown-2.11](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Annealing (Rgraph C Library Wrapper for R)
  ...
  * [robustbase-0.93-9](https://cran.r-project.org/web/packages/robustbase/index.html) Basic Robust Statistics
...
Ordinary Differential Equations
  * [rotl-3.0.11](https://cran.r-project.org/web/packages/rotl/index.html) Interface to the 'Open Tree of Life' API
  ...
  * [rprojroot-2.0.2](https://cran.r-project.org/web/packages/rprojroot/index.html) Finding Files in Project Subdirectories
  * [rrcov-1.6-0](https://cran.r-project.org/web/packages/rrcov/index.html) Scalable Robust Estimators with High Breakdown Point
  ...
  * [rsconnect-0.8.24](https://cran.r-project.org/web/packages/rsconnect/index.html) Deployment Interface for R Markdown Documents and Shiny
Applications
  * [rslurm-0.6.1](https://cran.r-project.org/web/packages/rslurm/index.html) Submit R Calculations to a 'Slurm' Cluster
  * [rstan-2.21.2](https://cran.r-project.org/web/packages/rstan/index.html) R Interface to Stan
  * [rstanarm-2.21.1](https://cran.r-project.org/web/packages/rstanarm/index.html) Bayesian Applied Regression Modeling via Stan
  * [rstantools-2.1.1](https://cran.r-project.org/web/packages/rstantools/index.html) Tools for Developing R Packages Interfacing with 'Stan'
  ...
  * [rtracklayer-1.54.0](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  ...
  * [scater-1.22.0](https://www.bioconductor.org/packages/release/bioc/html/scater.html) Single-Cell Analysis Toolkit for Gene Expression Data in R
  ...
  * [scuttle-1.4.0](https://www.bioconductor.org/packages/release/bioc/html/scuttle.html) Single-Cell RNA-Seq Analysis Utilities
  ...
  * [sem-3.1-13](https://cran.r-project.org/web/packages/sem/index.html) Structural Equation Models
  ...
  * [seqLogo-1.60.0](https://www.bioconductor.org/packages/release/bioc/html/seqLogo.html) Sequence logos for DNA sequence alignments
  * [seqinr-4.2-8](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
  * [seqminer-8.2](https://cran.r-project.org/web/packages/seqminer/index.html) Efficiently Read Sequence Data (VCF Format, BCF Format, METAL
Format and BGEN Format) into R
  ...
  * [servr-0.23](https://cran.r-project.org/web/packages/servr/index.html) A Simple HTTP Server to Serve Static Files or Dynamic Documents
  * [sessioninfo-1.2.0](https://cran.r-project.org/web/packages/sessioninfo/index.html) R Session Information
  * [setRNG-2013.9-1](https://cran.r-project.org/web/packages/setRNG/index.html) Set (Normal) Random Number Generator and Seed
  * [sets-1.0-19](https://cran.r-project.org/web/packages/sets/index.html) Sets, Generalized Sets, Customizable Sets and Intervals
  * [sf-1.0-3](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
  * [sfsmisc-1.1-12](https://cran.r-project.org/web/packages/sfsmisc/index.html) Utilities from 'Seminar fuer Statistik' ETH Zurich
  * [shadowtext-0.0.9](https://cran.r-project.org/web/packages/shadowtext/index.html) Shadow Text Grob and Layer
...
Recalculating
  ...
  * [shinyjs-2.0.0](https://cran.r-project.org/web/packages/shinyjs/index.html) Easily Improve the User Experience of Your Shiny Apps in Seconds
...
Analysis for Bayesian Models
  ...
  * [siggenes-1.68.0](https://www.bioconductor.org/packages/release/bioc/html/siggenes.html) Multiple Testing using SAM and Efron's Empirical Bayes Approaches
...
Files
  * [slam-0.1-48](https://cran.r-project.org/web/packages/slam/index.html) Sparse Lightweight Arrays and Matrices
...
Estimation
  ...
  * [sn-2.0.0](https://cran.r-project.org/web/packages/sn/index.html) The Skew-Normal and Related Distributions Such as the Skew-t and
the SUN
  ...
  * [snpStats-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/snpStats.html) SnpMatrix and XSnpMatrix classes and methods
  ...
  * [sp-1.4-5](https://cran.r-project.org/web/packages/sp/index.html) Classes and Methods for Spatial Data
...
Use in Ecological Models
  * [spaMM-3.9.13](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, with or without Spatial Random Effects
  * [spaa-0.2.2](https://cran.r-project.org/web/packages/spaa/index.html) SPecies Association Analysis
  * [spam-2.7-0](https://cran.r-project.org/web/packages/spam/index.html) SPArse Matrix
  * [sparklyr-1.7.2](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [sparseMatrixStats-1.6.0](https://www.bioconductor.org/packages/release/bioc/html/sparseMatrixStats.html) Summary Statistics for Rows and Columns of Sparse Matrices
  * [spatial-7.3-14](https://cran.r-project.org/web/packages/spatial/index.html) Functions for Kriging and Point Pattern Analysis
  * [spatstat-2.2-0](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  * [spatstat.core-2.3-0](https://cran.r-project.org/web/packages/spatstat.core/index.html) Core Functionality of the 'spatstat' Family
  * [spatstat.data-2.1-0](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat' Family
  * [spatstat.geom-2.3-0](https://cran.r-project.org/web/packages/spatstat.geom/index.html) Geometrical Functionality of the 'spatstat' Family
  * [spatstat.linnet-2.3-0](https://cran.r-project.org/web/packages/spatstat.linnet/index.html) Linear Networks Functionality of the 'spatstat' Family
  * [spatstat.sparse-2.0-0](https://cran.r-project.org/web/packages/spatstat.sparse/index.html) Sparse Three-Dimensional Arrays and Linear Algebra Utilities
  * [spatstat.utils-2.2-0](https://cran.r-project.org/web/packages/spatstat.utils/index.html) Utility Functions for 'spatstat'
  * splines built in
...
Classification
  ...
  * [stargazer-5.2.2](https://cran.r-project.org/web/packages/stargazer/index.html) Well-Formatted Regression and Summary Statistics Tables
...
Distance Functions
  * [stringi-1.7.5](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
  ...
  * [styler-1.6.2](https://cran.r-project.org/web/packages/styler/index.html) Non-Invasive Pretty Printing of R Code
  ...
  * [survival-3.2-13](https://cran.r-project.org/web/packages/survival/index.html) Survival Analysis
  ...
  * [sva-3.42.0](https://www.bioconductor.org/packages/release/bioc/html/sva.html) Surrogate Variable Analysis
...
Normal Distribution
  ...
  * [systemPipeR-2.0.1](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
  * [systemfonts-1.0.3](https://cran.r-project.org/web/packages/systemfonts/index.html) System Native Font Finding
  * [tableone-0.13.0](https://cran.r-project.org/web/packages/tableone/index.html) Create 'Table 1' to Describe Baseline Characteristics with or
without Propensity Score Weights
  ...
  * [taxize-0.9.99](https://cran.r-project.org/web/packages/taxize/index.html) Taxonomic Information from Around the Web
  * tcltk built in
...
Models
  * [terra-1.4-11](https://cran.r-project.org/web/packages/terra/index.html) Spatial Data Analysis
  * [testit-0.13](https://cran.r-project.org/web/packages/testit/index.html) A Simple Package for Testing R Packages
  * [testthat-3.1.0](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  * [threejs-0.3.3](https://cran.r-project.org/web/packages/threejs/index.html) Interactive 3D Scatter Plots, Networks and Globes
  * [tibble-3.1.5](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
...
Stack and List Structures
  ...
  * [tidymodels-0.1.4](https://cran.r-project.org/web/packages/tidymodels/index.html) Easily Install and Load the 'Tidymodels' Packages
  ...
  * [tidyr-1.1.4](https://cran.r-project.org/web/packages/tidyr/index.html) Tidy Messy Data
  * [tidyselect-1.1.1](https://cran.r-project.org/web/packages/tidyselect/index.html) Select from a Set of Strings
  ...
  * [tidytree-0.3.6](https://cran.r-project.org/web/packages/tidytree/index.html) A Tidy Tool for Phylogenetic Tree Data Manipulation
  * [tidyverse-1.3.1](https://cran.r-project.org/web/packages/tidyverse/index.html) Easily Install and Load the 'Tidyverse'
  * [tiff-0.1-8](https://cran.r-project.org/web/packages/tiff/index.html) Read and Write TIFF Images
  * [tilingArray-1.72.0](https://www.bioconductor.org/packages/release/bioc/html/tilingArray.html) Transcript mapping with high-density oligonucleotide tiling arrays
  ...
  * [timereg-2.0.1](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
  * [tinytex-0.34](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain TeX Live, and Compile
LaTeX Documents
  * [tkWidgets-1.72.0](https://www.bioconductor.org/packages/release/bioc/html/tkWidgets.html) R based tk widgets
  ...
  * [treeio-1.18.1](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [tseries-0.10-48](https://cran.r-project.org/web/packages/tseries/index.html) Time Series Analysis and Computational Finance
  * [tseriesChaos-0.1-13.1](https://cran.r-project.org/web/packages/tseriesChaos/index.html) Analysis of Nonlinear Time Series
  * [tsna-0.3.4](https://cran.r-project.org/web/packages/tsna/index.html) Tools for Temporal Social Network Analysis
  * [tsne-0.1-3](https://cran.r-project.org/web/packages/tsne/index.html) T-Distributed Stochastic Neighbor Embedding for R (t-SNE)
  * [tune-0.1.6](https://cran.r-project.org/web/packages/tune/index.html) Tidy Tuning Tools
  * [tuneR-1.3.3.1](https://cran.r-project.org/web/packages/tuneR/index.html) Analysis of Music and Speech
  ...
  * [tzdb-0.2.0](https://cran.r-project.org/web/packages/tzdb/index.html) Time Zone Database Information
  ...
  * [udunits2-0.13.1](https://cran.r-project.org/web/packages/udunits2/index.html) Udunits-2 Bindings for R
  ...
  * [units-0.7-2](https://cran.r-project.org/web/packages/units/index.html) Measurement Units for R Vectors
  ...
  * [usethis-2.1.3](https://cran.r-project.org/web/packages/usethis/index.html) Automate Package and Project Setup
  * [utf8-1.2.2](https://cran.r-project.org/web/packages/utf8/index.html) Unicode Text Processing
  * utils built in
  * [uuid-1.0-2](https://cran.r-project.org/web/packages/uuid/index.html) Tools for Generating and Handling of UUIDs
  * [uwot-0.1.10](https://cran.r-project.org/web/packages/uwot/index.html) The Uniform Manifold Approximation and Projection (UMAP) Method
for Dimensionality Reduction
  ...
  * [vctrs-0.3.8](https://cran.r-project.org/web/packages/vctrs/index.html) Vector Helpers
  * [vegan-2.5-7](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
...
Estimates
  ...
  * [vroom-1.5.5](https://cran.r-project.org/web/packages/vroom/index.html) Read and Write Rectangular Text Data Quickly
  * [vsn-3.62.0](https://www.bioconductor.org/packages/release/bioc/html/vsn.html) Variance stabilization and calibration for microarray data
  * [waldo-0.3.1](https://cran.r-project.org/web/packages/waldo/index.html) Find Differences Between R Objects
...
Signal Processing
  ...
  * [widgetTools-1.72.0](https://www.bioconductor.org/packages/release/bioc/html/widgetTools.html) Creates an interactive tcltk widget
  * [wikitaxa-0.4.0](https://cran.r-project.org/web/packages/wikitaxa/index.html) Taxonomic Information from 'Wikipedia'
  * [withr-2.4.2](https://cran.r-project.org/web/packages/withr/index.html) Run Code 'With' Temporarily Modified Global State
  * [wk-0.5.0](https://cran.r-project.org/web/packages/wk/index.html) Lightweight Well-Known Geometry Parsing
  * [wordcloud-2.6](https://cran.r-project.org/web/packages/wordcloud/index.html) Word Clouds
  * [workflows-0.2.4](https://cran.r-project.org/web/packages/workflows/index.html) Modeling Workflows
  * [workflowsets-0.1.0](https://cran.r-project.org/web/packages/workflowsets/index.html) Create a Collection of 'tidymodels' Workflows
  * [worrms-0.4.2](https://cran.r-project.org/web/packages/worrms/index.html) World Register of Marine Species (WoRMS) Client
  * xCell 1.1.0
  * [xfun-0.27](https://cran.r-project.org/web/packages/xfun/index.html) Supporting Functions for Packages Maintained by 'Yihui Xie'
  * [xgboost-1.4.1.1](https://cran.r-project.org/web/packages/xgboost/index.html) Extreme Gradient Boosting
