...
### Package List
  ...
  * [BDgraph-2.55](https://cran.r-project.org/web/packages/BDgraph/index.html) Bayesian Structure Learning in Graphical Models using
Birth-Death MCMC
...
Optimization
  * [Matrix-1.2-16](https://cran.r-project.org/web/packages/Matrix/index.html) Sparse and Dense Matrix Classes and Methods
...
(SNNS)
  ...
  * [RcppArmadillo-0.9.200.7.1](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
...
Packages
  ...
  * [Rhdf5lib-1.4.2](https://www.bioconductor.org/packages/release/bioc/html/Rhdf5lib.html) hdf5 library as an R package
...
Implementation
  ...
  * [SDMTools-1.1-221](https://cran.r-project.org/web/packages/SDMTools/index.html) Species Distribution Modelling Tools: Tools for processing data
...
(CGDS)
  ...
  * [clipr-0.5.0](https://cran.r-project.org/web/packages/clipr/index.html) Read and Write from the System Clipboard
...
al.
  ...
  * [clustree-0.3.0](https://cran.r-project.org/web/packages/clustree/index.html) Visualise Clusterings at Different Resolutions
  ...
  * [colorspace-1.4-0](https://cran.r-project.org/web/packages/colorspace/index.html) A Toolbox for Manipulating and Assessing Colors and Palettes
...
Plots
  ...
  * [crul-0.7.0](https://cran.r-project.org/web/packages/crul/index.html) HTTP Client
  ...
  * [data.table-1.12.0](https://cran.r-project.org/web/packages/data.table/index.html) Extension of `data.frame`
  * datasets built in
  * [dbplyr-1.3.0](https://cran.r-project.org/web/packages/dbplyr/index.html) A 'dplyr' Back End for Databases
  * [ddalpha-1.3.8](https://cran.r-project.org/web/packages/ddalpha/index.html) Depth-Based Classification and Calculation of Data Depth
...
Dendrograms
  * [e1071-1.7-0.1](https://cran.r-project.org/web/packages/e1071/index.html) Misc Functions of the Department of Statistics, Probability
...
Regions
  ...
  * [emulator-1.2-19](https://cran.r-project.org/web/packages/emulator/index.html) Bayesian Emulation of Computer Programs
...
Default
  ...
  * [feather-0.3.2](https://cran.r-project.org/web/packages/feather/index.html) R Bindings to the Feather 'API'
...
Makridakis, Wheelwright & Hyndman (1998)
  ...
  * [forecast-8.5](https://cran.r-project.org/web/packages/forecast/index.html) Forecasting Functions for Time Series and Linear Models
...
Model Fitting
  ...
  * [geometry-0.4.0](https://cran.r-project.org/web/packages/geometry/index.html) Mesh Generation and Surface Tessellation
...
Enhancements
  ...
  * [ggforce-0.2.0](https://cran.r-project.org/web/packages/ggforce/index.html) Accelerating 'ggplot2'
...
'ggplot2'
  ...
  * [git2r-0.24.0](https://cran.r-project.org/web/packages/git2r/index.html) Provides Access to Git Repositories
  ...
  * [gllvm-1.1.2](https://cran.r-project.org/web/packages/gllvm/index.html) Generalized Linear Latent Variable Models
...
when Linkage Phase is Ambiguous
  ...
  * [huge-1.3.0](https://cran.r-project.org/web/packages/huge/index.html) High-Dimensional Undirected Graph Estimation
  ...
  * [igraph-1.2.4](https://cran.r-project.org/web/packages/igraph/index.html) Network Analysis and Visualization
...
Monte Carlo Studies
  ...
  * [labelled-2.1.0](https://cran.r-project.org/web/packages/labelled/index.html) Manipulating Labelled Data
...
Classification, and Density Estimation
  ...
  * [mgcv-1.8-27](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [mpath-0.3-7](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
...
Files
  ...
  * [network-1.14-377](https://cran.r-project.org/web/packages/network/index.html) Classes for Relational Data
...
Data and Resting State Data
  ...
  * [nor1mix-1.2-3](https://cran.r-project.org/web/packages/nor1mix/index.html) Normal aka Gaussian (1-d) Mixture Models (S3 Classes and
Methods)
  ...
  * [openssl-1.2.2](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
  ...
  * [optparse-1.6.1](https://cran.r-project.org/web/packages/optparse/index.html) Command Line Option Parser
  * [ordinal-2019.3-9](https://cran.r-project.org/web/packages/ordinal/index.html) Regression Models for Ordinal Data
...
Dependencies
  ...
  * [partykit-1.2-3](https://cran.r-project.org/web/packages/partykit/index.html) A Toolkit for Recursive Partytioning
...
17 Samples of 'P. Infestans" and 1 'P. Mirabilis'
  ...
  * [plotrix-3.7-4](https://cran.r-project.org/web/packages/plotrix/index.html) Various Plotting Functions
  ...
  * [polspline-1.1.14](https://cran.r-project.org/web/packages/polspline/index.html) Polynomial Spline Routines
...
Polynomial Manipulations
  * [prabclus-2.2-7](https://cran.r-project.org/web/packages/prabclus/index.html) Functions for Clustering and Testing of Presence-Absence,
Abundance and Multilocus Genetic Data
  ...
  * [processx-3.3.0](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
...
Path
  * [purrr-0.3.1](https://cran.r-project.org/web/packages/purrr/index.html) Functional Programming Tools
...
Resampling
  * [qgraph-1.6.1](https://cran.r-project.org/web/packages/qgraph/index.html) Graph Plotting Methods, Psychometric Data Visualization and
...
Regression
  * [randomForestSRC-2.8.0](https://cran.r-project.org/web/packages/randomForestSRC/index.html) Fast Unified Random Forests for Survival, Regression, and
...
and Logs
  * [raster-2.8-19](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
...
(BMP,JPEG,PNG,TIFF)
  ...
  * [readxl-1.3.0](https://cran.r-project.org/web/packages/readxl/index.html) Read Excel Files
...
'GitHub'
  ...
  * [reticulate-1.11.1](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  * [rex-1.1.2](https://cran.r-project.org/web/packages/rex/index.html) Friendly Regular Expressions
  * [rgdal-1.4-2](https://cran.r-project.org/web/packages/rgdal/index.html) Bindings for the 'Geospatial' Data Abstraction Library
  ...
  * [rgl-0.100.18](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [rlang-0.3.1](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  ...
  * [rms-5.1-3](https://cran.r-project.org/web/packages/rms/index.html) Regression Modeling Strategies
  ...
  * [robustbase-0.93-3](https://cran.r-project.org/web/packages/robustbase/index.html) Basic Robust Statistics
...
Ordinary Differential Equations
  * [rotl-3.0.7](https://cran.r-project.org/web/packages/rotl/index.html) Interface to the 'Open Tree of Life' API
...
Applications
  ...
  * [rstudioapi-0.9.0](https://cran.r-project.org/web/packages/rstudioapi/index.html) Safely Access the RStudio API
  ...
  * [sf-0.7-3](https://cran.r-project.org/web/packages/sf/index.html) Simple Features for R
...
Estimation
  ...
  * [spaMM-2.6.1](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, Particularly Spatial Models
  ...
  * [spatstat-1.58-2](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  ...
  * [spdep-1.0-2](https://cran.r-project.org/web/packages/spdep/index.html) Spatial Dependence: Weighting Schemes, Statistics and Models
  * splines built in
  ...
  * [statnet.common-4.2.0](https://cran.r-project.org/web/packages/statnet.common/index.html) Common R Scripts and Utilities Used by the Statnet Project
Software
  * stats built in
  * stats4 built in
  ...
  * [stringi-1.3.1](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
  ...
  * [svd-0.4.2](https://cran.r-project.org/web/packages/svd/index.html) Interfaces to Various State-of-Art SVD and Eigensolvers
  * synapseClient 1.14-3
  * [sys-3.1](https://cran.r-project.org/web/packages/sys/index.html) Powerful and Reliable Tools for Running System Commands in R
  ...
  * [taxize-0.9.6](https://cran.r-project.org/web/packages/taxize/index.html) Taxonomic Information from Around the Web
...
Exponential-Family Random Graph Models
  ...
  * [tibble-2.0.1](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
  ...
  * [tinytex-0.10](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain 'TeX Live', and Compile
'LaTeX' Documents
  ...
  * [urltools-1.7.2](https://cran.r-project.org/web/packages/urltools/index.html) Vectorised Tools for URL Handling and Parsing
  ...
  * [vegan-2.5-4](https://cran.r-project.org/web/packages/vegan/index.html) Community Ecology Package
...
Signal Processing
  ...
  * [xfun-0.5](https://cran.r-project.org/web/packages/xfun/index.html) Miscellaneous Functions by 'Yihui Xie'
  ...
  * [zip-2.0.0](https://cran.r-project.org/web/packages/zip/index.html) Cross-Platform 'zip' Compression
