---
layout: post
title: Python-3.6.2-foss-2016b-fh2
date: 2018-05-21
---
...
### Package List
  ...
  * [Flask-Migrate-2.1.0](https://pypi.org/project/Flask-Migrate/) SQLAlchemy database migrations for Flask applications using Alembic
  ...
  * [Pillow-4.2.1](http://pypi.org/project/Pillow/) Python Imaging Library (Fork)
  ...
  * [SQLAlchemy-1.1.13](http://pypi.org/project/SQLAlchemy/) Database Abstraction Library
  * [Sphinx-1.6.3](http://pypi.org/project/Sphinx/) Python documentation generator
  * [Theano-0.10.0b1](https://pypi.org/project/Theano/) Optimizing compiler for evaluating mathematical expressions on CPUs and GPUs.
  ...
  * [XlsxWriter-0.9.8](https://pypi.org/project/XlsxWriter/) A Python module for creating Excel XLSX files.
  ...
  * [ansible-2.3.2.0](https://pypi.org/project/ansible/) Radically simple IT automation
  ...
  * [awscli-1.11.136](https://pypi.org/project/awscli/) Universal Command Line Environment for AWS.
  ...
  * [boto3-1.4.6](http://pypi.org/project/boto3/) The AWS SDK for Python
  * [botocore-1.6.3](https://pypi.org/project/botocore/) Low-level, data-driven core of boto 3.
  ...
  * [cliff-2.8.0](https://pypi.org/project/cliff/) Command Line Interface Formulation Framework
  ...
  * [cmd2-0.7.6](https://pypi.org/project/cmd2/) cmd2 - a tool for building interactive command line applications in Python
  ...
  * [cryptography-2.0.3](http://pypi.org/project/cryptography/) cryptography is a package which provides cryptographic recipes and primitives to Python developers.
  ...
  * [dask-0.15.1](https://pypi.org/project/dask/) Parallel PyData with Task Scheduling
  ...
  * [debtcollector-1.17.0](https://pypi.org/project/debtcollector/) A collection of Python deprecation patterns and strategies that help you collect your technical debt in a non-destructive manner.
  ...
  * [distributed-1.18.0](https://pypi.org/project/distributed/) Distributed computing
  ...
  * [freezer-5.0.0.0rc1](https://pypi.org/project/freezer/) The OpenStack Backup Restore and Disaster Recovery as a Service Platform
  ...
  * [keystoneauth1-3.1.0](https://pypi.org/project/keystoneauth1/) Authentication Library for OpenStack Identity
  ...
  * [nltk-3.2.4](https://pypi.org/project/nltk/) Natural Language Toolkit
  * [nose-1.3.7](http://pypi.org/project/nose/) nose extends unittest to make testing easier
  * [notebook-5.1.0rc1](https://pypi.org/project/notebook/) A web-based notebook environment for interactive computing
  ...
  * [numpy-1.13.1](https://pypi.org/project/numpy/) NumPy: array processing for numbers, strings, records, and objects.
  ...
  * [os-brick-1.15.2](https://pypi.org/project/os-brick/) OpenStack Cinder brick library for managing local volume attaches
  ...
  * [oslo.concurrency-3.21.0](https://pypi.org/project/oslo.concurrency/) Oslo Concurrency library
  * [oslo.config-4.11.0](https://pypi.org/project/oslo.config/) Oslo Configuration API
  * [oslo.context-2.17.0](https://pypi.org/project/oslo.context/) Oslo Context library
  * [oslo.i18n-3.17.0](https://pypi.org/project/oslo.i18n/) Oslo i18n library
  * [oslo.log-3.30.0](https://pypi.org/project/oslo.log/) oslo.log library
  * [oslo.privsep-1.22.0](https://pypi.org/project/oslo.privsep/) OpenStack library for privilege separation
  * [oslo.serialization-2.20.0](https://pypi.org/project/oslo.serialization/) Oslo Serialization library
  * [oslo.service-1.25.0](https://pypi.org/project/oslo.service/) oslo.service library
  * [oslo.utils-3.28.0](https://pypi.org/project/oslo.utils/) Oslo Utility library
  * [packaging-16.8](http://pypi.org/project/packaging/) Core utilities for Python packages
  * [pandas-0.20.3](https://pypi.org/project/pandas/) Powerful data structures for data analysis, time series, and statistics
  ...
  * [psycopg2-2.7.3](https://pypi.org/project/psycopg2/) psycopg2 - Python-PostgreSQL Database Adapter
  ...
  * [pyasn1-0.3.2](http://pypi.org/project/pyasn1/) ASN.1 types and codecs
  ...
  * [pymongo-3.5.0](https://pypi.org/project/pymongo/) Python driver for MongoDB <http://www.mongodb.org>
  ...
  * [pytest-3.2.1](http://pypi.org/project/pytest/) pytest: simple powerful testing with Python
  * [python-cinderclient-3.1.0](https://pypi.org/project/python-cinderclient/) OpenStack Block Storage API Client Library
  ...
  * [python-neutronclient-6.5.0](https://pypi.org/project/python-neutronclient/) CLI and Client Library for OpenStack Networking
  * [python-novaclient-9.1.0](https://pypi.org/project/python-novaclient/) Client library for OpenStack Compute API
  ...
  * setupfiles 0.0.14
  * [setuptools-36.2.7](https://pypi.org/project/setuptools/) Easily download, build, install, upgrade, and uninstall Python packages
  ...
  * [snakemake-4.0.0](https://pypi.org/project/snakemake/) Snakemake is a workflow management system that aims to reduce the complexity of creating workflows by providing a fast and comfortable execution environment, together with a clean and modern specification language in python style. Snakemake workflows are essentially Python scripts extended by declarative code to define rules. Rules describe how to create output files from input files.
  ...
  * [spyder-3.2.1](https://pypi.org/project/spyder/) Scientific PYthon Development EnviRonment
  ...
  * [stevedore-1.25.0](http://pypi.org/project/stevedore/) Manage dynamic plugins for Python applications
  ...
  * [tensorflow-1.3.0rc1](https://pypi.org/project/tensorflow/) TensorFlow helps the tensors flow
  ...
  * [toil-3.10.0a1.dev437](https://pypi.org/project/toil/) Pipeline management software for clusters.
