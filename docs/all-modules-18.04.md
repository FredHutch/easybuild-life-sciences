...
The GNU Scientific Library (GSL) is a numerical library for C and C++ programmers.
 ...
 - [GTS/0.7.6-GCCcore-7.3.0](http://gts.sourceforge.net/)  [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/GTS/GTS-0.7.6-GCCcore-7.3.0.eb)  
...
GraphicsMagick is the swiss army knife of image processing.
 - [Graphviz/2.40.1-foss-2018b](http://www.graphviz.org/)  [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/Graphviz/Graphviz-2.40.1-foss-2018b.eb)  
...
Qt is a comprehensive cross-platform C++ application framework.
 - [R/3.5.3-foss-2018b](http://www.r-project.org/)  [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/r/R/R-3.5.3-foss-2018b.eb)  
...
The NCBI SRA Toolkit enables reading (dumping) of sequencing files 
 ...
 - [STAR/2.6.1c-foss-2018b](https://github.com/alexdobin/STAR)  [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/STAR/STAR-2.6.1c-foss-2018b.eb)  
...
The Visualization Toolkit (VTK) is an open-source, freely available software system for
 ...
 - [ViennaRNA/2.4.10-foss-2018b-Python-2.7.15](http://www.tbi.univie.ac.at/RNA/) 
...
pybedtools wraps and extends BEDTools and offers feature-level manipulations from within Python.
 - [qcat/1.0.1-foss-2018b-Python-3.6.6](https://github.com/nanoporetech/)  [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/q/qcat/qcat-1.0.1-foss-2018b-Python-3.6.6.eb)  
