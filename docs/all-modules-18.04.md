...
This bundle collect the standard GNU build tools: Autoconf, Automake
 ...
 - [BBMap/38.44-foss-2018b](https://sourceforge.net/projects/bbmap/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BBMap/BBMap-38.44-foss-2018b.eb)  
BBMap short read aligner, and other bioinformatic tools.
 - [BCFtools/1.9-foss-2018b](http://www.htslib.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BCFtools/BCFtools-1.9-foss-2018b.eb)  
Samtools is a suite of programs for interacting with high-throughput sequencing data.
 BCFtools
 - [BEDOPS/2.4.35-foss-2018b](http://bedops.readthedocs.io/en/latest/index.html)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BEDOPS/BEDOPS-2.4.35-foss-2018b.eb)  
BEDOPS is an open-source command-line toolkit that performs highly efficient and
 ...
 - [BEDTools/2.27.1-foss-2018b](https://github.com/arq5x/bedtools2)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BEDTools/BEDTools-2.27.1-foss-2018b.eb)  
The BEDTools utilities allow one to address common genomics tasks such as finding feature overlaps
 ...
 and SAM/BAM.
 - [BLAST+/2.8.1-foss-2018b](http://blast.ncbi.nlm.nih.gov/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BLAST+/BLAST+-2.8.1-foss-2018b.eb)  
...
BLAT on DNA is designed to quickly find sequences of 95% and greater similarity of length 25 bases or
 more.
 - [BWA/0.7.17-foss-2018b](http://bio-bwa.sourceforge.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BWA/BWA-0.7.17-foss-2018b.eb)  
Burrows-Wheeler Aligner (BWA) is an efficient program that aligns
 relatively short nucleotide sequences against a long reference sequence such as the human genome.
 - [BamTools/2.5.1-foss-2018b](https://github.com/pezmaster31/bamtools)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/BamTools/BamTools-2.5.1-foss-2018b.eb)  
...
Bioperl is the product of a community effort to produce Perl code which is useful in biology.
 ...
 - [Biopython/1.73-foss-2018b-Python-3.6.6](http://www.biopython.org)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/Biopython/Biopython-1.73-foss-2018b-Python-3.6.6.eb)  
...
Bison is a general-purpose parser generator that converts an annotated context-free grammar
 ...
 - [Blosc/1.14.4-GCCcore-7.3.0](http://www.blosc.org/)  
Blosc, an extremely fast, multi-threaded, meta-compressor library
 - [Boost/1.68.0-foss-2018b-Python-2.7.15](http://www.boost.org/)  
...
Bowtie is an ultrafast, memory-efficient short read aligner.
 ...
 - [Bowtie2/2.3.4.2-foss-2018b](http://bowtie-bio.sourceforge.net/bowtie2/index.shtml)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/Bowtie2/Bowtie2-2.3.4.2-foss-2018b.eb)  
Bowtie 2 is an ultrafast and memory-efficient tool for aligning sequencing reads
 to long reference sequences. It is particularly good at aligning reads of about 50 up to 100s or 1,000s
 of characters, and particularly good at aligning to relatively long (e.g. mammalian) genomes.
 Bowtie 2 indexes the genome with an FM Index to keep its memory footprint small: for the human genome,
 its memory footprint is typically around 3.2 GB. Bowtie 2 supports gapped, local, and paired-end alignment modes.
 - [CARBayes/5.1.1-foss-2018b-R-3.5.2](http://github.com/duncanplee/CARBayes)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/c/CARBayes/CARBayes-5.1.1-foss-2018b-R-3.5.2.eb)  
Implements a class of univariate and multivariate spatial generalised linear mixed models for areal unit data, with inference in a Bayesian setting using Markov chain Monte Carlo (MCMC) simulation.
 - [CITE-seq-Count/1.4.2-foss-2018b-Python-3.6.6](https://hoohm.github.io/CITE-seq-Count)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/c/CITE-seq-Count/CITE-seq-Count-1.4.2-foss-2018b-Python-3.6.6.eb)  
...
CMake, the cross-platform, open-source build system.  CMake is a family of
 ...
 - [CUDA/9.2.88-GCC-7.3.0-2.30](https://developer.nvidia.com/cuda-toolkit)  
...
C, C++, Objective-C compiler, based on LLVM.  Does not
 ...
 - [Cufflinks/2.2.1-foss-2018b](http://cole-trapnell-lab.github.io/cufflinks/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/c/Cufflinks/Cufflinks-2.2.1-foss-2018b.eb)  
Transcript assembly, differential expression, and differential regulation for RNA-Seq
 - [DB/18.1.25-GCCcore-7.3.0](http://www.oracle.com/technetwork/products/berkeleydb)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/d/DB/DB-18.1.25-GCCcore-7.3.0.eb)  
...
projects.
 - [DBus/1.13.6-GCCcore-7.3.0](http://dbus.freedesktop.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/d/DBus/DBus-1.13.6-GCCcore-7.3.0.eb)  
D-Bus is a message bus system, a simple way for applications to talk
 ...
 - [DIAMOND/0.9.22-foss-2018b](https://github.com/bbuchfink/diamond)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/d/DIAMOND/DIAMOND-0.9.22-foss-2018b.eb)  
Accelerated BLAST compatible local sequence aligner
 - [Doxygen/1.8.14-GCCcore-7.3.0](http://www.doxygen.org)  
Doxygen is a documentation system for C++, C, Java, Objective-C, Python,
 IDL (Corba and Microsoft flavors), Fortran, VHDL, PHP, C#, and to some
 extent D.

 - [EMBOSS/6.6.0-foss-2018b](http://emboss.sourceforge.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/e/EMBOSS/EMBOSS-6.6.0-foss-2018b.eb)  
...
The FASTX-Toolkit is a collection of command line tools for 
 ...
 - [FFTW/3.3.8-gompic-2018b](http://www.fftw.org)  
...
t-distributed stochastic neighbor embedding (t-SNE) is widely used for
 ...
 - [FLASH/2.2.00-foss-2018b](https://ccb.jhu.edu/software/FLASH/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/f/FLASH/FLASH-2.2.00-foss-2018b.eb)  
...
FSL is a comprehensive library of analysis tools for FMRI, MRI and DTI brain imaging data.
 - [FastANI/1.1-foss-2018b](http://www.iodbc.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/f/FastANI/FastANI-1.1-foss-2018b.eb)  
...
pipeline.
 - [FastTree/2.1.10-foss-2018b](http://www.microbesonline.org/fasttree/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/f/FastTree/FastTree-2.1.10-foss-2018b.eb)  
...
The Free Implementation of the Unicode Bidirectional Algorithm.
 ...
 - [GATK/4.1.0.0-foss-2018b-Python-3.6.6](http://www.broadinstitute.org/gatk/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/GATK/GATK-4.1.0.0-foss-2018b-Python-3.6.6.eb)  
...
GD.pm
 - [GDAL/2.2.3-foss-2018b-Python-3.6.6](http://www.gdal.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/GDAL/GDAL-2.2.3-foss-2018b-Python-3.6.6.eb)  
...
GMP is a free library for arbitrary precision arithmetic, operating on signed
 ...
 - [GMime/2.6.23-GCCcore-7.3.0](http://spruce.sourceforge.net/gmime/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/GMime/GMime-2.6.23-GCCcore-7.3.0.eb)  
...
This is a CPU only build, containing both MPI and threadMPI builds.
 ...
 - [GSL/2.5-GCC-7.3.0-2.30](http://www.gnu.org/software/gsl/)  
The GNU Scientific Library (GSL) is a numerical library for C and C++ programmers.
 The library provides a wide range of mathematical routines such as random number generators, special functions
 and least-squares fitting.
 - [GTS/0.7.6-foss-2018b](http://gts.sourceforge.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/GTS/GTS-0.7.6-foss-2018b.eb)  
GTS stands for the GNU Triangulated Surface Library.
 ...
 - [Ghostscript/9.23-GCCcore-7.3.0](http://ghostscript.com)  
Ghostscript is a versatile processor for PostScript data with the ability to render PostScript to
 different targets. It used to be part of the cups printing stack, but is no longer used for that.
 - [GitPython/2.1.11-foss-2018b-Python-3.6.6](https://github.com/gitpython-developers/GitPython)  
GitPython is a python library used to interact with Git repositories 
 - [Go/1.12](http://www.golang.org)  
Go is an open source programming language that makes it easy to build
 simple, reliable, and efficient software.
 - [GraphicsMagick/1.3.31-foss-2018b](http://www.graphicsmagick.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/GraphicsMagick/GraphicsMagick-1.3.31-foss-2018b.eb)  
...
HISAT2 is a fast and sensitive alignment program for mapping next-generation sequencing reads
 ...
 - [HMMER/3.2.1-foss-2018b](http://hmmer.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/h/HMMER/HMMER-3.2.1-foss-2018b.eb)  
...
HarfBuzz is an OpenType text shaping engine.
 - [ICU/61.1-GCCcore-7.3.0](http://site.icu-project.org/home)  
...
The JasPer Project is an open-source initiative to provide a free
 ...
 - [Java/11.0.2](https://openjdk.java.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/j/Java/Java-11.0.2.eb)  
...
LAST finds similar regions between sequences.
 - [LLVM/6.0.0-GCCcore-7.3.0](http://llvm.org/)  
...
LMDB is a fast, memory-efficient database. With memory-mapped files, it has the read performance
 ...
 - [LZO/2.10-foss-2018b](http://www.oberhumer.com/opensource/lzo/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/LZO/LZO-2.10-foss-2018b.eb)  
Portable lossless data compression library
 - [LibTIFF/4.0.9-GCCcore-7.3.0](http://www.remotesensing.org/libtiff/)  
tiff: Library and tools for reading and writing TIFF data files
 - [LightGBM/2.2.3-foss-2018b](https://github.com/microsoft/LightGBM)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/LightGBM/LightGBM-2.2.3-foss-2018b.eb)  
A fast, distributed, high performance gradient boosting (GBT, GBDT, GBRT,
 ...
 - [LittleCMS/2.9-foss-2018b](http://www.littlecms.com/)  
Little CMS intends to be an OPEN SOURCE small-footprint
 color management engine, with special focus on accuracy and performance. 
...
Model Based Analysis for ChIP-Seq data
 - [MUMmer/4.0.0beta2-foss-2018b](http://mummer.sourceforge.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/m/MUMmer/MUMmer-4.0.0beta2-foss-2018b.eb)  
MUMmer is a system for rapidly aligning entire genomes,
 whether in complete or draft form. AMOS makes use of it.
 - [MUSCLE/3.8.31-foss-2018b](http://drive5.com/muscle/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/m/MUSCLE/MUSCLE-3.8.31-foss-2018b.eb)  
...
NASM: General-purpose x86 assembler
 - [NGS/2.9.3-foss-2018b-Java-1.8](https://github.com/ncbi/ngs)  
NGS is a new, domain-specific API for accessing reads, alignments and pileups produced from
 Next Generation Sequencing.
 - [NLopt/2.4.2-GCCcore-7.3.0](http://ab-initio.mit.edu/wiki/index.php/NLopt)  
NLopt is a free/open-source library for nonlinear optimization, 
 ...
 - [NSPR/4.20-GCCcore-7.3.0](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSPR)  
Netscape Portable Runtime (NSPR) provides a platform-neutral API for system level
 and libc-like functions.
 - [NSS/3.39-GCCcore-7.3.0](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS)  
...
OpenBLAS is an optimized BLAS library based on GotoBLAS2 1.13 BSD version.
 - [OpenJPEG/2.3.0-GCCcore-7.3.0](http://www.openjpeg.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/o/OpenJPEG/OpenJPEG-2.3.0-GCCcore-7.3.0.eb)  
OpenJPEG is an open-source JPEG 2000 codec written in
 ...
 - [OpenMPI/3.1.1-gcccuda-2018b](https://www.open-mpi.org/)  
...
OptiType is a novel HLA genotyping algorithm based on integer linear programming,
 ...
 - [PANDAseq/2.11-foss-2018b](https://github.com/neufeld/pandaseq)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/PANDAseq/PANDAseq-2.11-foss-2018b.eb)  
...
The PCRE library is a set of functions that implement regular expression
 ...
 - [PEAR/0.9.11-foss-2018b](http://sco.h-its.org/exelixis/web/software/pear/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/PEAR/PEAR-0.9.11-foss-2018b.eb)  
...
Porechop is a tool for finding and removing adapters from Oxford Nanopore reads.
 ...
 - [PostgreSQL/10.3-foss-2018b](https://www.postgresql.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/PostgreSQL/PostgreSQL-10.3-foss-2018b.eb)  
...
PyTables is a package for managing hierarchical datasets and designed to efficiently and easily cope
 ...
 - [PyYAML/3.13-foss-2018b-Python-3.6.6](https://pypi.python.org/pypi/PyYAML/)  
...
Pyomo is a Python-based open-source software package that supports a diverse set of optimization
 ...
 - [Pysam/0.15.1-foss-2018b-Python-3.6.6](https://github.com/pysam-developers/pysam)  
Pysam is a python module for reading and manipulating Samfiles. 
 It's a lightweight wrapper of the samtools C-API. Pysam also includes an interface for tabix.
 - [Python/3.6.6-foss-2018b](http://python.org/)  
...
Qt is a comprehensive cross-platform C++ application framework.
 - [R/3.6.1-foss-2018b](http://www.r-project.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/r/R/R-3.6.1-foss-2018b.eb)  
R is a free software environment for statistical computing
 and graphics.
 - [RepeatMasker/4.0.8-foss-2018b-Perl-5.28.0-HMMER](http://www.repeatmasker.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/r/RepeatMasker/RepeatMasker-4.0.8-foss-2018b-Perl-5.28.0-HMMER.eb)  
RepeatMasker is a program that screens DNA sequences for interspersed repeats
 and low complexity DNA sequences.
 - [SAMtools/1.9-foss-2018b](http://www.htslib.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/SAMtools/SAMtools-1.9-foss-2018b.eb)  
SAM Tools provide various utilities for manipulating alignments in the SAM format, 
 including sorting, merging, indexing and generating alignments in a per-position format.
 - [SCons/3.0.1-foss-2018b-Python-3.6.6](http://www.scons.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/SCons/SCons-3.0.1-foss-2018b-Python-3.6.6.eb)  
...
Genome assembler for single-cell and isolates data sets
 - [SPRING/1.6-foss-2018b-Python-2.7.15](http://https://github.com/AllonKleinLab/SPRING_dev)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/SPRING/SPRING-1.6-foss-2018b-Python-2.7.15.eb)  
...
The NCBI SRA Toolkit enables reading (dumping) of sequencing files 
 ...
 - [STAR/2.7.0d-foss-2018b](https://github.com/alexdobin/STAR)  
STAR aligns RNA-seq reads to a reference genome using uncompressed suffix arrays.
 - [STAR-Fusion/1.5.0-foss-2018b-Perl-5.28.0](https://github.com/STAR-Fusion/STAR-Fusion)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/STAR-Fusion/STAR-Fusion-1.5.0-foss-2018b-Perl-5.28.0.eb)  
STAR-Fusion uses the STAR aligner to identify candidate fusion transcripts 
 ...
 - [SWIG/3.0.12-foss-2018b-Python-3.6.6](http://www.swig.org/)  
SWIG is a software development tool that connects programs written in C and C++ with
 a variety of high-level programming languages.
 - [ScaLAPACK/2.0.2-gompic-2018b-OpenBLAS-0.3.1](http://www.netlib.org/scalapack/)  
...
SeqAn is an open source C++ library of efficient algorithms and data structures
 ...
 - [Seqmagick/0.6.2-foss-2018b-Python-2.7.15](https://fhcrc.github.io/seqmagick/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/Seqmagick/Seqmagick-0.6.2-foss-2018b-Python-2.7.15.eb)  
We often have to convert between sequence formats and do
 ...
 - [Sniffles/1.0.8-foss-2018b](https://github.com/fritzsedlazeck/Sniffles)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/Sniffles/Sniffles-1.0.8-foss-2018b.eb)  
...
and evaluate mathematical expressions involving multi-dimensional arrays efficiently.
 - [Tk/8.6.8-GCCcore-7.3.0](http://www.tcl.tk/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/Tk/Tk-8.6.8-GCCcore-7.3.0.eb)  
Tk is an open source, cross-platform widget toolchain that provides a library of basic elements for
 ...
 - [Tkinter/3.6.6-foss-2018b-Python-3.6.6](http://python.org/)  
Tkinter module, built with the Python buildsystem
 - [TopHat/2.1.1-foss-2018b](http://ccb.jhu.edu/software/tophat/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/TopHat/TopHat-2.1.1-foss-2018b.eb)  
TopHat is a fast splice junction mapper for RNA-Seq reads.
 - [Tracer/1.7.1](http://beast.community/tracer)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/Tracer/Tracer-1.7.1.eb)  
Tracer is a program for analysing the trace files generated
 ...
 - [Trinity/2.8.4-foss-2018b](http://trinityrnaseq.github.io)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/Trinity/Trinity-2.8.4-foss-2018b.eb)  
...
UDUNITS supports conversion of unit specifications between formatted and binary forms,
 ...
 - [VCFtools/0.1.16-foss-2018b-Perl-5.28.0](https://vcftools.github.io)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/v/VCFtools/VCFtools-0.1.16-foss-2018b-Perl-5.28.0.eb)  
...
VSEARCH supports de novo and reference based chimera detection,
 ...
 - [VTK/8.1.1-foss-2018b-Python-3.6.6](http://www.vtk.org)  
...
ANNOVAR is an efficient software tool to utilize update-to-date
 ...
 - [ant/1.10.1-Java-1.8](http://ant.apache.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/a/ant/ant-1.10.1-Java-1.8.eb)  
Apache Ant is a Java library and command-line tool whose mission is to drive processes described in
 ...
 Java applications.
 - [bam2wig/1.5](https://github.com/MikeAxtell/bam2wig)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/bam2wig/bam2wig-1.5.eb)  
Conversion of a BAM alignment to wiggle and bigwig coverage files, with flexible reporting options.
 - [bcl2fastq2/2.20.0-foss-2018b](https://support.illumina.com/sequencing/sequencing_software/bcl2fastq-conversion-software.html)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/bcl2fastq2/bcl2fastq2-2.20.0-foss-2018b.eb)  
...
Bioawk is an extension to Brian Kernighan's awk,
 ...
 - [biobambam2/2.0.95-foss-2018b](https://github.com/gt1/biobambam2)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/b/biobambam2/biobambam2-2.0.95-foss-2018b.eb)  
Tools for processing BAM files; 
 bamsormadup, bamcollate2, bammarkduplicates, bammaskflags, bamrecompress,
 bamsort, bamtofastq
 - [bzip2/1.0.6-GCCcore-7.3.0](https://sourceware.org/bzip2)  
...
Cairo is a 2D graphics library with support for multiple output devices.
 ...
 - [canu/1.8-foss-2018b](http://canu.readthedocs.io)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/c/canu/canu-1.8-foss-2018b.eb)  
Canu is a fork of the Celera Assembler designed for
 high-noise single-molecule sequencing
 - [cas-offinder/2.4-foss-2018b]()   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/c/cas-offinder/cas-offinder-2.4-foss-2018b.eb)  
Cas-OFFinder is OpenCL based, ultrafast and versatile program that searches
 ...
 - [cellranger/3.0.2-foss-2018b](https://support.10xgenomics.com/single-cell-gene-expression/software/overview/welcome)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/c/cellranger/cellranger-3.0.2-foss-2018b.eb)  
...
GNU Compiler Collection (GCC) based compiler toolchain, including
 ...
 - [fosscuda/2018b]((none))   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/f/fosscuda/fosscuda-2018b.eb)  
GCC based compiler toolchain __with CUDA support__, and including
 OpenMPI for MPI support, OpenBLAS (BLAS and LAPACK support), FFTW and ScaLAPACK.
 - [freeglut/3.0.0-foss-2018b](http://freeglut.sourceforge.net/)  
...
and documentation
 - [git-lfs/2.7.1](https://git-lfs.github.com)  
Git Large File Storage (LFS) replaces large files such as audio
 ...
 - [gnuplot/5.2.5-foss-2018b](http://gnuplot.sourceforge.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/gnuplot/gnuplot-5.2.5-foss-2018b.eb)  
Portable interactive, function plotting utility
 - [gompi/2018b]((none))  
GNU Compiler Collection (GCC) based compiler toolchain,
 including OpenMPI for MPI support.
 - [gompic/2018b]((none))   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/gompic/gompic-2018b.eb)  
GNU Compiler Collection (GCC) based compiler toolchain along with CUDA toolkit,
...
GNU gperf is a perfect hash function generator. For a given list of strings,
 ...
 - [graphite2/1.3.13-GCCcore-7.3.0](http://graphite.sil.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/g/graphite2/graphite2-1.3.13-GCCcore-7.3.0.eb)  
Graphite is a "smart font" system developed specifically to
 handle the complexities of lesser-known languages of the world.
 - [h5py/2.8.0-foss-2018b-Python-3.6.6](http://www.h5py.org/)  
...
help2man produces simple manual pages from the '--help' and '--version'
 ...
 - [hivmmer/0.1.2-foss-2018b-Python-3.6.6](https://github.com/kantorlab/hivmmer)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/h/hivmmer/hivmmer-0.1.2-foss-2018b-Python-3.6.6.eb)  
...
iCount: protein-RNA interaction analysis
 ...
 - [igraph/0.7.1-foss-2018b](http://igraph.org)  
...
intltool is a set of tools to centralize translation of
 ...
 - [jbigkit/2.1-GCCcore-7.3.0]()   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/j/jbigkit/jbigkit-2.1-GCCcore-7.3.0.eb)  
JBIG-KIT is a software implementation of the JBIG1 data
 ...
 - [jemalloc/5.1.0-GCCcore-7.3.0](http://www.canonware.com/jemalloc)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/j/jemalloc/jemalloc-5.1.0-GCCcore-7.3.0.eb)  
...
The OpenGL Utility Library (GLU) is a computer graphics library for OpenGL. 
 - [libcerf/1.7-GCCcore-7.3.0](http://apps.jcns.fz-juelich.de/doku/sc/libcerf)  
...
Direct Rendering Manager runtime library.
 - [libevent/2.1.8-GCCcore-7.3.0](http://libevent.org/)  
...
Library for reading and writing coordinate system information from/to GeoTIFF files
 - [libgpg-error/1.35-GCCcore-7.3.0](https://gnupg.org/related_software/libgpg-error/index.html)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libgpg-error/libgpg-error-1.35-GCCcore-7.3.0.eb)  
Libgpg-error is a small library that defines common error
 values for all GnuPG components.
 - [libgtextutils/0.7-GCCcore-7.3.0](http://hannonlab.cshl.edu/fastx_toolkit/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libgtextutils/libgtextutils-0.7-GCCcore-7.3.0.eb)  
ligtextutils is a dependency of fastx-toolkit and is provided
 via the same upstream
 - [libharu/2.3.0-GCCcore-7.3.0](http://libharu.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libharu/libharu-2.3.0-GCCcore-7.3.0.eb)  
...
libjpeg-turbo is a fork of the original IJG libjpeg which uses SIMD to
 ...
 - [libmaus2/2.0.611-foss-2018b](https://github.com/gt1/libmaus2)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libmaus2/libmaus2-2.0.611-foss-2018b.eb)  
...
GNU libtool is a generic library support script. Libtool hides the complexity
 ...
 - [libunistring/0.9.10-GCCcore-7.3.0](http://www.gnu.org/software/libunistring/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libunistring/libunistring-0.9.10-GCCcore-7.3.0.eb)  
This library provides functions for manipulating Unicode strings and for
 manipulating C strings according to the Unicode standard.

 - [libwebp/1.0.0-foss-2018b](https://developers.google.com/speed/webp)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libwebp/libwebp-1.0.0-foss-2018b.eb)  
...
Libxml2 is the XML C parser and toolchain developed for the Gnome project
 ...
 - [libxslt/1.1.32-GCCcore-7.3.0](http://xmlsoft.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/libxslt/libxslt-1.1.32-GCCcore-7.3.0.eb)  
Libxslt is the XSLT C library developed for the GNOME project
 (but usable outside of the Gnome platform).
 - [libyaml/0.2.1-GCCcore-7.3.0](http://pyyaml.org/wiki/LibYAML)  
LibYAML is a YAML parser and emitter written in C.
 - [lumpy/0.2.13-foss-2018b](https://github.com/pezmaster31/bamtools)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/l/lumpy/lumpy-0.2.13-foss-2018b.eb)  
...
alignment.
 - [nanofilt/2.5.0-foss-2018b-Python-3.6.6](https://github.com/wdecoster/nanofilt)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/n/nanofilt/nanofilt-2.5.0-foss-2018b-Python-3.6.6.eb)  
Filtering and trimming of long read sequencing data.
 - [nanopolish/0.11.1-foss-2018b-Python-2.7.15](https://github.com/jts/nanopolish)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/n/nanopolish/nanopolish-0.11.1-foss-2018b-Python-2.7.15.eb)  
...
The Ncurses (new curses) library is a free software emulation of curses in
 ...
 - [netCDF/4.6.1-foss-2018b](http://www.unidata.ucar.edu/software/netcdf/)  
...
Nettle is a cryptographic library that is designed to fit easily
 ...
 - [numactl/2.0.11-GCCcore-7.3.0](http://oss.sgi.com/projects/libnuma/)  
The numactl program allows you to run your application program on specific
 ...
 - [numexpr/2.6.5-foss-2018b-Python-2.7.15](http://code.google.com/p/numexpr/)  
...
Guppy software supports MinIT and MinION instruments from
 ...
 - [parasail/2.4-foss-2018b](https://github.com/jeffdaily/parasail)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/parasail/parasail-2.4-foss-2018b.eb)  
...
Philosopher provides easy access to third-party tools and custom algorithms
 ...
 open search results.
 - [picard/2.18.29-Java](http://sourceforge.net/projects/picard)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/picard/picard-2.18.29-Java.eb)  
...
pkg-config is a helper tool used when compiling applications and libraries.
 ...
 - [pkgconfig/1.3.1-foss-2018b-Python-3.6.6](http://github.com/matze/pkgconfig)  
pkgconfig is a Python module to interface with the pkg-config command line tool
 - [pocl/1.2-GCC-7.3.0-2.30](http://portablecl.org)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/pocl/pocl-1.2-GCC-7.3.0-2.30.eb)  
Pocl is a portable open source (MIT-licensed) implementation of the OpenCL standard
 - [poppler/0.70.1-foss-2018b](https://poppler.freedesktop.org/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/poppler/poppler-0.70.1-foss-2018b.eb)  
Poppler is a PDF rendering library based on the xpdf-3.0 code
 base.
 - [pplacer/1.1.alpha19-foss-2018b](['https://matsen.fhcrc.org/pplacer/'])   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/pplacer/pplacer-1.1.alpha19-foss-2018b.eb)  
...
Prodigal (Prokaryotic Dynamic Programming Genefinding
   ...
   Tennessee.
 - [prokka/1.13-foss-2018b-BioPerl-1.7.2](http://www.vicbioinformatics.com/software.prokka.shtml)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/prokka/prokka-1.13-foss-2018b-BioPerl-1.7.2.eb)  
Prokka is a software tool for the rapid annotation of prokaryotic genomes.
 - [protobuf/3.6.1-GCCcore-7.3.0](https://github.com/google/protobuf/)  
Google Protocol Buffers
 - [psipred/4.02-foss-2018b](http://bioinf.cs.ucl.ac.uk/psipred/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/p/psipred/psipred-4.02-foss-2018b.eb)  
The PSIPRED Protein Sequence Analysis Workbench aggregates
 several UCL structure prediction methods into one location.
 - [pyBigWig/0.3.13-foss-2018b-Python-3.6.6](https://github.com/deeptools/pyBigWig)  
...
This package contains Python bindings for parasail. 
 - [qcat/1.0.7-foss-2018b-Python-3.6.6](https://github.com/nanoporetech/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/q/qcat/qcat-1.0.7-foss-2018b-Python-3.6.6.eb)  
...
RevBayes provides an interactive environment for statistical
 ...
 phylogenetics.
 - [samblaster/0.1.24-foss-2018b](https://github.com/GregoryFaust/samblaster)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/samblaster/samblaster-0.1.24-foss-2018b.eb)  
samblaster is a fast and flexible program for marking
 duplicates in read-id grouped1 paired-end SAM files.
 - [scikit-learn/0.20.0-foss-2018b-Python-3.6.6](http://scikit-learn.org/stable/index.html)  
...
It strives to be simple and efficient, accessible to everybody, and reusable in various contexts.
 - [smallgenomeutilities/0.2.1-foss-2018b-Python-3.6.6](https://github.com/cbg-ethz/smallgenomeutilities)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/s/smallgenomeutilities/smallgenomeutilities-0.2.1-foss-2018b-Python-3.6.6.eb)  
...
Strelka2 is a fast and accurate small variant caller
 ...
 - [tabix/0.2.6-GCCcore-7.3.0](http://samtools.sourceforge.net)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/tabix/tabix-0.2.6-GCCcore-7.3.0.eb)  
Generic indexer for TAB-delimited genome position files 
 - [tbb/2018_U5-GCCcore-7.3.0](https://01.org/tbb/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/tbb/tbb-2018_U5-GCCcore-7.3.0.eb)  
...
Tcsh is an enhanced, but completely compatible version of the Berkeley UNIX C shell (csh). 
 ...
 - [tmux/2.8-GCC-7.3.0-2.30](http://tmux.sourceforge.net/)   [easyconfig](https://github.com/FredHutch/easybuild-life-sciences/blob/master/fh_easyconfigs/t/tmux/tmux-2.8-GCC-7.3.0-2.30.eb)  
